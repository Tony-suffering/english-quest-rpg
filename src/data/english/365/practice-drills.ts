...
export const HANDCRAFTED_DRILLS: HandcraftedDrill[] = [
    ...
    // ═══════════════════════════════════════════════════════
    {
        ...
        japaneseKey: 'はじめまして',
        type: 'pick-native',
        question: '初対面で、ネイティブが一番自然に言うのはどれ？',
        questionSub: '「はじめまして」を英語で',
        options: [
            'Nice to meet you for the first time.',
            'Nice to meet you.',
            'First time meeting. How are you?',
            'I am pleased to make your acquaintance.',
        ],
        correctIdx: 1,
        explanation: 'for the first time は不要(meetに「初対面」の意味が入ってる)。I am pleased to make your acquaintance は200年前の小説。Nice to meet you. これだけでOK。その後に一言足すのがネイティブ流(I have heard a lot about you. など)。',
    },
    {
    ...
    },
    {
        ...
        japaneseKey: 'お名前は？',
        type: 'pick-native',
        question: '相手の名前を聞き取れなかった。一番柔らかい聞き方は？',
        options: [
        ...
        correctIdx: 2,
        explanation: 'What is your name again? は相手のせいにする感じ。Repeat your name は命令形で無礼。Say your name も同じく命令調。I did not catch your name は「聞き取れなかった(私のせい)」で角が立たない英語の礼儀作法。',
    },
    {
        id: 'd1-iimise-1',
    ...
    },
    {
        ...
        type: 'register',
        question: '居酒屋のカウンターで店主に聞くとき、一番空気に合うのは？',
        options: [
            'What do you recommend, sir?',
            "What's good here?",
            'I would like to know your recommendation.',
            'Please tell me what is recommended.',
        ],
        correctIdx: 1,
        explanation: 'sir 付けたら高級レストラン。I would like to know... は硬すぎて面接みたい。Please tell me what is recommended は受動態で不自然。カジュアルな店では What is good here? が一番ネイティブ。What is your go-to? も同じくらい自然。',
    },
    {
        id: 'd1-toriaezu-1',
        japaneseKey: 'とりあえずビール',
        type: 'meaning',
        question: '「とりあえずビール」のニュアンスを英語で一番近く出せるのは？',
        options: [
            'Just beer for now.',
            "I'll start with a beer.",
            'Beer as a first priority.',
            'Tentatively, beer please.',
        ],
        correctIdx: 1,
        explanation: 'Just beer for now は「今のところビールだけ」で微妙にケチくさい。priority や tentatively は辞書引いた英語で会話で使わない。I will start with a beer が「まず1杯目」の意味で自然。「とりあえず」の概念は英語にないが start with が最も近い。',
    },
    {
        id: 'd1-wakaru-1',
        japaneseKey: 'わかるわかる',
        type: 'trap',
        question: '友達の愚痴に共感したい。どれが一番「わかるわかる」の温度感？',
        options: [
            'I understand.',
            'I know, right?',
        ...
        correctIdx: 1,
        explanation: 'I understand は他人事の冷たい相槌。試験の答えなら正解だが会話では冷たい。comprehend は法廷用語。I know, right? は「だよね！」で完全に同じ温度。I have been there(私もそうだった)も同じく強い共感。',
    },
    {
        id: 'd1-matakimasu-1',
        japaneseKey: 'また来ます',
        type: 'pick-native',
        question: '店を出るときの「また来ます」。一番自然な言い方は？',
        options: [
            'I will come again.',
            "I'll be back.",
            'I want to come here again.',
            'Please wait for my next visit.',
        ],
        correctIdx: 1,
        explanation: 'I will come again は文法的に正しいがロボットみたい。I want to come here again も教科書的で硬い。Please wait for my next visit は意味不明。I will be back(ターミネーターと同じ)が「また来るよ」の最自然な英語。日本語とビッタリ一致する稀有な例。',
    },
    ...
    },
    {
        ...
        japaneseKey: 'おいしい！',
        type: 'pick-native',
        question: '日本人は "Delicious!" を連発するが、ネイティブの感想として一番自然なのは？',
        options: [
            'Delicious!',
            'This is so good!',
            'Very delicious!',
        ...
        correctIdx: 1,
        explanation: 'Delicious は間違いではないが少しフォーマルで連発すると不自然。Very delicious は文法ミス(deliciousは強い形容詞なのでveryをつけない、very bigはOKだがvery enormousと同じ変)。tasty は「まあ美味しい」程度で褒め言葉として弱い。This is so good! が一番自然。',
    },
    {
        id: 'd2-mouippai-1',
    ...
    // ═══════════════════════════════════════════════════════
    {
        ...
        japaneseKey: '駅はどこですか？',
        type: 'register',
        question: '道で知らない人に駅の場所を聞く。一番丁寧なのは？',
        options: [
            'Where station?',
            'Station where?',
            "Excuse me, where's the station?",
            'Tell me the station location.',
        ],
        correctIdx: 2,
        explanation: 'Where station? / Station where? は外国人が日本人に話しかけるときの「スシ、ドコ？」レベル。Tell me は命令形で失礼。Excuse me を前につけるだけで礼儀正しさが一気に上がる。英語は Excuse me, を付けるかどうかが最大の分岐点。',
    },
    {
        id: 'd4-norikae-1',
    ...
    },
    {
        ...
        japaneseKey: '疲れた',
        type: 'pick-native',
        question: '「マジで疲れた」のニュアンスを一番出せるのは？',
        options: [
            "I'm very tired.",
            "I'm so tired.",
            "I'm exhausted.",
        ...
        correctIdx: 2,
        explanation: 'very tired は教科書英語で感情がない。so tired は「めっちゃ疲れた」で使える。wearing fatigue は存在しない英語。exhausted は「疲労困憊」で tired より強く、ネイティブが日常で連発する。I am beat / I am wiped も同じく使える。',
    },
    {
        id: 'd5-bikkuri-1',
        japaneseKey: 'びっくりした',
    ...
    },
    {
        ...
        japaneseKey: '心配しないで',
        type: 'pick-native',
        question: '友達が不安そう。「心配しないで」の自然な言い方は？',
        options: [
            "Don't be worry.",
            "Don't worry.",
            "Don't have worry.",
        ...
        correctIdx: 1,
        explanation: 'Do not be worry は文法エラー(worryは動詞、Do not be の後は形容詞)。Do not have worry は存在しない。Stop worrying yourself は意味は通じるが不自然。Do not worry. これだけ。カジュアルなら No worries. (オーストラリア英語から世界へ)。',
    },
    ...
    // ═══════════════════════════════════════════════════════
    {
        ...
        correctIdx: 2,
        explanation: 'Help me は映画でピンチのときの叫び。Please help me は「助けてください(緊急)」感。I need your help now は圧が強すぎる。Could you give me a hand? が「ちょっと手貸してくれる？」で日常の軽いお願いに最適。give a hand(手を貸す)は日本語と同じ発想。',
    },
    {
        id: 'd6-shashin-1',
