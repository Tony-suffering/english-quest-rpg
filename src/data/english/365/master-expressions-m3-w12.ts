...
export const MONTH3_W12_EXPRESSIONS: MasterExpression[] = [
...

    {
        ...
        english: [
            ...
            "Oh yeah, I have been wanting to try that place near the station. Friday works for me if you are down.",
        ],
        jaTranslations: [
            '飲みに行かない？',
            'ねえ、今度飲みに行かない？',
            '近いうち仕事終わりに飲みに行こうと思ってたんだけど。',
            'あー、駅前のあの店ずっと気になってた。金曜でよければ俺はいけるよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "This Friday? Let me think... yeah, I should be free. Count me in.",
        ],
        jaTranslations: [
            '金曜空いてる？',
            'ねえ、今週の金曜空いてる？',
            '今週の金曜の夜、空いてるかなと思って。何人かで飲みに行くんだけど。',
            '今週の金曜？えーと…うん、たぶん大丈夫。俺も行く。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "No worries, just shoot me a text when you know. Hope you can make it though.",
        ],
        jaTranslations: [
            'いいね。ちょっと確認するね。',
            'いいじゃん、ちょっと予定確認させて。',
            '行きたいんだけど、スケジュール確認して連絡するね。',
            '全然いいよ、わかったらLINEして。来れるといいな。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "That is too bad. But yeah, next week works. Just let us know when you are free.",
        ],
        jaTranslations: [
            'ごめん、無理だわ。',
            '行きたいけどその日は予定あるんだよね。',
            'ほんとごめん、金曜はもう先約があって。また今度でいい？',
            'それは残念。でもまあ来週でもいいよ。空いてる日教えて。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Good idea. I will throw it in the group chat and see who is in.",
        ],
        jaTranslations: [
            'みんなで行こうよ。',
            'みんなで行こうよ。人数多いほうが楽しいし。',
            '全員誘えばいいじゃん。大人数のほうが絶対盛り上がるって。',
            'いいね。グルチャに投げて誰が来るか聞いてみるわ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Seven sounds good. Let us meet at the station and walk over together so nobody gets lost.",
        ],
        jaTranslations: [
            '何時？',
            '何時に集合？',
            '何時集合？あと、どこに行けばいい？',
            '7時でいいんじゃない。駅で待ち合わせして一緒に歩こう、迷わないように。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Nice, thanks. You are the best. We will just show up at seven then.",
        ],
        jaTranslations: [
            '俺が予約しとく。',
            '任せろ。予約しとくから。',
            '心配すんな、先に電話して席取っとくよ。',
            'ナイス、ありがとう。さすがだわ。じゃあ7時に行けばいいのね。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "I know, I know. I will be there, I swear. You can hold me to it.",
        ],
        jaTranslations: [
            'ドタキャンすんなよ。',
            '絶対ドタキャンしないでよ。',
            '前みたいにバックレないって約束して。',
            'わかったわかった。絶対行くって、マジで。約束する。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Let us just split it evenly. Way easier than figuring out who had what.",
        ],
        jaTranslations: [
            '会計どうする？',
            '割り勘にする？',
            '会計どうしたい？均等割り？それとも自分の分だけ？',
            '均等割りでいいじゃん。誰が何頼んだとか計算するより楽だし。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Same here. It has been way too long. Friday cannot come soon enough.",
        ],
        jaTranslations: [
            '楽しみにしてる。',
            'マジで楽しみ。',
            '待ちきれない。みんなで集まるの久しぶりだし。',
            'こっちもだよ。ほんと久しぶりすぎ。金曜早く来ないかな。',
        ],
...

    {
        ...
        english: [
            ...
            "Alright, I am holding you to that. Do not let me down this time.",
        ],
        jaTranslations: [
            '約束する。',
            '俺の言葉を信じてくれ。',
            '約束するよ。これは絶対だから。',
            'よし、その言葉忘れないからな。今回はがっかりさせんなよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Sure, yeah. Just text me whenever. We will figure something out.",
        ],
        jaTranslations: [
            '今度遊ぼうよ。',
            '今度マジでお茶しようよ。',
            'ほんとそろそろ会わない？久しぶりすぎだし。',
            'うんうん。いつでも連絡して。なんとかなるっしょ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "I am dead serious. Pick a day and I will be there. No excuses.",
        ],
        jaTranslations: [
            'マジで言ってる？',
            'え、それ本気で言ってんの？',
            'ちょっと待って。今のガチ？それともいつもの社交辞令？',
            '超本気だよ。日にち決めてくれたら絶対行く。言い訳なし。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "We will see about that. Actions speak louder than words, my friend.",
        ],
        jaTranslations: [
            '約束は守るから。',
            '今回はマジで最後までやるって誓うよ。',
            '今回はガチだから。絶対バックレない。',
            'どうだかね。口だけじゃなくて行動で見せてくれよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Ouch. That is fair though. I deserve that. OK watch, I will prove you wrong.",
        ],
        jaTranslations: [
            '口だけじゃん。',
            'いっつもそう言うけど結局やらないじゃん。',
            'それ前も聞いたわ。行動で示せよ、わかってるだろ。',
            'いてて。まあ確かに。自業自得だわ。よし見てろ、間違ってるって証明するから。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Did I? Wow, OK you have a better memory than me. My bad.",
        ],
        jaTranslations: [
            '前もそう言ってたよね。',
            'それ前回もまったく同じこと言ってたじゃん。',
            'おかしいな、3ヶ月前にもまったく同じセリフ聞いた気がするんだけど。',
            'そうだっけ？うわ、お前のほうが記憶力いいわ。ごめん。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Respect. You do not see that kind of integrity much anymore.",
        ],
        jaTranslations: [
            '俺は約束を守る男だ。',
            '男の価値は約束を守れるかどうかだ。',
            '俺たちの世代じゃ、約束は契約書なんかいらなかった。言葉が全てだったんだ。',
            'かっこいいっすね。そういう筋を通す人、最近少なくなりましたよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Ha, yeah we do that in Japan too. Ours is way more hardcore though, with the thousand needles thing.",
        ],
        jaTranslations: [
            'ピンキースウェアって知ってる？',
            'ピンキースウェアって聞いたことある？',
            'アメリカだと子供が約束するとき、ピンキースウェアってやるんだよ。',
            'あはは、日本にもあるよそれ。でもうちのほうがハードだけどね、針千本飲ますとか言うし。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Smart move. Send me the invite so it is in my calendar too.",
        ],
        jaTranslations: [
            'カレンダーに入れとく。',
            'OK、今カレンダーに追加するわ。',
            'あのさ、忘れないようにカレンダーに入れとくわ。',
            '賢いね。招待送ってよ、俺のカレンダーにも入れとくから。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Deal. That is fair. But I am not going to bail, so it does not matter.",
        ],
        jaTranslations: [
            '約束破ったらおごりだからね。',
            'ドタキャンしたら次はおごりだよ。',
            'いい？また逃げたら次は全員分おごりね。いい？',
            'いいよ。フェアだ。でもドタキャンしないから関係ないけどね。',
        ],
...

    {
        ...
        english: [
            ...
            "Wait, what? No, I did not hear anything. Spill it.",
        ],
        jaTranslations: [
            'ねえ聞いた？',
            'ねえ、これ聞いた？',
    ...
    },
    {
        ...
        english: [
            ...
            "I heard it from someone in HR, so it is pretty reliable actually.",
        ],
        jaTranslations: [
            'マジ？誰が言ったの？',
            'えー嘘でしょ。それどこで聞いたの？',
            'ちょっと待って、本気で？情報源は？さすがにそれはありえなくない？',
            '人事のやつから聞いたから、結構ガチな話だよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "OK OK, my lips are sealed. I will not say a word, I promise.",
        ],
        jaTranslations: [
            'ここだけの話だけど…',
            'これ俺たちだけの秘密な、いい？',
            '内緒で言うんだけどさ。絶対に言いふらさないでくれよ。',
            'わかったわかった、口にチャックする。一言も言わない、約束する。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "I knew it. The way they act around each other, it was so obvious.",
        ],
        jaTranslations: [
            'あの二人、付き合ってるらしいよ。',
            'あの二人、もう付き合ってるって聞いたんだけど。',
            '噂だと、あの二人もう何ヶ月も付き合ってるらしいよ。',
            'やっぱりな。あの二人の態度見てたらバレバレだったわ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "That is probably smart. I should stop taking everything at face value too.",
        ],
        jaTranslations: [
            '噂は信じない。',
            'それは話半分で聞いとくわ。',
            '本人の口から聞くまでは信じないようにしてる。',
            'それが賢いよな。俺ももう何でも鵜呑みにするのやめるわ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "That is the office for you. Never tell anyone anything unless you want the whole building to know.",
        ],
        jaTranslations: [
            '噂って広まるの早いよね。',
            'ゴシップって光の速さで広まるよな。',
            '噂の広まり方ヤバくない？一人にしか言ってないのに。',
            'それが会社ってもんだよ。ビル全体に知られたくなかったら誰にも言うな。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Yeah, you are probably right. There is usually at least some truth to these things.",
        ],
        jaTranslations: [
            '火のないところに煙は立たぬ、ってやつだな。',
            'まあ多少は本当のことあるんじゃない？火のないところに煙は立たぬってさ。',
            'だってさ、何もないところからこんな話出てこないでしょ。火のないところに煙は立たぬってやつだよ。',
            'まあそうだろうな。こういう話って大体ちょっとは本当なんだよな。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Ha, true. We have all got stuff we would not want people finding out about.",
        ],
        jaTranslations: [
            '俺が言えた義理じゃないけど。',
            '別に俺が偉そうに言える立場じゃないんだけどさ。',
            'まあ俺もあんまり偉そうに言えないけどな。自分だって人に言えない秘密あるし。',
            'はは、確かにな。みんなバレたくないこと抱えてるもんだよな。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Relax, I will not tell anyone. Your secret is safe with me.",
        ],
        jaTranslations: [
            '誰にも言わないで。',
            'これ自分だけの秘密にしといてね、いい？',
            'これ信用して話すからさ。絶対に誰にも言わないでよ。',
            '落ち着けよ、誰にも言わないから。お前の秘密は俺が守る。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Fair enough. Another round sounds way better than more gossip anyway.",
        ],
        jaTranslations: [
            '噂話はそのへんにしとけ。',
            'よし、収拾つかなくなる前に話題変えようぜ。',
            'まあ、今夜の噂話はこのくらいにしとこう。別の話しようや。',
            'そうだな。おかわりのほうが噂話よりよっぽどいいわ。',
        ],
...

    {
        ...
        english: [
            ...
            "Aw, thanks. I got it at that new shop in Shibuya. You should check it out.",
        ],
        jaTranslations: [
            'その服いいね。',
            'その服めっちゃ似合ってるよ。',
            'うわ、その服めっちゃいい。どこで買ったの？',
            'え、ありがとう。渋谷の新しい店で買ったやつ。行ってみなよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "No, I totally mean it. I would not say it if I did not think so.",
        ],
        jaTranslations: [
            'お世辞でしょ。',
            'いやいや、そんなこと言っちゃって。',
            '本気で言ってるの？それとも社交辞令？いまいちわかんなくて。',
            'いやいや、ガチだって。思ってなかったらそんなこと言わないよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "OK, I believe you. Sorry, I am just not used to getting compliments like that.",
        ],
        jaTranslations: [
            '本気で言ってるよ。',
            'いや、マジで本心だって。',
            '社交辞令じゃないよ。ほんとにそう思ってるんだから。',
            'わかった、信じる。ごめん、こういう風に褒められるの慣れてなくてさ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Just say thanks and smile. That is literally all you have to do. It gets easier.",
        ],
        jaTranslations: [
            '褒められると恥ずかしい。',
            '褒められるとどう反応していいかわかんない。',
            '褒められるといつも変な空気になっちゃって。何て言えばいいか全然わかんないんだよね。',
            'ありがとうって言って笑っとけばいいんだよ。マジでそれだけ。慣れるから。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Yeah, I have been trying to just say thank you lately. It feels weird but people seem to like it.",
        ],
        jaTranslations: [
            '日本人は謙遜しすぎだよね。',
            '日本人って褒め言葉受け取るの苦手だよな。',
            '日本の文化って、褒められて素直にありがとうって言いにくくしてる気がする。',
            'うん、最近は素直にありがとうって言うようにしてる。変な感じだけど、相手は喜んでくれるんだよな。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "You are right. I overthink it every time. Thank you. See? That was not so bad.",
        ],
        jaTranslations: [
            '素直にありがとうって言えばいいんだよ。',
            '一番簡単なのは、ありがとうって言うことだ。',
            'ライフハック教えてやる。褒められたら、笑ってありがとうって言え。それだけだ。',
            'そうだよな。毎回考えすぎてたわ。ありがとう。ほら、そんなに難しくなかったろ？',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Ha, guilty as charged. But honestly, I only say it when I mean it.",
        ],
        jaTranslations: [
            '口上手いね。',
            'ほんと甘い言葉上手いよね。',
            '口上手すぎでしょ。それみんなに言ってるんでしょ？',
            'はは、バレたか。でも本気の時しか言わないよ、正直。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Uh oh. OK go ahead, I can take it. Just do not sugarcoat it.",
        ],
        jaTranslations: [
            '正直に言っていい？',
            'ぶっちゃけていい？ちょっとだけ。',
            '悪く取らないでほしいんだけど、正直な感想言ってもいい？',
            'うわ、来たか。いいよ言って、受け止めるから。オブラートに包まなくていいよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Hmm, that is a fair point. I had not thought about it that way before.",
        ],
        jaTranslations: [
            'それは違うと思う。',
            'うーん、それはちょっと賛成できないな。',
            '言いたいことはわかるけど、それはちょっと違うんじゃないかな。',
            'うーん、確かにそれは一理あるな。そういう見方したことなかったわ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "For real. I do not have to put on an act here. That is why I keep coming back.",
        ],
        jaTranslations: [
            '本音で話せるっていいよね。',
            '正直に話せる人がいるのってありがたいよな。',
            '取り繕わなくていい関係って、ほんと大事だと思う。',
            'ほんとそれ。ここでは演技しなくていいからさ。だからまた来ちゃうんだよ。',
        ],
...

    {
        ...
        english: [
            ...
            "Aw, already? OK, get home safe. We will do this again soon.",
        ],
        jaTranslations: [
            'そろそろ行くわ。',
            'そろそろ帰ろうかな。',
            'じゃあそろそろ帰るわ。明日朝早いんだよね。',
            'えー、もう？わかった、気をつけてな。またすぐやろうぜ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Fine, one more. But just one, I really do have to go after that.",
        ],
        jaTranslations: [
            'もう？まだ早いじゃん。',
            'え、もう帰るの？夜はまだこれからだよ。',
            'もう一杯行こうよ。まだ10時にもなってないし。',
            'しょうがないな、もう一杯だけな。でもほんとにそれで帰るからな。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Thanks, I will. I will send you a text once I am home.",
        ],
        jaTranslations: [
            '気をつけてね。',
            '帰り道気をつけてね。',
            '家着いたらLINEしてよ、無事に帰ったかわかるように。',
            'ありがとう、そうする。着いたら連絡するわ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Same here. We needed this. Let us not wait so long next time, yeah?",
        ],
        jaTranslations: [
            'ありがとう、楽しかった。',
            '今日はありがとう。ほんと楽しかった。',
            'マジでありがとう、企画してくれて。めっちゃ楽しかった。',
            'こっちもだよ。こういうの必要だったわ。次はもっと早く集まろうな。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "I am in. Same time, same place. Let us make it a thing.",
        ],
        jaTranslations: [
            'また来週ね。',
            'じゃあ来週ね。同じ時間、同じ場所？',
            'よし、また来週な。定例にしようぜこれ。',
            '乗った。同じ時間、同じ場所で。恒例にしよう。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Eleven forty-five I think. You have still got time, but we should probably wrap up soon.",
        ],
        jaTranslations: [
            '終電いつ？',
            '終電何時だっけ？',
            'ちょっと待って、もう一杯頼む前に終電の時間確認しとかない？',
            '11時45分だったかな。まだ大丈夫だけど、そろそろ切り上げたほうがいいかもな。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Night. Get home safe everyone. This was a blast.",
        ],
        jaTranslations: [
            'じゃあね、おやすみ。',
            'よし、みんなおやすみ。',
            'じゃあおやすみ、みんな。気をつけて帰れよ、またな。',
            'おやすみー。みんな気をつけてな。最高に楽しかったわ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Sure thing, I will bring it right over. One bill or separate?",
        ],
        jaTranslations: [
            'お会計お願いします。',
            'すみません、お勘定いただけますか？',
            'お手すきの時にお会計お願いできますか？そろそろお開きなんで。',
            'はいよ、すぐ持ってくるね。お会計まとめる？別々にする？',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "What? No way, you do not have to do that. At least let me get the next round.",
        ],
        jaTranslations: [
            '俺のおごりだ。',
            '俺が出すよ。今夜は俺のおごり。',
            '財布しまえ。今夜は俺が出す。いいから。',
            'え？いいよいいよ、そんな。せめて次の一杯は俺に払わせてよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Alright, alright. I will hold you to that. Next time is on you for sure.",
        ],
        jaTranslations: [
            '次は私が出すからね。',
            'わかった、でも次は絶対私が払う。文句なしで。',
            'いいけど、次は私が出すから。これは交渉の余地なしだからね。',
            'はいはい、わかったよ。じゃあ次は頼むぞ。絶対お前のおごりな。',
        ],
...

    {
        ...
        english: [
            ...
            "Oh you saw that? Thanks. I almost did not post it, but the colors were too good not to share.",
        ],
        jaTranslations: [
            'いいね押したよ。',
            'いいね押しといた。あの写真きれいだったね。',
            '今朝の投稿見ていいね押したよ。あの夕焼けの写真やばかったね。',
            'え、見てくれたの？ありがとう。上げるか迷ったんだけど、色がきれいすぎてさ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Of course, go for it. I will follow you back. What is your handle?",
        ],
        jaTranslations: [
            'フォローしてもいい？',
            'インスタフォローしてもいい？',
            'インスタフォローしていい？投稿めっちゃ好きなんだよね。',
            'もちろん、どうぞどうぞ。フォロバするよ。アカウント名なに？',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Go ahead, take your pics. Just hurry up because I am starving over here.",
        ],
        jaTranslations: [
            'これめっちゃ映えるね。',
            'これインスタ映えするじゃん。',
            'ちょっと待って、まだ食べないで。先に写真撮らせて。これめっちゃ映える。',
            'いいよ撮りなよ。でも早くしてくれ、こっち腹減って死にそうなんだから。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Just say thanks, that means a lot. Short and sweet. You do not need to overthink it.",
        ],
        jaTranslations: [
            '英語でどう返せばいい？',
            '英語で返したいんだけど何て言えばいいかわかんない。',
            '投稿に英語でコメントもらったんだけど、返信したいのに頭真っ白で。',
            'thanks, that means a lot って返せばいいよ。短くて十分。考えすぎなくていい。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Wait, seriously? That is insane. Show me, I want to see the numbers.",
        ],
        jaTranslations: [
            'バズった。',
            '投稿が一晩でバズったんだけど。',
            '今朝起きたらいいね1万超えてた。完全にバズったわ。',
            'え、マジで？やばくない？見せて、数字見たい。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Ugh, just block them and move on. Do not even waste your energy on that.",
        ],
        jaTranslations: [
            'アンチコメント来た。',
            '変なやつに嫌なコメントされた。',
            'なんか投稿したら知らない人からめちゃくちゃ失礼なコメント来て。結構へこんだ。',
            'うわ、もうブロックして忘れな。そんなやつにエネルギー使うのもったいないって。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Thanks, you are right. I am not going to let one jerk ruin my day.",
        ],
        jaTranslations: [
            '気にしなくていいよ。',
            'あんなやつ無視しな。相手にする価値ないから。',
            'アンチはアンチだよ。あんなゴミに時間使って返信するな。',
            'ありがとう、そうだよね。たった一人のバカに一日台無しにされてたまるか。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Yeah, go ahead. My DMs are open. Just send me whatever.",
        ],
        jaTranslations: [
            'DM送っていい？',
            'DM送ってもいい？',
            '直接メッセージしてもいい？コメント欄に書くのはちょっと…って思って。',
            'いいよ、送って。DM開放してるから。なんでも送ってきて。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Honestly, same. I deleted the app for a week last month and it felt amazing.",
        ],
        jaTranslations: [
            'もうSNSうんざり。',
            'SNSちょっと休憩したい。疲れた。',
            'SNS休もうかなって思ってる。メンタルに影響し始めてて。',
            '正直俺も。先月一週間アプリ消したけど、めっちゃ快適だったわ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "OK boomer. Just kidding. But seriously, you are not wrong about the eye contact thing.",
        ],
        jaTranslations: [
            '昔はSNSなんてなかったんだよ。',
            '俺の時代にはSNSなんてなかったからな。',
            '俺が若い頃は人と直接会って話してたんだよ。信じられるか？',
            'はいはい、おじさん。冗談だって。でもアイコンタクトの話は確かにそうだよな。',
        ],
...

    {
        ...
        english: [
            ...
            "Yeah, tell me about it. The older I get, the more I realize that.",
        ],
        jaTranslations: [
            '人間関係って難しいよな。',
            '人って複雑だよなあ。',
            '歳取れば取るほど、人間関係維持するのって大変だなって思うわ。',
            'ほんとそれ。歳取るほどそれがわかるようになるんだよな。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "That is rough. Have you tried reaching out? Someone has to break the ice.",
        ],
        jaTranslations: [
            '友達と気まずくて。',
            '最近友達とうまくいってなくて。',
            '親友とちょっと揉めちゃって、今めっちゃ気まずいんだよね。',
            'それはきついな。自分から連絡してみた？誰かが切り出さないと始まらないよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "You are right. I will text her tonight. It is not worth losing a friend over something stupid.",
        ],
        jaTranslations: [
            '自分から謝ったほうがいいよ。',
            '大人になって先に謝りな。',
            'つらいのはわかるけど、プライド飲み込んでごめんって言ったほうがいいよ。',
            'そうだよな。今夜連絡するわ。くだらないことで友達失うのバカらしいもんな。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Yeah, that makes sense. A little breathing room never hurts.",
        ],
        jaTranslations: [
            'ちょっと距離置いたほうがいいかな。',
            'ちょっと一歩引いたほうがいいかなって思って。',
            'ちょっと距離置こうかなって考えてるんだよね。客観的に見るためにさ。',
            'うん、それはありだな。少し息抜きする余裕があって悪いことないよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "I get that. But you have to take care of yourself first or you will burn out completely.",
        ],
        jaTranslations: [
            '人に気を使いすぎちゃう。',
            '人の目ばっかり気にして疲れた。',
            'みんなを幸せにしようとしてエネルギー使い果たして、自分のこと忘れちゃうんだよね。',
            'わかるよ。でもまず自分を大事にしないと、完全に燃え尽きるぞ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "I used to be the same way. Start small. Say no to one thing this week and see how it feels.",
        ],
        jaTranslations: [
            '断れないんだよね。',
            '人に頼まれるとノーって言えないんだよ。',
            '誰かに何か頼まれると、嫌でも毎回イエスって言っちゃうんだよね。',
            '俺も昔そうだったよ。まず小さいことから始めろ。今週一個だけ断ってみな。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "You are right. No is a complete sentence. I need to tattoo that on my brain.",
        ],
        jaTranslations: [
            'ノーって言う練習しろ。',
            'ノーって言えるようになれ。それだけで完結する言葉だ。',
            'ノーは立派な一文だ。誰にも理由を説明する義務なんてない。',
            'そうだよな。ノーは完結した一文。脳みそに刻みつけとくわ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "That hit hard. I think I need to appreciate the real ones in my life more.",
        ],
        jaTranslations: [
            '本当の友達ってなんだろうな。',
            '本当の友達って何なんだろうな。',
            'たまに思うんだよ、本当の友達と、ただ近くにいるだけのやつの違いって何なんだろうって。',
            'それ刺さるわ。自分の周りの本物の友達、もっと大事にしなきゃなって思った。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Anytime. That is what we are here for. You would do the same for me.",
        ],
        jaTranslations: [
            '話聞いてくれてありがとう。',
            '最後まで聞いてくれてありがとう。',
            '時間取って話聞いてくれて、ほんとありがとう。思ってた以上に助かった。',
            'いつでもいいよ。そのためにいるんだから。お前だって同じことしてくれるだろ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "That really means a lot. Seriously, thank you. I will not forget that.",
        ],
        jaTranslations: [
            'いつでもここにいるからな。',
            '話したくなったらいつでも言えよ、わかってるだろ？',
            '話したい時はいつでもいいからな。昼でも夜でも、理由なんて聞かない。',
            'それほんと嬉しいわ。マジでありがとう。忘れないよ。',
        ],
...

    {
        ...
        english: [
            ...
            "Yeah, first time. This place looks great. Could we get a table for two?",
        ],
        jaTranslations: [
            'いらっしゃい。初めて？',
            'いらっしゃい。うちは初めてですか？',
            'よう、いらっしゃい。前にも来たことある？それとも初めて？',
            'うん、初めてです。いい雰囲気ですね。二人なんですけど、席空いてます？',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "You have to try the yakitori. It is our specialty. I will bring you an assortment.",
        ],
        jaTranslations: [
            'おすすめは？',
            'ここ何がおいしいの？おすすめある？',
            '初めてだからメニューよくわかんなくて。おすすめは何？',
            '焼き鳥は絶対食べてくれ。うちの自慢だ。盛り合わせ持ってくるよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Just use your hands for this one. Dip it in the sauce on the side. The leaf is just for looks.",
        ],
        jaTranslations: [
            'これどうやって食べるの？',
            'これどうやって食べるの？特別な食べ方ある？',
            'これめっちゃおいしそうだけど食べ方わかんない。教えてくれる？',
            'これは手で食べていいよ。横のタレにつけて。葉っぱは飾りだから。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Kanpai. I love that. To good food and new friends. Cheers everyone.",
        ],
        jaTranslations: [
            '乾杯。',
            'グラス上げて。乾杯。',
            '始める前にちゃんと乾杯しようぜ。新しい出会いとうまいメシに。',
            'カンパイ。いいね。うまいメシと新しい友達に。みんな乾杯。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Oh nice, that is awesome. Your pronunciation is pretty good actually. Keep it up.",
        ],
        jaTranslations: [
            '日本語少し話せますよ。',
            '実は日本語ちょっとだけわかるんです。そんなにだけど。',
            '日本語を一年くらい勉強してて。まだ初級レベルだけど頑張ってます。',
            'へー、すごいじゃん。発音結構いいよ実は。その調子で頑張れよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Oh sorry, my bad. I will slow down. Just stop me if I am going too fast again.",
        ],
        jaTranslations: [
            'もう少しゆっくり話してもらえますか？',
            'すみません、もうちょっとゆっくりお願いできますか？',
            'ほんとすみません、英語あんまり得意じゃなくて。少しだけゆっくり話してもらえたら。',
            'あ、ごめんごめん。ゆっくり話すね。また早くなったら止めてくれていいから。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Thanks so much. We will definitely be back. This was the highlight of our trip.",
        ],
        jaTranslations: [
            'また来てくださいね。',
            'いつでも歓迎ですよ。',
            'お会いできてよかったです。いつでもまた来てくださいね。',
            'ほんとありがとうございます。絶対また来ます。旅行で一番の思い出になりました。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Oh thanks. Here is mine too. Let us connect on LinkedIn as well.",
        ],
        jaTranslations: [
            '名刺交換しましょう。',
            'これ私の名刺です。お持ちですか？',
            '名刺お渡ししますね。いつでも連絡してください。',
            'あ、ありがとうございます。これ私のもどうぞ。LinkedInでもつながりましょう。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Sure, I am mostly on WhatsApp. Here, scan my QR code. Let us keep in touch for real.",
        ],
        jaTranslations: [
            '連絡先教えてもらえますか？',
            '電話番号かLINE教えてもらえる？',
            '連絡先交換してもいいですか？ぜひこれからも連絡取りたくて。',
            'いいよ、WhatsApp使ってるから。はい、QRコード読んで。ちゃんと連絡取り合おうよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "We had a great time too. Come back anytime, you are always welcome here.",
        ],
        jaTranslations: [
            '今夜は楽しかったです。ありがとう。',
            '今夜はほんとに楽しかったです。ありがとうございます。',
            '今夜は全部ありがとうございました。料理も、お酒も、話も。全部最高でした。',
            'こちらこそ楽しかったです。いつでもまた来てくださいね、いつでも歓迎ですから。',
        ],
...

    {
        ...
        english: [
            ...
            "Oh cool, I would love to meet them. Lead the way.",
        ],
        jaTranslations: [
            '紹介させてください。',
            '紹介したい人がいるんだけど。',
    ...
    },
    {
        ...
        english: [
            ...
            "Hey, nice to meet you. Takeshi has told me a lot about you. All good things, I promise.",
        ],
        jaTranslations: [
            'こちらは私の同僚です。',
            'こちらは同僚の田中です。一緒に働いてます。',
            '同僚の田中を紹介させてください。もう3年くらい一緒に仕事してるんです。',
            'どうも、はじめまして。タケシからいろいろ聞いてますよ。いい話ばっかりです、ほんとに。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Ha, I hope whatever you heard was not too embarrassing. It is great to meet you too.",
        ],
        jaTranslations: [
            'お噂はかねがね。',
            'たくさんお話聞いてます。やっとお会いできて嬉しいです。',
            'いい話しか聞いてないですよ。やっとお顔と名前が一致しました。',
            'はは、変な話じゃなかったらいいんですけど。こちらこそお会いできて嬉しいです。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Of course, first names are totally fine. Nice to meet you too, Yuki.",
        ],
        jaTranslations: [
            'はじめまして。',
            'はじめまして。ユキって呼んでください。',
            'はじめまして、やっとお会いできました。ユキです。下の名前で気軽に呼んでください。',
            'もちろん、下の名前で全然いいですよ。こちらこそはじめまして、ユキさん。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "I am in marketing, nothing too exciting. What about you?",
        ],
        jaTranslations: [
            '何のお仕事されてるんですか？',
            'お仕事は何をされてるんですか？',
            '差し支えなければ、何のお仕事されてるんですか？',
            'マーケティングやってます、そんなに面白くないですけど。あなたは？',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "I am really into hiking lately. There are so many great trails around Tokyo. You should come with us sometime.",
        ],
        jaTranslations: [
            '趣味は何ですか？',
            '仕事以外だと何するのが好き？',
            '仕事以外だと何してる？趣味とか好きなこととか。',
            '最近ハイキングにハマってて。東京近郊にいいコースいっぱいあるんだよ。今度一緒に行こうよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Right? It feels like we have known each other forever already. This is why I love meeting new people.",
        ],
        jaTranslations: [
            '共通点あるね。',
            'え、それ一緒じゃん。すごいね。',
            'えー、お前もそれ好きなの？世界狭いな。共通点めっちゃあるじゃん。',
            'だよな？なんかもう昔から知ってた気がするわ。だから新しい人と会うの好きなんだよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "You are doing great, honestly. I could not even tell you were nervous.",
        ],
        jaTranslations: [
            '人見知りだから緊張する。',
            '内向的だからこういうの苦手なんだよね。',
            '初めての人に会うとめっちゃ緊張しちゃって。打ち解けるのに時間かかるんだよね。',
            '全然大丈夫だよ、ほんとに。緊張してるなんて全然わかんなかったよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "No need to apologize. Your English is way better than my Japanese. We will figure it out.",
        ],
        jaTranslations: [
            '英語下手ですみません。',
            'すみません、英語まだ勉強中なんです。',
            'ご容赦ください。英語あんまり上手くないんですけど、精一杯頑張ります。',
            '謝らなくていいよ。あなたの英語、俺の日本語よりよっぽどうまいから。なんとかなるよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "I am glad you came. Tonight would not have been the same without you.",
        ],
        jaTranslations: [
            '来てよかった。',
            '今夜来てほんとよかった。',
            '来るかどうか迷ったけど、来てほんとよかった。今夜最高だった。',
            '来てくれて嬉しいよ。お前がいなかったら今夜はこうはならなかったよ。',
        ],
