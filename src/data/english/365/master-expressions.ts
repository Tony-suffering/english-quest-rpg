...
export const MASTER_EXPRESSIONS: MasterExpression[] = [
...

    {
        ...
        jaTranslations: [
            ...
            'はじめまして。いや、ずっと来ようと思ってたんですけど、なかなか...まあ、やっと来れました。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'うん、楽しみにしてます。正直まだここ誰も知らないんで...親しみやすい顔があると助かります。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'お名前は？',
            'すみません、お名前聞き取れなくて。',
            'すみません、お名前なんでしたっけ？ほんと名前覚えるの苦手で、気を悪くしないでくださいね。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'この店いいね。',
            'ここの雰囲気、好きだなあ。',
            'この店なんかすごいですね。地元のあったかい感じがあって。いいなあ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'ここ何がおいしい？',
            '何頼めばいい？いつも何にするの？',
            'で、ここ何がおいしいの？絶対これ食べとけってやつある？あなたのセンスに任せます。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'まずビール。うん、ビールだけでいい。ちょっと一息つかないと料理のことまで頭回んない。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            '仕事帰り？うん、俺もだよ。なんかそういう日だったんだよね、わかるでしょ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'いいから聞いて。仕事順調って言ったじゃん？あれ嘘。何があったか教えてあげる。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'また来るから。マジで。ここ俺の新しい居場所になるかも。もう逃げられないよ。',
        ],
...

    {
        ...
        jaTranslations: [
            ...
            'すみません！',
            'あの、すみません -- お手すきのときに。',
            'すみません、お忙しいところ申し訳ないんですが...あ、やっぱりちょっと待ってください、まだ決めてないんです。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'これにします。',
            'これもらえますか？うん、これこれ。',
            'これにしよう。あ、やっぱり2つください。友達も欲しがると思うんで。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'あの、メニューってどこかにあります？それとも日替わりとかそういう感じ？どっちでも大丈夫です。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'お会計もらえますか？',
            'お会計、お手すきのときにお願いします。',
            'もう大丈夫です。お会計もらえますか？急がなくていいんで、いつでも。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'これめっちゃうまい！',
            'うわ、これやばい。何が入ってるの？',
            'いや、こんなにおいしいと思ってなかった。マジで。このソース何？レシピ教えて。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'これって辛い？少しでも？',
            'これどのくらい辛いの？10段階で言うと？',
            'あのちょっと聞きたいんですけど、これ顔が燃えるレベルですか？前ここで辛いの頼んだとき死にかけたんで聞いてます。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            '注文前に言っておいたほうがいいと思うんですけど、甲殻類アレルギーなんです。ひどくはないけど、痛い目に遭いたくはないんで。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'これ持ち帰りできますか？',
            '残りを箱に入れてもらってもいいですか？',
            'これ全部食べきれないんですよね。残り持って帰れますか？捨てるのもったいないし。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            '正直、久しぶりにこんなおいしいもの食べた。この店もっと評価されるべき。みんなに広めとくね。',
        ],
...

    {
        ...
        jaTranslations: [
            ...
            'で、これどのくらいの値段なんですかね？予算内に収めたいんだけど、すごく気になってて。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            '今のところ見てるだけです、ありがとう。いつもそう言って結局全部買っちゃうんだけど...うん、見てるだけ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'これネットで見たんですけど、お店にありますか？似たようなものでも大丈夫なんですが。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'これ着てみてもいいですか？',
            'これ試着できますか？試着室どこですか？',
            'これ試着させてもらってもいいですか？もうサイズ表示は信用してないんです -- ブランドによって全然違うから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'うん、これ無理ですね。ここがきつくて、あっちはゆるい。服買うときいつもこうなんです。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'これ色以外は完璧なんだよなあ。黒あるって言ってください。ネイビーでもいい。もうダークグレーでもいいです。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'これ本当に欲しいんですけど、ちょっと予算オーバーなんです。お値段相談できたりしませんか？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'カード使えますよね？もう現金持ち歩かないんですよ。今マジで一円も持ってないです。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            '袋なしで大丈夫です。ちょっとそういうの気をつけようと思って。ほら、エコ的なやつ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'これ実は誰かへのプレゼントなんですけど、ラッピングしてもらえたりします？自分で包むの本当にへたで。',
        ],
...

    {
        ...
        jaTranslations: [
            ...
            'すみません、完全に迷ってしまって。この辺に駅ってあります？自分がどこにいるか全然わからないんです。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'あの、ちょっと聞きたいんですけど、この電車渋谷停まります？それともまたホーム間違えました？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            '渋谷に行きたいんですけど路線間違えてて。どこで乗り換えればいいですか？ややこしいですか？それとも一回だけ？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'タクシー必要だと思うんですけど、近くにタクシー乗り場あります？それともアプリ使ったほうがいい？方向音痴なんです。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'どのくらいの距離感なんですかね？歩ける距離？それとも電車乗らないとだめ？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            '完全に迷いました。',
            '迷ったかも。なんか全然違う気がする。',
            'もう自分がどこにいるか全くわからない。20分くらい歩いてるのに何も見覚えがない。助けて。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'どうやって行けばいいですか？',
            '一番いい行き方は？歩き？電車？',
            'ここからだと何がおすすめですか？電車、バス、歩き？時間はあるんで一番簡単な方法でいいんですけど。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'やば、次だ。すみません、ちょっと通してください。ありがとうございます、すみません、通ります。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'すみません、英語あんまり得意じゃなくて。ちょっとゆっくりめに話してもらえますか？ちゃんと理解したいんです。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'ここWi-Fiあります？',
            'Wi-Fiありますか？パスワードは？',
            'あの、Wi-Fiってあります？ちょっと調べたいことがあって、電波入らないんですよね。',
        ],
...

    {
        ...
        jaTranslations: [
            ...
            '正直ちょっと嫌だったんだけど、これ普通に楽しい。マジで楽しい。なんでもっと早くやらなかったんだろ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'それ今日一日が最高になった。いや一週間か。ずっとそれ聞きたかったんだよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'うわ、マジで？すごいがっかりなんだけど。めっちゃ楽しみにしてたのに。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            '不意打ちだったわ。',
            'え、マジで？全然予想してなかった。',
            'うわ。いや全く予想してなかった。完全に不意打ちだよ。いい意味でだけど。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'ねえ、今は大ごとに感じるかもしれないけど、信じて -- うまくいくから。こういうのはいつもそうなんだよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'あのさ、なんか変わった気がする。嫌だったのにやりたくなってきた。これ新しい感覚だわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'やりたい気持ちはあるんだよ、本当に。でも口を開くたびに頭が...真っ白になる。すごく悔しい。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'それやばい！',
            'え、それやったの？マジですごいんだけど。',
            '嘘でしょ？やばすぎる。俺には絶対無理。いやほんとに、それ相当度胸いるよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'うわー。今どんなに安心してるか想像つかないでしょ。一日中ずっとハラハラしてたんだから。',
        ],
...

    {
        ...
        jaTranslations: [
            ...
            '突然なんだけどさ、お願いがあるんだよね。断る前にまず説明させて。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'ねえ、聞くのも悪いんだけど、ちょっと詰まっちゃって。手伝ってもらえない？すぐ終わると思うから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'あの、すみません、突然なんですけど、お願いしてもいいですか？一枚だけで。このボタンで撮れます。できればあの建物をバックに入れてもらえると。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'あー、ほんと行きたいんだけど今夜はどうしても無理で。別の日にしない？社交辞令じゃなくて本当に。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            '今回はまた今度にさせて、でもマジで次は参加する。日程決めちゃって。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'うーん。今すぐ答え出したくないんだよね、ちゃんと考えたいから。また連絡するでいい？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'もちろん、任せとけ。',
            'もう終わったと思って。全部やっとくから。',
            'もう何も言わなくていい。俺に任せろ。ゆっくり座ってて。全部なんとかするから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'ねえ、マジで全然平気だから。そもそも気にしてなかったし。もう忘れて次行こう。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'もちろんだよ！',
            'もちろん！喜んで手伝うよ。何が必要？',
            '何言ってんの？もちろんだよ！聞くまでもないじゃん。いつでも手伝うよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'いやほんとごめん、今ちょっとどうしても都合つかなくて。こっちもバタバタしてて。借り一つね。',
        ],
...

    {
        ...
        jaTranslations: [
            ...
            '調子どう？',
            'あ、久しぶり！最近どうしてた？',
            'おー元気？なんか会ってなさすぎて永遠に感じる。最近何してたの？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'で、週末どうだった？俺は正直、史上最高にだらけた週末だったわ。ソファから一歩も動いてない。後悔はしてない。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'いい天気だね。',
            'なんていい天気。今すぐ外に出るべきだよ。',
            'この天気信じられる？一週間ずっと雨だったのに急に今日これだよ。文句は言わないけどね。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            '何にハマってるの？',
            'で、楽しみで何してる？仕事以外で。',
            '仕事してないとき何してる？新しい趣味が欲しいんだよね。食べて寝て仕事しかしてない気がする。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            '何してるの？肩書きじゃなくて、毎日実際にやってることが知りたい。肩書きって全然伝わらないじゃん。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'へえ、面白いね。',
            'えー、全然知らなかった。もっと教えてよ。',
            'え、マジで？それめっちゃいいね。前からどんな感じなのか気になってたんだよ。で、普通の一日ってどんな感じ？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            '一緒！',
            'え、私も！自分だけかと思ってた。',
            'え、あなたも？もう公式に親友だね。そんなピンポイントなとこ一緒って。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            '絶対一緒に行こうよ。',
            'いつかやろうよ。来週末空いてる？',
            'ねえ、これほんとにやろうよ。話してるだけじゃなくて。来週の予定どんな感じ？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            '連絡取り合おうよ。はい、番号教えるね。LINE使ってる？何でもいいよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            '正直、こういうの必要だった。こうやってゆっくり話すの久しぶりだったから。今夜はありがとう、みんな。',
        ],
