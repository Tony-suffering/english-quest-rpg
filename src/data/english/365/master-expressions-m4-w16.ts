...
export const MONTH4_W16_EXPRESSIONS: MasterExpression[] = [
...

    {
        ...
        jaTranslations: [
            '試合どうだった？',
            'ねえ、今日の試合どうだった？',
            '今日の試合見れなかったんだけど、勝った？何があったの？',
            'すごい試合見逃したな。9回に追いついてサヨナラ二塁打で勝ったんだよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'いい試合だったよ。',
            '実はかなりいい試合だったんだよ。',
            'いい試合見逃したな。最後の最後まで接戦だったぞ。',
            'え、最後まで接戦だったの？夜更かしして見ればよかったなあ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'あのプレー見た？',
            'ちょっと待って、あのプレー見た？ありえないだろ。',
            'あのキャッチ見たって言ってくれ。今年のベストプレーだったぞ。',
            'おい、もう10回くらいリプレイ見たわ。どうやってあのボール届いたんだよ。やばすぎ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'あの審判ひどいな。',
            'マジかよ？あの判定ひどすぎだろ。',
            'あの審判、今夜ずっと誤審してるよ。両チームともイライラしてるだろ。',
            'だよな？5回のストライク判定とか完全に外れてたし。相手チームすら困惑してたぞ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'スポーツバーで見ようよ。',
            '試合はスポーツバーで見ない？',
            '7時から試合だし、でかいスクリーンあるスポーツバー探して手羽先でも食おうぜ。',
            '行く行く。5番街のあの店、でかいスクリーンあるし試合中は手羽先1ドルだぞ。行こう。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'あの選手は別格だな。',
            'あいつ完全にレベルが違うよ。',
            '20年この競技見てるけど、あいつが今まで見た中で一番才能あるかもしれん。',
            'ほんとそれ。楽々やってるように見えるもんな。世代に一人の才能を今見てるんだよ俺ら。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ルールがよくわからないんだけど。',
            '誰かルール教えてくれない？さっぱりわからん。',
            '見たいんだけど何が起きてるか全然わからない。なんで今止まったの？',
            '大丈夫、見ながら説明するよ。ぶっちゃけここにいる半分は周りに合わせて拍手してるだけだから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'これ延長行きそうだな。',
            'この試合の流れだと間違いなく延長だな。',
            'うわ、マジか。明日8時から仕事なのに。でもここまで見たら帰れないだろ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ハーフタイムだよ。',
            'ハーフタイムだ。もう一杯いこう。',
            'よし、ハーフタイムだ。飲み物追加してトイレ行くのにちょうどいいタイミング。',
            'やっとか。20分くらい我慢してたわ。ビールも頼んどいて。次は俺が奢るから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '生で見たいな。',
            'いつか生で試合見たいんだよね。',
            'テレビで見るのも楽しいけど、やっぱ現地には敵わないよ。雰囲気が全然違うもん。',
            '絶対行った方がいいよ。去年行ったけど雰囲気が段違い。テレビじゃ伝わらないって。',
        ],
...

    {
        ...
        jaTranslations: [
            '推しがいるんだよね。',
            'もう完全にハマってる人がいるの。',
            'グループの中に一人、ガチで推してるメンバーがいて。絶対的な推しなの。',
            'え、血液型まで知ってるの？すごい献身っぷりだね。いや怖いかも。正直どっちかわからん。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'グッズ全部集めてるよ。',
            '出たグッズは全部持ってるの。一つも逃してない。',
            'もう部屋が祭壇みたいになってて。アルバムもフォトカも限定品も全部あるよ。',
            '4000ドル？グッズに？いやまあ確かに部屋は博物館みたいだけどね。ちょっとすごいわ正直。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ファンミーティング行ってきたよ。',
            'ファンミから帰ってきたばっかりなんだけど、まだ震えてる。',
            '実際に会えたんだよ。ずっと心臓バクバクだった。',
            '30秒で頭真っ白になったの？あるあるだな。でも笑ってもらえたんならいいじゃん。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'それ完全にオタクじゃん。',
            'お前ガチのオタクだな。',
            '別に否定しないけど、それ相当な入れ込みようだよな。',
            'タオルのために東京まで飛んだの？タオルだよ？しかも真顔で言ってるし。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '新曲がやばい。',
            '新しいシングル聴いた？神曲だよ。',
            '新曲出たんだけど一日中リピートしてる。めちゃくちゃいい。',
            'わかる、もうサビが頭から離れない。あとブリッジのベースドロップ、毎回鳥肌立つ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '引退したらどうしよう。',
            '正直、引退されたら何していいかわからない。',
            '解散するかもって考えると夜も眠れない。まだ心の準備ができてない。',
            'そういうこと言うなって。先週引退の噂一つ見ただけでパソコン閉じて散歩しに行ったわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ライブ最高だった。',
            '今まで行ったライブで一番よかった。断言する。',
            '昨夜からまだ鳥肌立ってる。あの会場の熱気はやばかった。',
            'めっちゃ羨ましい。アンコールでアコースティックバージョンやった？あそこやばかったって聞いたけど。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '推しにお金使いすぎてるわ。',
            '推し活の出費がちょっと制御不能になってきた。',
            '計算したら今年グッズに食費より使ってた。多分やばい。',
            'おい、先月フォトカに俺の食費以上使ってたぞ。予算決めたら？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ファン同士の繋がりがいいよね。',
            '一番いいのはファン仲間と出会えたことかな。',
            '思ってなかったけど、ファンコミュニティで一番の親友ができた。',
            'それいい話だね。俺のジム仲間も同じパターンだよ。共通の推しで仲良くなって今めっちゃ仲いい。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '推し活は自分へのご褒美だから。',
            '自分の幸せへの投資だと思ってるよ。',
            'セラピーにお金使う人もいるじゃん。私はライブチケットに使う。同じことだよ。',
            'まあ幸せで借金してないなら誰も文句言えないでしょ。好きにしなよ。',
        ],
...

    {
        ...
        jaTranslations: [
            '勝ったよ！',
            '勝ったよ！信じられない！',
            'マジで勝ったわ。まだ信じられん。すごい試合だった。',
            'うそだろ！第3クォーターでもう終わりだと思って消したのに。最後見逃したなんて。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '負けた。最悪。',
            '負けた。もう話したくない。',
            '勝ち確だったのに最後の5分で台無しにしやがった。泣きたい。',
            'うわあ。今朝の顔見てわかったよ。全然寝てない顔してた。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '何対何だった？',
            '最終スコアいくつだった？',
            'スコア見れなかったんだけど、どうなった？接戦だった？',
            '3対2。ずっと接戦だったよ。ハイライト見た方がいいって。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '監督が問題だ。',
            '正直、あの監督クビにすべきだよ。',
            '選手は悪くないんだよ。采配がチームの足引っ張ってんだ。',
            'お前もう2年それ言ってるよな。でも正直、昨日の交代見て俺も同意し始めたわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '逆転勝ちだったよ。',
            '10点差からひっくり返したんだよ。',
            '3Qでもうテレビ消そうとしたんだけど、消さなくてマジよかった。逆転がやばかった。',
            'マジ？15点差でもう消そうとしたけど、最後まで見てよかったわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '引き分けだった。',
            '引き分け？モヤモヤするわ。',
            'あんだけ盛り上がっといて引き分けかよ。ちゃんとした結末返してくれよ。',
            'ほんとそれ。3時間返せよ。誰も勝ってねえし。延長やれよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '優勝あるかもよ。',
            'この調子なら優勝いけるんじゃない？',
            'フラグ立てるつもりはないけど、今年はマジでタイトル狙えるチャンスあるぞ。',
            'フラグ立てんな！去年も同じこと言ってたじゃん。結果どうなったよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ハイライト見た？',
            'ハイライト見てみ。信じられないから。',
            '結果知ってたのにハイライト集見たら鳥肌立ったわ。',
            'もう2回見たわ。最後のゴールで実況の声が完全に枯れてたの、もう映画だよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '今シーズンは期待できそうだ。',
            '今シーズンはいい予感するんだよな。',
            'オフの補強が上手くいったし、戦力充実してる。今年は俺らの年だぞ。',
            'データ上はな。でもお前、去年プレーオフ始まる前に優勝記念の帽子買ってなかったっけ？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '結局のところ、勝つことがすべてだ。',
            'スポーツは結果がすべてだよ。',
            'どんなに美しい試合をしても、負けたら誰も覚えてないんだよ。',
            'それちょっと厳しくない？歴代最高の試合って、優勝してないチームがやってたりするぞ。',
        ],
...

    {
        ...
        jaTranslations: [
            'ジムに通い始めた。',
            '先月ジム入会して、ちゃんと行ってるんだよね。',
            'ついにジム入会して、週3で通ってる。自分でもびっくりしてる。',
            'え、マジ？今回はちゃんと続いてんの？素直に感心するわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'どんなトレーニングしてるの？',
            'ルーティンは？筋トレ？有酸素？何やってんの？',
            'プログラム組んでるの？それともその日の気分でやってる感じ？',
            '正直、全部ちょっとずつやってる。筋トレも有酸素も。考えすぎないで、とにかく動けよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '筋肉痛がやばい。',
            '全身筋肉痛。まともに歩けない。',
            '昨日脚やったんだけど、座るだけで顔歪むわ。階段が敵だよ。',
            '脚の日？わかる。俺も初めてスクワットやった後、3日間座れなかったわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '一緒に走らない？',
            '明日の朝走るんだけど、一緒にどう？',
            '週3で走ってるんだけど、一人より二人の方が楽しいし。どう？',
            'いいよ。でも最初の1kmで置いていったら、俺は即Uターンして帰るからな。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'プロテイン飲んでる？',
            'プロテインとかサプリとか飲んでる？',
            'ネットでプロテインパウダー注文したんだけど、どの味がいいかわからん。おすすめある？',
            'チョコはやめとけ。マジで溶けたタイヤの味するから。リサが使ってるブランドのバニラにしろ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '体重計がピクリとも動かない。',
            '1ヶ月運動してるのに体重変わんないんだけど。',
            '週4で運動して食事も気をつけてるのに体重ビクともしない。もうイライラする。',
            '体重計なんか忘れろ。筋肉は脂肪より重いんだよ。服のサイズ変わってたら、それが本当の成果だ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ちゃんとストレッチしろよ。',
            '前後にストレッチしろって。マジで。',
            '一回ストレッチサボったら筋を痛めてさ。人生最悪の一週間だった。二度とサボらん。',
            '俺もそれ身をもって学んだわ。先月ウォームアップサボって背中やっちまった。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '休む日も大事だよ。',
            '休息日取れよ。体の回復に時間が必要なんだから。',
            '毎日行きたい気持ちはわかるけど、それ逆効果なんだよ。休むのもトレーニングのうちだ。',
            'ほんとそれ。一回毎日行ってみたけど、3週間で体がぶっ壊れた。休息日はガチで必要。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'フォームがすべてだ。',
            'まずフォームを意識しろ。重さは後からでいい。',
            'トレーナーにスクワットのフォーム直してもらったら全く別の種目になった。何ヶ月も間違ってたわ。',
            'わかる。デッドリフトのフォーム動画見たら、何ヶ月もずっと間違ってたことに気づいたわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '今日はほんと行きたくない。',
            '今日ジムサボろうかな。めっちゃ疲れてるし。',
            '全身全霊がソファから動くなって言ってる。ジムは明日でいいだろ。',
            'いいから行けよ。いつも行った後すごくいいって言ってんだろ。靴履いて考えるのやめろ。',
        ],
...

    {
        ...
        jaTranslations: [
            'どこのチーム応援してるの？',
            'で、どこのファン？どこ応援してるの？',
            '友達続けられるかどうか、応援してるチーム次第だからな。言ってみ。',
            'うわ、ジャイアンツだけはやめてくれ。ジャイアンツだったらマジでこの店出るぞ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'にわかファンじゃないよ。',
            '強くなる前からずっとファンだったんだよ。',
            '最弱時代もずっと応援してたんだ。今喜ぶ権利は稼いだよ。',
            'まあそれなら認める。あの7年間の負け越しシーズン耐え抜いたなら、自慢する権利あるわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '観客がすごかった。',
            'スタジアムの熱気がマジですごかった。',
            'あんなうるさい観客初めてだよ。あの雰囲気は今まで体験したことない。',
            'だろうな。6万人が一斉にチャントしたら、マジで胸にズンって来るもんな。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '今年こそ全部勝ってほしい。',
            '今年は俺らの年だ。感じるんだよ。',
            'このメンバーで今年優勝できなかったら、他に何が必要なんだよ。',
            'お前毎年それ言うじゃん！でも正直、今回は戦力ガチで充実してるな。慎重に同意しとくわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'あのチームだけは無理。',
            'あのチームは全身全霊で嫌いだ。',
            'リーグで一つだけ負けてほしいチームがあるとしたら、あそこだ。論理的な理由すらない。',
            '同じく。理由すらないんだよ。あのユニフォーム見ただけで何かがキレる。もう本能だわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '子供の頃からファンなんだ。',
            '親父と一緒に見て育ったんだよ。血に流れてるんだ。',
            '一番古い記憶は、リビングの小さいテレビで親父の膝の上に座って試合見てたことだな。',
            'それいいな。試合見ながら親父のこと思い出すって、それがスポーツの本質だよな。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ユニフォーム買っちゃった。',
            '我慢できなかった。新しいユニフォーム買っちゃった。',
            '新しいホームユニ出た瞬間、5分で注文したわ。後悔はない。',
            'また？これで何枚目？8枚くらい？お前のクローゼット、もはやチームショップだろ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '移籍しないでほしい。',
            'トレードされたら俺マジで立ち直れない。',
            '移籍の噂があるんだけど、正直感情的にどう処理すればいいかわからん。',
            '噂がどんどんデカくなってるよな。もしライバルチームに行ったら、俺マジでどうしていいかわからん。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '応援歌歌おう！',
            'みんな！一緒にチャント歌おうぜ！',
            '歌詞知らなくてもいいから。でかい声で知ったフリして歌え。',
            '歌詞知らないけど関係ないだろ。Aメロはモゴモゴして、サビだけ叫ぶわ。みんなそうだし。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'スポーツは人を繋げるよな。',
            '世界で何が起きてても、スポーツは人を一つにできるんだよ。',
            '知らない人同士が昔からの友達みたいにハイタッチするの、最高だよな。',
            'だよな？あのゴールの後、隣の知らないやつとハイタッチしたけど、何年来の友達みたいだったわ。',
        ],
...

    {
        ...
        jaTranslations: [
            'トレードされたらしいよ。',
            '聞いた？今朝トレードされたんだって。',
            '朝起きたらトレードのニュースで、一日中テンション下がりっぱなしだわ。',
            'え、マジ？先週残りたいって言ってたじゃん。冷たくね？どこに出されたの？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '怪我したらしいよ。',
            '悪いニュース。怪我で離脱だって。',
            '前十字靭帯断裂だって発表があった。今シーズン絶望だよ。',
            '前十字？最低8ヶ月は離脱だろ。シーズン終わったな。あいつがかわいそうだわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'FAになるらしいよ。',
            '契約切れるんだって。FA になるよ。',
            'この冬FAになるから、リーグ全チームが狙ってくるぞ。',
            'リーグ全チームが札束投げつけるだろうな。残ってくれよ。オフシーズンの失恋はもう耐えられん。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '新記録出たんだって。',
            '見た？昨夜歴代記録を更新したんだよ。',
            'やったんだよ。30年間破られなかった記録をついに更新した。歴史の目撃者になったわ。',
            '30年だぞあの記録。家でテレビ見てたんだけど、リビングで一人で立ち上がって拍手したわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '引退するらしいよ。',
            '引退発表したんだって。一つの時代の終わりだな。',
            'マジで引退するとは信じられない。まだ実感湧かないわ。',
            '一つの時代が終わったな。あの人のプレー見て育ったんだよ。もう同じじゃないよな。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ドラフトで誰取るかな。',
            'ドラフトもうすぐだけど、誰指名すると思う？',
            'あのクォーターバックを1位で取らなかったら、俺マジで頭おかしくなるわ。',
            'あのQB取らなかったら俺もう知らん。でもうちのフロントなら、誰も知らないやつ取るんだろうな。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '移籍金やばいね。',
            'いくら払ったの？馬鹿げた金額だろ。',
            '一人の選手に2億ドル。プロスポーツの経済学は俺には理解できん。',
            '2億ドルだぞ。俺は4年間大学行ったのに、こいつはボール蹴ってそれ稼ぐんだ。すごい時代だわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'シーズンオフ暇すぎる。',
            'シーズンオフ嫌い。何していいかわかんない。',
            'シーズン終わって1ヶ月で、もう過去10年分のハイライト全部見たわ。',
            '俺も。何かを感じたくて昔の試合見直してる。今の俺の週末、存在意義ゼロだわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ネットが大騒ぎだよ。',
            'SNSが完全に溶けてるわ。',
            '1時間ずっと反応見てるけど止められない。ミームがやばすぎる。',
            '1時間スクロールしてるけど止まらん。誰かがあのトレードをゲーム・オブ・スローンズの裏切りに例えてて、もう5万いいねついてるわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '解説者はいつも外すよな。',
            'スポーツアナリストって何も当たらないよな。自分の直感の方が信頼できるわ。',
            '専門家が全員、実際と逆の予想してたぞ。コイン投げた方がマシだろ。',
            'ほんとそれ。テレビのあいつ、最下位予想したチームが優勝したからな。マジでコイン投げろよ。',
        ],
...

    {
        ...
        jaTranslations: [
            'フェスに行きたい。',
            '来月音楽フェスがあるんだけど、マジで行きたい。',
            'ちゃんとした野外フェス行ったことないんだけど、この夏ついに実現させる。',
            'でもそれ毎年言ってるよな。今回はマジで行くの？本気なら俺も行くけど。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'チケット取れた！',
            'チケット取れた！信じられない！',
            'オンラインの待ち列で45分待って、なんとかチケット取れた。手が震えてる。',
            'うそ、すごいじゃん！まだあるなら俺のも取ってくれ。今夜返すから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '何持っていけばいい？',
            '何持っていけばいい？初めてのフェスなんだけど。',
            '持ち物リスト作ってるんだけど、実際何がいるかわからん。行ったことある人、アドバイスくれ。',
            'モバイルバッテリーと歩きやすい靴。この2つが前回の命綱だった。あとはなんとかなるよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '一緒に行かない？',
            'チケット余ってるんだけど、行かない？',
            '絶対楽しいと思うよ。行きたかったらチケット取っとくから言って。',
            '出演者リスト聞いた時点で決まった。あのバンドが土曜のヘッドライナーなら行く。チケットのリンク送って。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'めちゃくちゃ混んでた。',
            '人がやばかった。まともに動けなかった。',
            'あんな人数一箇所に見たことない。ステージ間の移動だけで30分かかったわ。',
            'だよな。後ろの方にいるのが正解だよ。音は普通に聞こえるし、息もできるし。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '開場何時？',
            '開場何時？早めに着きたいんだけど。',
            '2時開場なら12時には並びたい。前座見逃したくないし。',
            'じゃあ1時には着こう。去年は3時の時点で列が建物一周してたらしいから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '物販の列がやばかった。',
            '物販の列に1時間以上並んだわ。',
            'やっと物販の先頭に着いたら、半分もう売り切れてたんだよ。',
            '1時間並んで欲しいTシャツ売り切れ？えぐいな。次は真っ先に物販行けよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '帰りの電車満員だろうな。',
            'ちょっと早めに出て混雑避けない？',
            '前ここのイベント行ったとき、電車が激混みで帰るのに2時間かかったわ。',
            '15分早めに出よう。前回電車でイワシ缶状態になって、ライブの余韻が完全に消えたわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '写真めっちゃ撮った。',
            'カメラロールパンパン。300枚くらい撮った。',
            '今を楽しもうとしつつ全部記録もしたくて、両方中途半端になった。',
            '当ててやろうか、半分は誰かの後頭部のブレブレ写真だろ。次はスマホしまって楽しめよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '来年も絶対行く。',
            '来年もう計画してる。あれは見逃せない。',
            'いくらかかっても予定がどうでも関係ない。今後毎年このイベント行くわ。',
            '来年は俺も入れてくれ。今回みたいな感じなら、もう見逃さないわ。',
        ],
...

    {
        ...
        jaTranslations: [
            'どんどんハマっていく。',
            '知れば知るほど夢中になるんだよ。',
            '最初は軽い興味だったのに、もう完全に生活を支配されてる。',
            'いつもそうやって始まるんだよ。深夜にYouTube1本見たら、気づいたら5万円分の道具買ってるやつ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '道具にこだわり始めた。',
            '安物から始まったのに、気づいたら高級品をひたすら調べてる。',
            '昨日の夜3時間、スマホより高い機材のレビュー読んでたわ。',
            'あーあ、道具沼に入ったな。一番金がかかるフェーズだぞ。お前の財布はもう戻ってこない。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'YouTubeで独学してる。',
            'YouTubeが先生だよ。全部動画で覚えた。',
            'ちゃんとした先生はいないけど、正直YouTubeの無料コンテンツの方が有料講座より良いんだよ。',
            'マジでそう。ガレージで撮ってる名前も知らんやつの動画が、大学4年間より俺に教えてくれたわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '同じ趣味の仲間が見つかった。',
            '地元のグループに入ったんだけど、同じ趣味の人と出会えて最高だよ。',
            '何年も自分だけだと思ってたのに、ネットで丸ごとコミュニティ見つけたんだ。',
            'あの感覚最高だよな。俺も同じようにして仲間見つけて、今は毎月集まってる。人生変わったわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '沼にハマった。',
            'もう深すぎて戻れない。',
            '軽い興味から始まったのに、もう完全な沼。誰か止めてくれ。',
            'もう戻れないよな？一回沼に入ったら、新しいアイデンティティとして受け入れるしかない。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '上達してきた気がする。',
            'ちゃんと成長が見えるようになってきた。いい気分だよ。',
            '半年前に作ったやつと今のを比べたら、差がすごかったわ。',
            'ビフォーアフター見せてくれよ。そういう成長見るの大好きだし。一番やる気出るやつ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '教えてくれない？',
            'ずっとやってみたかったんだよね。基本だけ教えてくれない？',
            'めっちゃハマってるの知ってるから、時間あったら教えてほしいんだけど。',
            'もちろん！教えると自分も上手くなるんだよね。今週末で日にち決めよう。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '趣味にお金かけすぎかな。',
            '趣味の出費が手に負えなくなってきた。',
            '今年この趣味にいくら使ったか計算したんだけど、考えないことにした。',
            '24時間ルール試してみ。カートに入れて1日待って、まだ欲しかったら買え。俺はいつもそれで助かってる。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '何やっても続かないんだよね。',
            'いつも最初はやる気あるのに、数週間で飽きるんだよ。',
            '俺の趣味歴は放棄された興味の墓場だよ。全部試して何一つ完走してない。',
            '少なくとも色々やってるじゃん！大体の人はソファでゴロゴロしてるだけだよ。そのうちどれか続くかもよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '趣味があるのは大事だよ。',
            '自分だけの何かが必要なんだよ。仕事のためでも人のためでもない、自分のためのやつ。',
            '趣味のおかげで正気を保ってるわ。なかったら仕事と睡眠だけで頭おかしくなってる。',
            'ほんとそれ。没頭してると何時間もスマホ見ないんだよな。脳のリセットボタンみたいなもんだわ。',
        ],
...

    {
        ...
        jaTranslations: [
            'この一ヶ月楽しかったね。',
            'もう一ヶ月終わったとか信じられない。あっという間だったな。',
            '振り返ると、すごく成長した気がする。最高に楽しかったわ。',
            'ほんとあっという間だったな。みんなのことすごくよく知れた気がする。最高の一ヶ月だった。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '英語で意見が言えるようになった。',
            '一ヶ月前は映画の感想すら英語で言えなかったのに、今は議論できるんだ。',
            '一番変わったのは語彙じゃない。自分の考えを英語で言う自信がついたことだ。',
            '正直、俺もそう。一ヶ月前は「いい」しか言えなかったのに、今はなぜいいか説明できる。すごい進歩だよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '好きなことだと覚えやすいんだよ。',
            '今月めっちゃ新しい単語覚えたのは、内容に興味があったからだよ。',
            'コツは頑張って勉強することじゃない。マジで興味あることを勉強することだ。',
            'だよな？binge-watchとかsold outとかの単語は絶対忘れないもん。興味あるから。教科書じゃそうはいかない。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '来月も楽しみだな。',
            '来月何やるんだろ。もうワクワクしてるわ。',
            '来月が今月の半分でも楽しかったら、最高の時間になるぞ。',
            'テーマが何でも俺は参加する。みんなでやるなら、なんでも来い。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '映画の話が一番盛り上がったな。',
            '映画ほど人を喋らせるものはないよな。一晩中でも話せたわ。',
            '今月一番時間使ったのは映画の議論だった気がする。でも毎秒楽しかったわ。',
            '同意。あの夜、映画について2時間くらい言い合ったよな。英語で一番楽しかった瞬間だわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '推し活の話は爆笑だったな。',
            'ファン文化がここまで深いとは知らなかったわ。ミナに目を開かされた。',
            '推し活ってバカにしてたけど、みんなの話聞いたらわかるようになった。',
            '俺もそう。くだらないと思ってたけど、よく考えたらスポーツファンと同じことやってるんだよな。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'スポーツの表現が一番使えそうだ。',
            'スポーツ英語は実際の会話で一番出てくる気がする。',
            'スポーツの語彙を学ぶのはスポーツだけの話じゃないんだよ。半分は日常英語で使う表現だ。',
            'マジそれ。この前会議で上司がslam dunkって言ったんだけど、初めてニュアンスがわかったわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'みんなと話すのが一番の練習だよ。',
            'この居酒屋で一晩話す方が、教科書一週間分より学べるんだよ。',
            '本物の会話が本物の学びの場なんだよ。ここにあるものは、どんなアプリでも再現できない。',
            'お前もそうだよ。正直、この会話がどんなアプリや教科書より俺の英語を伸ばしてくれたわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '一ヶ月お疲れ様！',
            'また一ヶ月乗り越えたな。乾杯！',
            '4ヶ月目終了。ここまで続けたみんなを誇りに思うよ。',
            '4ヶ月で誰も脱落してない。普通にすごいわ。俺らを誇りに思う。乾杯。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '乾杯！来月もよろしく！',
            'みんな乾杯！来月も最高の一ヶ月にしよう！',
            'グラス上げろ！4ヶ月目完了、5ヶ月目が待ってるぞ。俺らならいける！',
            'みんな乾杯！5ヶ月目に乾杯。泣いてないよ、お前が泣いてんだよ。...いや、ちょっと泣いてるわ。乾杯！',
        ],
