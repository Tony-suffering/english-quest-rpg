...
export const MONTH2_W5_EXPRESSIONS: MasterExpression[] = [
...

    {
        ...
        english: [
            ...
            "Oh no, you look wrecked. Did you at least grab coffee on the way?",
        ],
        jaTranslations: [
            '寝坊した。',
            '今朝マジで寝坊した。',
            '寝坊して朝ごはん食えなかった。ギリ電車乗れたけど。',
            'うわ、顔死んでるよ。せめてコーヒーは買った？',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Same here. I don't even make eye contact with anyone before my second cup.",
        ],
        jaTranslations: [
            'コーヒーが必要。',
            'コーヒーないと動けない。',
            '最初の一杯飲むまでマジで人間として機能しない。',
            'わかる。俺も2杯目までは誰とも目合わせたくない。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Just toast. I'm boring like that. You?",
        ],
        jaTranslations: [
            '何食べた？',
            '朝ごはん何食べた？',
            '朝ごはん何食べた？俺は途中でおにぎり買っただけ。',
            'トーストだけ。つまんない人間でしょ。そっちは？',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Every morning? That's impressive. I can barely get out of bed, let alone go for a run.",
        ],
        jaTranslations: [
            '毎朝ジョギングしてる。',
            '毎朝ジョギングに行ってる。',
            '毎朝ジョギング行くようにしてる。20分だけでも。',
            '毎朝？すごいな。俺なんかベッドから出るのすら無理なのに、走るとか論外だよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "An hour? That's rough. Have you thought about moving closer to the office?",
        ],
        jaTranslations: [
            '仕事まで1時間。',
            '通勤は大体1時間くらい。',
            '家から会社までドアツードアで1時間くらいかかる。',
            '1時間？キツいね。もっと会社の近くに引っ越すとか考えない？',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "You're gonna be late to your own wedding someday. Seriously, set your clocks five minutes ahead.",
        ],
        jaTranslations: [
            'いつもギリギリ。',
            'いつもギリギリになっちゃう。',
            'いつも遅刻ギリギリ。ほんと最後の最後まで家出ない。',
            'お前いつか自分の結婚式にも遅刻するぞ。マジで時計5分進めとけ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Yeah, I can tell. You look like you're still half asleep right now.",
        ],
        jaTranslations: [
            '朝型じゃないんだよね。',
            '朝はほんと苦手で。',
            'マジで朝型じゃない。脳みそが昼まで起動しない。',
            'うん、見ればわかる。今もまだ半分寝てるみたいだし。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Cold shower or warm? 'Cause I've heard cold ones wake you up way faster.",
        ],
        jaTranslations: [
            'まずシャワー浴びる。',
            '出かける前にさっとシャワー浴びる。',
            '朝は絶対シャワー浴びてから出る。目が覚めるんだよね。',
            '冷水？お湯？冷たい方がもっと目覚めるって聞いたことあるけど。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Ha! I'd rather be the worm, honestly. At least the worm got to sleep in.",
        ],
        jaTranslations: [
            '早起きは三文の徳。',
            '早起きは三文の徳って言うけどさ...',
            '早起きは三文の徳って言うけど、正直もっと寝たい。',
            'ハハ！俺はむしろ虫の方がいいわ。少なくとも虫は寝坊できたし。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "That happened to me last week. Maybe it's time to get a backup alarm or something.",
        ],
        jaTranslations: [
            '目覚まし鳴らなかった。',
            '今朝目覚まし鳴らなかったんだよ。',
            '目覚まし鳴らなかった。いや、鳴ったのかもだけど完全に寝てた。',
            '先週俺もそれやった。予備の目覚ましでも買った方がいいんじゃない？',
        ],
...

    {
        ...
        english: [
            ...
            "Yeah, sure. Pull up a chair, let's take a look.",
        ],
        jaTranslations: [
            'ちょっと確認いい？',
            '一つだけ確認させて。',
            'ねえ、一個だけさっと確認したいんだけど。今ちょっといい？',
            'うん、いいよ。椅子持ってきて、一緒に見よう。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "End of day Friday, I think. But don't quote me on that -- check with the manager.",
        ],
        jaTranslations: [
            '締め切りいつ？',
            'これいつまで？',
            'これいつまで？ちゃんと時間確保しておきたくて。',
            '金曜の終業時だと思う。でも俺の言葉を鵜呑みにしないで、マネージャーに確認して。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Tell me about it. I almost fell asleep when they started talking about the budget.",
        ],
        jaTranslations: [
            '会議長すぎ。',
            'あの会議長すぎたわ。',
            'あの会議永遠に続いた。目開けてるの必死だった。',
            'ほんとそれ。予算の話始まった時マジで寝そうになった。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Perfect, thanks. Let me know if they don't get back to you by tomorrow.",
        ],
        jaTranslations: [
            'メール送った。',
            'もうメール送っといたよ。',
            'さっきメール送っといた。フォロー必要なら言って。',
            '完璧、ありがとう。明日までに返事来なかったら教えて。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Already? Lucky you. I've still got like an hour of work left. See ya!",
        ],
        jaTranslations: [
            'もう帰るね。',
            'お先に帰るわ。また明日。',
            '今日はこれで上がるね。みんなまた明日。',
            'もう？いいなあ。俺まだ1時間くらい残ってるわ。じゃあね！',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Of course. What are you stuck on? Show me what you've got.",
        ],
        jaTranslations: [
            '手伝ってくれる？',
            'これちょっと手貸してくれない？',
            'ねえ、これちょっと手伝ってくれない？ちょっと詰まってて。',
            'もちろん。どこで詰まってるの？見せて。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Got it. I'll just ping you on Slack if anything comes up.",
        ],
        jaTranslations: [
            '今日は在宅勤務。',
            '今日は家で仕事してる。',
            '今日はリモートで。Slackなら連絡つくよ。',
            '了解。何かあったらSlackで連絡するわ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "No worries, I totally get it. I'll ask someone else. Hang in there.",
        ],
        jaTranslations: [
            '忙しすぎ。',
            '今めっちゃ忙しい。',
            '今週マジでパンパン。これ以上は引き受けられないかも。',
            '全然大丈夫、わかるよ。他の人に頼むわ。頑張って。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Awesome, you're a lifesaver. Just loop me in when it's done.",
        ],
        jaTranslations: [
            '了解。',
            '了解、やっとくね。',
    ...
    },
    {
        ...
        english: [
            ...
            "Oh, I'm down. That new ramen place? I've been wanting to try it too. Let's go.",
        ],
        jaTranslations: [
            'ランチ行かない？',
            'ランチ一緒にどう？',
            'ねえ、ランチ行かない？行ってみたい店あるんだけど。',
            'いいね、行く。あの新しいラーメン屋？俺も気になってた。行こう。',
        ],
...

    {
        ...
        english: [
            ...
            "It comes with a soup and a small salad. And sure, iced coffee's no problem.",
        ],
        jaTranslations: [
            '日替わりランチで。',
            '日替わりランチにします。',
            '日替わりランチにする。何がついてくるの？',
            'スープと小さいサラダがつきます。アイスコーヒーも大丈夫ですよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "It's chicken, peppers, and a cream sauce. No nuts or anything, if that's what you're worried about.",
        ],
        jaTranslations: [
            'これ何が入ってる？',
            'この料理何が入ってますか？',
            'すみません、これ何が入ってます？ちょっと好き嫌いあって。',
            'チキンとピーマンとクリームソースです。ナッツとかは入ってないですよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Sure, we can do a large for an extra two hundred yen. Want me to go ahead and do that?",
        ],
        jaTranslations: [
            '大盛りできる？',
            '量多めにできますか？',
            '大盛りにできますか？今日めっちゃお腹空いてて。',
            'はい、プラス200円で大盛りにできますよ。しましょうか？',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "No problem at all. I'll bring four separate checks in a sec.",
        ],
        jaTranslations: [
            '別会計でお願いします。',
            '会計別々にできますか？',
            '別会計にしてもらえますか？各自で払うんで。',
            '全然大丈夫ですよ。4つに分けてすぐ持ってきますね。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Of course. I'll have it boxed up for you in just a minute.",
        ],
        jaTranslations: [
            '持ち帰りできる？',
            'これ持ち帰りでお願いします。',
            'やっぱり持ち帰りにしてもらえますか？仕事で急用できちゃって。',
            'もちろんです。すぐ箱に入れますね。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Honestly, you can't go wrong with the teriyaki set. That's what most people get.",
        ],
        jaTranslations: [
            'おすすめは？',
            'ここ何がおいしい？',
            'ここ何がおいしいの？初めてだから全然わかんなくて。',
            '正直、照り焼きセットにしとけば間違いないよ。みんなそれ頼むし。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Yeah, let's just try that Thai place down the street. I don't feel like waiting.",
        ],
        jaTranslations: [
            '混んでるね。',
            'ここめっちゃ混んでるな。',
            'うわ、ギュウギュウだ。待つ？それとも他のとこ行く？',
            'そうだな、あの通りのタイ料理屋にしよう。待つ気分じゃないわ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Right? I told you this place was good. Try the garlic bread too, it's insane.",
        ],
        jaTranslations: [
            'これ美味い！',
            'これマジで美味い！',
            'うわ、これやばい美味い。絶対食べてみて。',
            'でしょ？ここ美味いって言ったじゃん。ガーリックブレッドもやばいから食べてみ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "I warned you about the dessert. You never listen. Want me to get the check?",
        ],
        jaTranslations: [
            'お腹いっぱい。',
            'もう食えない。',
            'パンパンだわ。デザートまで頼んだの失敗だった。',
            'デザートやめとけって言ったじゃん。人の話聞かないよな。会計頼む？',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Yes, we take Visa and Mastercard. We also have PayPay if you prefer.",
        ],
        jaTranslations: [
            'カード使えますか？',
            'クレジットカード使えますか？',
            'すみません、カード使えますか？それとも現金のみ？',
            'はい、VisaとMastercardが使えます。PayPayもありますよ。',
        ],
...

    {
        ...
        english: [
            ...
            "It's not just you. I'm melting over here. Can we crank the AC up a little?",
        ],
        jaTranslations: [
            'めっちゃ暑い。',
            '今日めっちゃ暑くない？',
            '俺だけ？今日異常に暑くない？死にそうなんだけど。',
            'お前だけじゃないよ。こっちも溶けそう。エアコンもうちょい上げていい？',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Here, you can borrow mine. I've got a spare in my bag.",
        ],
        jaTranslations: [
            '傘持ってくればよかった。',
            '傘持ってくるべきだった。',
            '傘持ってくればよかった。来る途中でびしょ濡れになった。',
            'ほら、俺の使いな。カバンに予備入ってるから。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Ugh, don't remind me. My laundry never dries during rainy season. It's the worst.",
        ],
        jaTranslations: [
            '梅雨がもうすぐだね。',
            '梅雨がもう来るよね。',
            '梅雨もうすぐだよね。もう今から嫌だわ。',
            'うわ、思い出させないで。梅雨の時期洗濯物全然乾かないの最悪。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "I know, right? I wore sandals because of that stupid forecast. Big mistake.",
        ],
        jaTranslations: [
            '予報ハズレた。',
            '天気予報完全にハズレたね。',
            '予報では晴れって言ってたのにこれ見ろよ。完全にハズレ。',
            'だよね？あのクソ予報のせいでサンダル履いてきちゃったよ。大失敗。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Yes! Let's do it. I'll grab some drinks from the conbini on the way.",
        ],
        jaTranslations: [
            'いい天気。外で食べよう。',
            'めっちゃ天気いいじゃん。外で食べない？',
            '今日天気サイコーだな。たまには外で食べない？',
            'いいね！やろやろ。途中でコンビニ寄ってドリンク買ってくわ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "I saw someone's umbrella fly away on the street. It was kind of hilarious, actually.",
        ],
        jaTranslations: [
            '風がすごい。',
            'めっちゃ風強くない？',
            '今日風ヤバいな。髪ぐちゃぐちゃだわ。',
            '道で誰かの傘飛んでったの見たわ。正直ちょっとウケた。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Oh shoot, I totally forgot. Do you have any I can borrow real quick?",
        ],
        jaTranslations: [
            '日焼け止め塗った？',
            '日焼け止め塗った？',
            '日焼け止め塗った？焼けるよマジで。',
            'やば、完全に忘れてた。ちょっと貸してくれない？',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Seriously? I just made plans for Saturday. Guess I'd better stock up on snacks just in case.",
        ],
        jaTranslations: [
            '台風来るらしい。',
            '台風来るってよ。',
            '今週末台風来るらしいよ。買いだめしといた方がいいかも。',
            'マジで？土曜予定入れちゃったんだけど。とりあえずお菓子買い込んどくか。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "For real. It was freezing last week and now it's like summer. Make up your mind, weather.",
        ],
        jaTranslations: [
            '最近天気おかしい。',
            '最近天気変じゃない？',
            '気のせい？最近天気おかしくない？普通じゃないよこれ。',
            'ほんとそれ。先週凍えてたのに今は夏みたいだし。天気よ、どっちかにしろ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Oh no. You're gonna have to wash it all over again. That's so annoying.",
        ],
        jaTranslations: [
            '洗濯物出しっぱなしだった。',
            '洗濯物外に干しっぱなしにしてた。',
            '洗濯物干しっぱなしで今雨降ってるし。最高だわ。',
            'うわ最悪。全部洗い直しじゃん。だるすぎ。',
        ],
...

    {
        ...
        english: [
            ...
            "Let me think... Saturday I'm free after lunch. What did you have in mind?",
        ],
        jaTranslations: [
            '今週末空いてる？',
            '今週末ヒマ？',
            'ねえ今週末ヒマ？なんかしない？って思って。',
            'えーと…土曜の午後なら空いてるけど。何するつもり？',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "No rush. Just text me when you know for sure. We'll figure it out.",
        ],
        jaTranslations: [
            '予定あるかも。',
            'ちょっと予定入ってるかも。確認する。',
            'その日なんか入ってるかも。ちょっとカレンダー見させて。',
            '急がなくていいよ。確定したら連絡して。なんとかなるっしょ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Noon at the station works for me. I'll be the one half asleep with a coffee.",
        ],
        jaTranslations: [
            '何時に会う？',
            '何時がいい？',
            '何時に待ち合わせる？場所はどこにする？',
            '昼の12時に駅でいいよ。コーヒー持って半分寝てるやつが俺だから。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "I won't, I won't! I already blocked off my whole afternoon. I swear I'll be there.",
        ],
        jaTranslations: [
            'ドタキャンしないで。',
            '今回はドタキャンすんなよ。',
            '今回はドタキャンすんなよマジで。いっつもそうじゃん。',
            'しないしない！午後まるまる空けてあるから。絶対行くって！',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Yeah, that'd be great. Last time we didn't and we waited forever. Book it for seven?",
        ],
        jaTranslations: [
            '予約しようか？',
            '予約しとこうか？土曜混むかも。',
            '予約しといた方がよくない？土曜混むかもだし。',
            'うん、頼む。前予約しないで行って永遠に待ったじゃん。7時で取って。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "How about that Italian place near the station? I've been craving pasta all week.",
        ],
        jaTranslations: [
            'どこ行く？',
            'どこにする？',
            'どこ行く？正直なんでもいいけど。',
            '駅前のイタリアンは？今週ずっとパスタ食べたかったんだよね。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "No worries, next weekend works. I'll hold you to it, though!",
        ],
        jaTranslations: [
            'また今度にしよう。',
            'また今度にしよう。',
            'また今度にしよう。マジで行きたいんだけど今週ヤバくて。',
            '全然いいよ、来週末でも。でも約束だからな！',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Me too! It's been way too long. This is gonna be fun.",
        ],
        jaTranslations: [
            '楽しみにしてる。',
            '楽しみ！',
            '今週末めっちゃ楽しみ。久しぶりに遊ぶね。',
            '俺も！ほんと久しぶりだよね。絶対楽しいわ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Six, I think. Maybe seven if Mina's boyfriend tags along.",
        ],
        jaTranslations: [
            '何人来る？',
            '何人来るの？',
            '何人くらい来る？テーブルどのくらいの大きさ要るか知りたくて。',
            '6人かな。ミナの彼氏も来るなら7人。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Cool, just drop a pin. I'm terrible with addresses so a map link would help.",
        ],
        jaTranslations: [
            '場所はあとで送る。',
            'あとで場所送るね。',
            'あとで住所送るわ。ピン落とすから。',
            'おっけー、ピンでよろしく。住所覚えるの苦手だから地図のリンクだと助かる。',
        ],
...

    {
        ...
        english: [
            ...
            "You do sound a little off. Go home early and get some rest before it gets worse.",
        ],
        jaTranslations: [
            '風邪ひいたかも。',
            'なんかうつったかも。',
            'なんかうつったかもしれない。朝から喉がイガイガするんだよね。',
            '確かに声ちょっとおかしいね。悪化する前に早退して休みな。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "You should try stretching every hour or so. There's this YouTube video I use -- it actually helps a lot.",
        ],
        jaTranslations: [
            '肩が凝ってる。',
            '肩こりやばい。',
            '肩こりがやばい。マッサージ行きたいわ。',
            '1時間に1回くらいストレッチしてみ。YouTubeでいい動画あるんだけど、結構効くよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Wanna start going together? I need a gym buddy or I'll never go either.",
        ],
        jaTranslations: [
            '最近運動してない。',
            'もう何年も運動してないわ。',
            'もうずっと運動してない。マジでそろそろ再開しないと。',
            '一緒に行かない？誰かいないと俺も絶対行かないタイプなんだよね。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Get blue light glasses. I got mine last month and they've made a huge difference, honestly.",
        ],
        jaTranslations: [
            '目が疲れてる。',
            '目がめっちゃ疲れた。',
            '目が限界。一日中画面見てたわ。',
            'ブルーライトカットメガネ買いな。先月買ったけどマジで全然違うよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "That's what you said last time, too. You never learn. Drink some water, at least.",
        ],
        jaTranslations: [
            '昨日飲みすぎた。',
            '昨日飲みすぎたわ。',
            '昨日飲みすぎた。起きたら頭ガンガンで。',
            'それ前も言ってたよね。学ばないなお前。とりあえず水飲めって。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Have you tried melatonin? It knocked me right out when I was having the same problem.",
        ],
        jaTranslations: [
            '最近眠れない。',
            '最近全然寝れてないんだよね。',
            '最近全然寝れなくて。夜中に何回も起きちゃう。',
            'メラトニン試した？同じ症状の時に飲んだら一撃で寝れたよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Same. I've been taking allergy meds every day and I still can't stop sneezing. This season's brutal.",
        ],
        jaTranslations: [
            '花粉症がひどい。',
            '今年花粉症やばい。',
            '今年の花粉症マジで死ぬ。くしゃみ止まらん。',
            'わかる。毎日アレルギーの薬飲んでるのにくしゃみ止まんないもん。今年エグいわ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "You really should see someone about that. My friend went to a chiropractor and it helped a ton.",
        ],
        jaTranslations: [
            '腰が痛い。',
            '腰が痛いんだよね。',
            '腰がずっと痛い。そろそろ病院行かないとだめかも。',
            'マジで診てもらった方がいいよ。友達が整体行ったらめっちゃ良くなったって。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "I'm the opposite -- I can't eat anything when I'm stressed. Wish I could trade, though.",
        ],
        jaTranslations: [
            'ストレスで食べすぎる。',
            'ストレスでめっちゃ食べちゃう。',
            'ストレス溜まると食べまくっちゃうんだよね。仕事やばい時ずっと何か食べてる。',
            '俺逆だわ。ストレスで何も食べれなくなるタイプ。交換してほしいわマジで。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Thanks, I appreciate that. I think I'll take it easy this weekend and just recharge.",
        ],
        jaTranslations: [
            '無理しないで。',
            '無理すんなよ。',
            'あんまり無理すんなよ。ちゃんと休め。',
            'ありがと。今週末はゆっくりして充電するわ。',
        ],
...

    {
        ...
        english: [
            ...
            "Honestly? I just sleep in and binge Netflix. Not very exciting, I know.",
        ],
        jaTranslations: [
            '休みの日は何してるの？',
            '休みの日って何してんの？',
            '休みの日何してる？俺いつも気づいたら何もしてないんだけど。',
            '正直？寝坊してNetflix一気見。つまんないのはわかってる。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "I've actually been getting into pottery. It's weirdly addictive once you start.",
        ],
        jaTranslations: [
            '何か趣味ある？',
            '最近何にハマってる？',
            '最近何かハマってるものある？新しく始めたこととか。',
            '実は最近陶芸にハマってて。始めるとなんか中毒性あるんだよね。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Oh nice, have you seen anything good lately? I need recommendations.",
        ],
        jaTranslations: [
            '映画よく観る。',
            '映画結構観るよ。',
            '映画好きなんだよね。週1は観るようにしてる。',
            'へー、最近なんかいいのあった？おすすめ教えて。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Wait, you should show us some! I bet they're way better than you think.",
        ],
        jaTranslations: [
            '写真撮るのが好き。',
            '写真撮るのにハマってる。',
            '写真にハマっててさ。街中のスナップが多いかな。',
            'え、見せてよ！絶対自分で思ってるよりうまいって。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "What games are you playing right now? I just got into that new RPG everyone's talking about.",
        ],
        jaTranslations: [
            'ゲームする。',
            'ゲームするよ。結構ガチで。',
            'ゲーマーだわ正直。仕事終わったら毎日やってる。',
            '今何やってるの？最近話題のあのRPG俺も始めたんだけど。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Ooh, what are you reading right now? I've been looking for something new to start.",
        ],
        jaTranslations: [
            '読書が好き。',
            '読書が一番の趣味。',
            '読書が一番の趣味かな。常に本持ち歩いてるし。',
            'おー、今何読んでるの？新しいの探してたんだよね。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "No way, I had no idea! You gotta cook for us sometime. I'll bring the wine.",
        ],
        jaTranslations: [
            '料理するの好き。',
            '実は料理好きなんだよね。',
            '最近料理にハマってて。意外とリラックスできるんだよね。',
            'えっ知らなかった！今度作ってよ。ワイン持ってくからさ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "That sounds so fun. Take me with you next time! I never know where to go.",
        ],
        jaTranslations: [
            'カフェ巡りが好き。',
            'カフェ巡りにハマってる。',
            'カフェ巡りが好きで、ほぼ毎週新しいとこ行ってる。',
            'めっちゃいいね。今度連れてって！いつもどこ行けばいいかわかんないんだよね。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Wait, seriously? Do you still play? We should jam sometime.",
        ],
        jaTranslations: [
            '昔バンドやってた。',
            '昔バンドやってたんだよね。',
            '大学の時バンドやってたんだよ。ギター、信じられないだろうけど。',
            'え、マジで？まだ弾いてんの？今度セッションしようよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "You should try rock climbing. I started last month and I'm already hooked.",
        ],
        jaTranslations: [
            '何か始めたい。',
            '新しい趣味始めたいんだよね。',
            'なんか新しいこと始めたいんだよね。まだ何がいいかわかんないけど。',
            'ボルダリングやってみなよ。先月始めたけどもうハマってるわ。',
        ],
