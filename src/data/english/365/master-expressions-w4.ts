...
export const WEEK4_EXPRESSIONS: MasterExpression[] = [
    ...
    },
    {
        ...
        jaTranslations: [
            'センスいいね。',
            'センスめっちゃいいじゃん！',
            'ほんとセンスいいよね、俺だったら絶対思いつかない。',
            'まじでいっつもいいの選ぶよね。うらやましいわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '頑張ってるね。',
            'めっちゃ頑張ってるじゃん！',
            '努力してるの見ればわかるよ。ちゃんと結果出てる。',
            '正直、あんたに言われると嬉しいわ。まだまだやるよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            '2名でお願いします。',
            '2人だけなんです。',
            'かしこまりました。2名様で入れておきますね。変更あったらご連絡ください。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '7時に。',
            '7時くらいで、できれば。',
            '7時って大丈夫ですか？混んでたらずらせますけど。',
            '7時大丈夫ですよ。7時15分も空いてますけど、どっちがいいですか？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            '窓際の席ってありますか？',
            '窓際の席って空いてたりしますか？',
            'ちょっと確認しますね……はい、窓際ご用意できますよ。大丈夫です。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '個室ありますか？',
            '個室ってありますか？',
            'ちょっとプライベートな感じがいいんですけど、個室って空いてます？',
            '個室はないんですが、静かなコーナー席ならご案内できますよ。それでいいですか？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '誕生日なんです。',
            '実は誕生日の人がいるんです。',
            '誕生日のお祝いなんですけど、何か特別なことってやってもらえます？',
            'おめでとうございます！デザートにキャンドル付けてサービスしますよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'キャンセルしたいんですが。',
            'すみません、予約をキャンセルしたいんですが。',
            '申し訳ないんですけど、急用ができて今夜キャンセルしたいんです。',
            '全然大丈夫ですよ。キャンセルしておきましたね。お大事に。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '予約変更できますか？',
            '予約の変更ってできますか？',
            '予約の時間をずらしたいんですけど、いけますか？',
            '8時ですね？大丈夫ですよ、変更しますね。お名前と人数は同じですか？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '予約してあります。',
            'すみません、ケンジで予約してあるんですが。',
            '7時に予約してるケンジですけど。',
            'ケンジ様、2名様、7時ですね。はい、ございます。こちらへどうぞ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '遅れます。',
            'ちょっと遅れそうです、すみません！',
            'すみません、先に言っておくと15分くらい遅れそうです。席取っておいてもらえますか？',
            '大丈夫ですよ、お席確保しておきますね。気をつけて来てください。',
        ],
...

    {
        ...
        jaTranslations: [
            'お土産探してます。',
            'お土産を探してるんですけど。',
            '友達に何か持って帰りたくて、おすすめあります？',
            '何人分ですか？それがわかれば絞りやすいんで。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            '一番人気はどれ？',
            'みんな何買ってく？一番売れてるやつとか。',
            '正直、抹茶キットカットは飛ぶように売れるよ。あれ買っとけば間違いない。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '日本っぽいもの。',
            'すごく日本っぽいのが欲しくて。',
            'いかにも日本！って感じのが欲しいんだよね、ユニークなやつ。',
            '風呂敷とか見た？きれいだし、めっちゃ日本っぽいよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '予算は〜くらい。',
            '30ドルくらいに抑えたくて。',
            '一人30ドルくらいの予算なんだけど、その辺で何かある？',
            '30ドル？全然いけるよ、その価格帯いっぱいあるから。こっち来て。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '包んでもらえますか？',
            'ギフト用に包んでもらえます？',
            'ラッピングってやってますか？きれいにしたくて。',
            'はい、ラッピングできますよ。3ドル追加になりますが大丈夫ですか？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'いつまで持つ？',
            'これ賞味期限いつまでですか？',
            'これどのくらい持ちます？飛行機で持って帰りたくて。',
            'これ半年持つんで全然大丈夫ですよ。心配いらないです。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '飛行機に持ち込める？',
            'これ飛行機に持って行って大丈夫？',
            'これ税関通る？空港でトラブりたくないんだけど。',
            'それなら機内持ち込みで全然OKだよ。密封されてれば問題ないから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'みんなに配りたくて。',
            '会社のみんなに配るやつなんだ。',
            'バラで配れるやつがいいんだけど、個包装のってある？',
            'このクッキーの箱、中が個包装だから配るのにぴったりだよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'これ人気あるブランド？',
            'これ知られてる？みんなわかる感じ？',
            'あー、そのブランドめっちゃ有名だよ。日本行ったことある人なら一発でわかる。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'おすすめある？',
            '何がいいと思う？',
            'もし誰かにプレゼント買うとしたら、何選ぶ？',
            '俺だったら？この手ぬぐいセットかな。みんな喜ぶし、長持ちするし。',
        ],
...

    {
        ...
        jaTranslations: [
            'ゲートどこ？',
            'すみません、12番ゲートどこですか？',
            '12番ゲート探してるんですけど、こっちで合ってます？',
            'うん、まっすぐ行ってフードコート過ぎたら左にあるよ。もうすぐだよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '乗り継ぎです。',
            '別の便に乗り継ぐんです。',
            'ロサンゼルス行きの乗り継ぎなんですけど、ここからどこ行けばいいですか？',
            '大丈夫ですよ。乗り継ぎの案内に従ってください。セキュリティはもう通らなくていいです。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '荷物がない。',
            '荷物が出てこないんですけど。',
            'ずっと待ってるんですけど荷物出てこなくて、誰に言えばいいですか？',
            'あの角を曲がったとこに手荷物カウンターあるんで、そこ行ってください。追跡してくれますよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '申告するものは？',
            '何か申告しなきゃいけないものあります？',
            'これ申告いるかわかんないんですけど、ただのお菓子なんですが。',
            'お菓子は大丈夫。でも日本酒は申告してね。用紙にチェック入れるだけだから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '機内持ち込みサイズ？',
            'これ機内持ち込みいける？',
            'このカバン機内持ち込みで大丈夫？預けたくないんだけど。',
            'ちょっとギリギリかも。念のためサッと測らせて。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '遅れてる？',
            '飛行機遅延してますか？',
            '定刻通りかわかります？掲示板には遅延って出てるんですけど確認したくて。',
            '最後に聞いた情報だと45分遅れだね。もうすぐ掲示板も更新されると思うよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '席変えられますか？',
            '席の変更ってできます？',
            '別の席に移れたりしますか？ちょっと狭くて。',
            'ちょっと見てみますね……3列後ろに通路側が空いてるけど、そこでいい？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '毛布もらえますか？',
            '毛布いただけますか？',
            'すみません、予備の毛布ってあります？めっちゃ寒くて。',
            'もちろん！はいどうぞ。枕も持ってきますね。上空は冷えますからね。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '帰りの便いつ？',
            '帰りの飛行機って何時発？',
            '帰りの便確認してくれる？15日だと思うんだけど念のため。',
            'うん、15日の朝9時だよ。もうスマホに保存しといたから。',
        ],
...

    {
        ...
        jaTranslations: [
            '楽しかったなー。',
            'あれほんと楽しかったよな。',
            'あの時マジで最高だった。今でも思い出すもん。',
            'だよな？年内にまたああいうのやりたいよな。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'あの頃が懐かしいわ。',
            '懐かしいなー。',
            'めっちゃ思い出すわ。何年も考えてなかったのに。',
            'わかる。昨日ある曲流れてきて一瞬で大学時代に戻ったもん。不思議だよな。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '昔はよく……',
            '昔はしょっちゅうやってたなー。',
            '若い頃しょっちゅうやってたんだよ。ある意味俺の十八番だった。',
            'なんでやめたの？また始めなよ。そういうのに年齢関係ないって。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '初めての時覚えてる。',
            '初めてやった時のこと今でも覚えてるわ。',
            '初めての時は絶対忘れない。めっちゃ緊張したけど最高だった。',
            'はは、俺もー！ガッチガチだったよ。今思うと何にビビってたんだろ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '戻りたいなー。',
            'あの頃に戻れたらなー。',
            'たまにあの瞬間にもう一回戻って生きたいって思う。',
            '全然変じゃないよ。でもさ、また新しい思い出作ればいいじゃん。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            '写真見せてよ！',
            '写真出して！見たい！',
            'やば、ちょっと待って。俺も持ってるかも。あの夜みんなで撮ったよね？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '覚えてる？',
            'あれ覚えてる？',
            'あの時のこと覚えてる？あれマジ爆笑だったよな。',
            'うわ、覚えてるよ！この前ちょうどそれ思い出してたんだって。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'あれからもう5年も経つんだ。',
            '5年だよ？信じられる？早いなー。',
            'うそでしょそんなに経ってるの。やばいな。でも俺ら全然変わってないよな？',
        ],
...

    {
        ...
        jaTranslations: [
            'いつがいい？',
            'いつ都合いい？',
            'みんな何日がいい？俺はわりといつでもいけるよ。',
            '15日の週末とかどう？たぶん大体みんないけると思うんだけど。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ちょっと確認する。',
            '予定確認するね。',
            'ちょっとカレンダー見させて。なんか入ってるかも。',
            'ゆっくりでいいよ。木曜までに教えてくれれば予約全部取れるから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ドタキャンすんなよ。',
            '逃げんなよ絶対！',
            '今回はすっぽかさないって約束してよ。頼りにしてんだから。',
            'しないって！もう予定空けたし。今回はマジだから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '何時？',
            '何時に集合？',
            '何時にどこ？具体的に教えてくれないと迷子になるんだけど。',
            '11時に駅。グルチャにピン落とすからみんな迷わないでしょ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            '遅れそう、ごめん！',
            '10分くらい遅れる、先始めてて。',
            'またかよ。いいから早く来い。罰としてメニューで一番ヤバいの頼んどくから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '待ちきれない！',
            'めっちゃ楽しみ！',
            '楽しみすぎて待てない！絶対楽しいやつじゃん！',
            '俺もー！もう荷造り始めちゃった、まだ2週間あるのに。引かないでね。',
        ],
...

    {
        ...
        jaTranslations: [
            'いつか〜したいなー。',
            'いつかほんとに〜したいんだよね。',
            'ずっと夢だったんだけど、タイミングがなくてさ。',
            '全然変じゃないよ。やりなよ。何が引っかかってんの？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '目標は〜。',
            '〜に向けて頑張ってる。',
            '今の目標は〜で、実はちょっとずつ進んでるんだ。',
            '十分すごいよ。進んでるなら進歩だよ。続けろ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '〜になりたい。',
            'ずっと〜になりたかったんだ。',
            '小さい頃〜になりたくて、正直今でもちょっと思ってる。',
            '全然子供っぽくないよ。てか、お前なら向いてると思うけど。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'もう遅い？',
            '俺にはもう遅いかな？',
            '正直に言って。この歳からやり直すのってもう遅い？',
            'おい、俺のおじさん42歳で医学部入ったぞ。遅いなんてないよ。やれって。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '諦めたくない。',
            '絶対諦めない。',
            'ここまで来て諦めるかよ。最後までやるって決めた。',
            'その意気だよ。みんなお前のこと応援してるからな。マジで。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '現実的じゃないんだけど……',
            'バカみたいに聞こえるかもだけど……',
            '無理って思うかもしれないけど、最後まで聞いて。',
            'いいじゃん、俺は乗った。とりあえず調べてみようよ。最悪何が起きるよ？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '一歩踏み出したい。',
            'とにかく最初の一歩だけ踏み出したいんだよ。',
            '始めるのが一番難しいと思うんだ。一歩目さえ出れば大丈夫。',
            'じゃあその一歩目を一緒に考えようぜ。今すぐ。何する？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '遅すぎることなんてない。',
            '始めるのに遅すぎるなんてことない。',
            '年齢なんてただの数字だよ。欲しいなら取りに行け。',
            '今夜それ聞けてよかった。ほんとにありがとう。もう一杯いく？',
        ],
...

    {
        ...
        jaTranslations: [
            'おめでとう！',
            'おめでとう！お前にはふさわしいよ！',
            'おめでとう、ほんとに嬉しいよ。これでっかいじゃん！',
            'やめてよ泣きそう。ほんとにありがとう、めっちゃ嬉しい。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '乾杯！',
            'みんな、乾杯！',
            'お前と、お前が成し遂げた全部に乾杯。飲み干せ！',
            'みんな乾杯！温かい言葉ありがとう。なんて言えばいいかわかんないわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'よくやったね。',
            'めっちゃ頑張ったもんね。',
            '努力して、ちゃんと結果出したじゃん。誇りに思うよ。',
            '正直、みんなが押してくれなかったら無理だった。2回やめかけたし。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ちょっとしたもんだけど。',
            'ちょっとしたものがあるんだ。',
            '目つぶって。ちょっとしたプレゼント買ってきた。',
            'え、そんなことしなくてよかったのに！今開けていい？開けるね。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'サプライズ！',
            'サプライズ！驚いた？',
            '気づいてた？何週間もかけて準備してたんだよ！',
            'マジで全然気づかなかった。お前ら嘘下手くそなのにやられたわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'めっちゃ嬉しい。',
            '信じられない、めっちゃ嬉しい！',
            'みんな、ほんとにありがとう。なんて言っていいかわかんない。',
            'お前にはふさわしいよ。ほら、泣き出す前にグループハグしよう。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'まじで泣きそうなんだけど。',
            'こっち見ないで。感情やばくなってきた。',
            'ほら、ナプキン。恥ずかしがんなって。俺もウルウルきてるし正直。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'みんなのおかげだよ。',
            'みんながいなかったら無理だった。',
            'まじで全部みんなのおかげ。みんなの支えがなかったら今の俺はない。',
            'はいはい、みんな泣かせるなよ。誰かもう一杯頼んでくれ、しんみりしすぎる前に。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '最高の夜だ。',
            '今夜は最高の夜だよ！',
            '今夜を超える夜はないと思う。ここ数年で一番いい夜だ。',
            '同じく。こういう夜ってそうそうないもんな。来てよかったわ。',
        ],
...

    {
        ...
        jaTranslations: [
            'そろそろ帰るわ。',
            'ぼちぼち帰ろうかな。',
            '言いたくないけど、そろそろ帰ったほうがいいかも。遅くなってきたし。',
            'もう？もう一杯だけ。わかったよ、気をつけてね。着いたら連絡して。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '今日はありがとう。',
            '今夜はありがとう。めっちゃ楽しかった。',
            '今夜ほんとに必要だったんだ。みんなありがとう。',
            'こっちも同じ気持ちだよ。次はこんなに間あけないようにしよう。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '寂しくなるな。',
            'みんなに会えなくなるの寂しいわ。',
            '毎週みんなに会えないの変な感じだな。慣れちゃってたから。',
            'さよならじゃなくてまたねだから。次は一杯目おごるよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '忘れないでね。',
            '俺のこと忘れんなよ。',
            '忘れないって約束してよ。次会ったときテストするから。',
            'お前を忘れる？無理だわ。俺が知ってる中で一番声でかいもん。愛を込めて言ってるよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'これからもよろしく。',
            'これからも続けよう。',
            'これはまだ始まりだよ。俺たちはまだスタートしたばっかだ。',
            '第1章がこんなによかったら、第2章はやばいことになるな。俺は乗った。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '最高の1ヶ月だった。',
            'この1ヶ月、最高だった。',
            '1ヶ月前にこんな気持ちになるって言われても信じなかったよ。',
            '今のめっちゃいい言葉だったな。お前は一人で入ってきたけど、みんなと一緒に帰るんだよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'もっとうまくなるから。',
            '次はもっとうまくなってるよ。',
            'あと1ヶ月くれ。度肝抜いてやるから。見てろ。',
            '待ってるよ。俺は厳しい客だからな、そのジョーク磨いとけよ。',
        ],
