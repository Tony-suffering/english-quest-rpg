...
export const MONTH5_W17_EXPRESSIONS: MasterExpression[] = [
...

    {
        ...
        english: [
            ...
            "Honestly, you can't go wrong with the truffle pasta. It's our most popular dish by far.",
        ],
        jaTranslations: [
            'ここ何がおいしい？',
            'ここ何がおすすめ？初めて来たんだけど。',
            'すみません、初めてなんですけど、初心者におすすめってありますか？',
            '正直、トリュフパスタは外さないよ。一番人気のメニューだし。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Of course, Mr. Gondo. Your table's all set. Right this way, please.",
        ],
        jaTranslations: [
            '予約してます。権藤です。',
            'すみません、権藤で予約してるんですけど。',
            'こんばんは。権藤で6名予約してあります。',
            'はい、権藤様ですね。お席ご用意できてます。こちらへどうぞ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "No problem at all! Take your time. I'll come back in a few.",
        ],
        jaTranslations: [
            'もう少し時間もらえますか？',
            'まだ決まってないんです。もう少し待ってもらえますか？',
            'すみません、まだ迷ってて。もう少しだけ時間いただけますか？',
            '全然大丈夫ですよ！ゆっくりどうぞ。またちょっとしたら来ますね。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Absolutely, go for it! The portions are pretty generous, so sharing works great here.",
        ],
        jaTranslations: [
            'これシェアしていい？',
            '何品かシェアしても大丈夫ですか？',
            '何皿かシェアしようと思ってるんですけど、大丈夫ですか？量的に一人前って感じですか？',
            'もちろん！量けっこう多いんで、シェアにぴったりですよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Thanks for letting me know. I'll double-check with the kitchen right away. We take allergies very seriously here.",
        ],
        jaTranslations: [
            '食物アレルギーがあります。',
            '先に言っておくと、ナッツアレルギーなんです。',
            '注文前に言っておきたいんですけど、けっこう重めのナッツアレルギーがあって。これにナッツ入ってるか確認してもらえますか？',
            'お知らせありがとうございます。すぐキッチンに確認しますね。アレルギーは厳重に対応してますので。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Sure thing! Still water for the table, coming right up. I'll grab some extra glasses too.",
        ],
        jaTranslations: [
            'お水もらえますか？',
            'テーブルにお水いただけますか？',
            'すみません、テーブル用にピッチャーでお水いただけますか？普通の水で大丈夫です。',
            'かしこまりました！普通のお水ですね、すぐお持ちします。グラスも余分にお持ちしますね。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "No problem, we can leave those out. Want me to add anything else instead?",
        ],
        jaTranslations: [
            'これ抜きでお願いします。',
            'これ、玉ねぎ抜きでもらえますか？',
            'パスタがいいんですけど、オリーブ抜きにできますか？ほんと無理なんです。',
            '大丈夫ですよ、抜いておきますね。代わりに何か入れましょうか？',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Right? You wanna try a bite? I honestly can't believe how good this is.",
        ],
        jaTranslations: [
            'おいしそう！',
            'うわ、めっちゃおいしそう！',
            '見てこれ！やばい。あなたが頼んだのにすればよかった。',
            'でしょ？一口食べてみる？マジでうますぎてびっくりしてる。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Of course! I'll bring it right over. Would you like it all on one check or split?",
        ],
        jaTranslations: [
            'お会計お願いします。',
            'お時間ある時にお会計いただけますか？',
            'お手すきの時で結構ですので、お勘定お願いできますか？急ぎません。',
            'かしこまりました！すぐお持ちしますね。一括ですか？別々にしますか？',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Just do twenty percent. It's easy math and you won't look cheap. Trust me on this one.",
        ],
        jaTranslations: [
            'チップってどれくらい？',
            'チップの相場ってどのくらい？いつも分かんないんだよね。',
            'で、ここのチップってどうすればいい？15%でいい？もっと出した方がいい？',
            '20%にしとけ。計算も楽だし、ケチに見えない。俺を信じろ。',
        ],
...

    {
        ...
        english: [
            ...
            "It's just a garlic butter pasta, nothing fancy. Wanna stay for dinner? There's plenty.",
        ],
        jaTranslations: [
            '何作ってるの？',
            'ねえ、何作ってるの？すごいいい匂いする。',
            'めっちゃいい匂い。何作ってるの？見ててもいい？',
            'ただのガーリックバターパスタだよ、たいしたもんじゃない。晩飯食ってく？いっぱいあるし。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Yeah, I learned that the hard way. I used to skip the prep and everything would go wrong halfway through.",
        ],
        jaTranslations: [
            '下ごしらえが大事。',
            'カギは下ごしらえだ。手を抜くなよ。',
            'いいか、料理のほとんどは準備だ。下ごしらえがちゃんとできてれば、あとは楽勝。',
            'うん、それ痛い目見て学んだ。昔は下ごしらえサボって、途中で全部グダグダになってた。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "About fifteen minutes on low. Set a timer though, 'cause it'll burn if you forget about it.",
        ],
        jaTranslations: [
            'これ何分くらい煮るの？',
            '何分くらいコトコトすればいい？',
            '弱火でコトコトでいいの？どれくらい？焦がしたくないんだけど。',
            '弱火で15分くらいかな。タイマーかけとけよ、忘れると焦げるから。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Mmm, it's really close. Maybe a squeeze of lemon? I feel like it just needs a little something.",
        ],
        jaTranslations: [
            '食べてみて。',
            'ほら、これ味見して。どう思う？',
            'ちょっと味見してくれない？何か足りない気がするんだけど、何か分かんなくて。',
            'うーん、かなりいい線いってる。レモンちょっと搾る？なんかもうひと味欲しい感じ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Turn it down a notch. You want it just barely bubbling, not going crazy like that.",
        ],
        jaTranslations: [
            '火加減これでいい？',
            'この火加減で合ってる？もっと強く？弱く？',
            '火加減いつも分かんないんだよね。中火でいい？もっと弱い方がいい？',
            'もうちょい弱くして。フツフツ程度でいいんだよ、そんなボコボコ沸かすな。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Thanks! It's the garlic and rosemary doing all the heavy lifting. Should be ready in ten.",
        ],
        jaTranslations: [
            'いい匂い！',
            'めっちゃいい匂い。もうお腹空いてきた。',
            '何作ってるか知らんけど、とんでもなくいい匂いする。よだれ出そう。',
            'ありがとう！にんにくとローズマリーが頑張ってくれてるんだ。あと10分でできるよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "A little thinner, like this. Curl your fingers in so you don't cut yourself, okay?",
        ],
        jaTranslations: [
            'この切り方で合ってる？',
            'この切り方であってる？間違ってない？',
            'これ正しく切れてるか全然分かんない。もっと薄い方がいい？これでいい？',
            'もうちょい薄く、こんな感じ。指は丸めてね、切らないように。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "It's not that bad, don't panic. Just scrape off the bottom and add a bit more sauce. Nobody'll notice.",
        ],
        jaTranslations: [
            '焦げちゃった！',
            'やばい、焦がしたかも。もうダメ？',
            '一瞬目を離した隙に焦げた。まだ救える？もう手遅れ？',
            'そんなひどくないよ、焦るな。底をこそぎ取って、ソースちょい足しすればバレない。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "You sure? That's really sweet of you. I'll at least dry while you wash, deal?",
        ],
        jaTranslations: [
            '片付けは俺がやるよ。',
            '散らかったのは任せて。片付けやっとくから。',
            '料理してくれたんだから、皿洗いは俺がやるよ。当然だろ。',
            'ほんとに？やさしいね。じゃあ私は拭くから、あなた洗ってね。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Ha, glad you liked it! Come by next Saturday and I'll make it again. Bring wine this time.",
        ],
        jaTranslations: [
            'また作って。最高だよこれ。',
            'これめっちゃうまい。絶対また作ってよ。',
            'マジでこれやばい。また作るって約束して。毎日でも食えるわ。',
            'はは、気に入ってくれてよかった！来週土曜おいでよ、また作るから。今度ワイン持ってきてね。',
        ],
...

    {
        ...
        english: [
            ...
            "Really? I thought it was fine. Maybe add a little rice on the side to balance it out?",
        ],
        jaTranslations: [
            'ちょっとしょっぱい。',
            'これ自分にはちょっとしょっぱい寄りかな。',
            '自分だけかもしれないけど、ちょっとしょっぱくない？もうちょい水足した方がいいかも。',
            'そう？俺はちょうどいいと思うけど。ご飯と一緒に食べてバランス取れば？',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Right? That's exactly what I was going for. The secret is adding the chili at the very end so it doesn't overpower everything.",
        ],
        jaTranslations: [
            '甘すぎず辛すぎず、ちょうどいい。',
            '完璧なバランス。甘すぎず辛すぎず。',
            'これドンピシャだよ。甘さと辛さがちょうどいい塩梅。めっちゃバランスいい。',
            'でしょ？まさにそこ狙ったんだよ。秘訣は唐辛子を最後に入れること。そうすると全体を殺さないんだ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "That's three hours of simmering right there. You really can't rush a good broth, y'know?",
        ],
        jaTranslations: [
            'コクがあるね。',
            'うわ、めっちゃコクがあって深い味だね。',
            'すごい味の奥行き。何時間も煮込んだみたいな味する。',
            'そりゃ3時間煮込んでるからね。いい出汁は急いじゃダメなんだよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Perfect for summer, right? I swapped out the heavy dressing for a citrus vinaigrette and it made all the difference.",
        ],
        jaTranslations: [
            'さっぱりしてる。',
            'めっちゃ軽くてさっぱり。夏にぴったり。',
            'このすっきり感いいね。全然胃にもたれない。',
            '夏にぴったりでしょ？重いドレッシングをシトラスビネグレットに変えたらガラッと変わったんだ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Ha, yeah, it's definitely an acquired taste. Give it a couple more tries and you might actually start to like it.",
        ],
        jaTranslations: [
            'これちょっとクセがあるね。',
            'これ...面白い味だね。かなり独特。',
            '正直に言うと、これ慣れが必要な味だね。まずくはないけど、かなり個性的。',
            'はは、まあ確かに慣れが必要な味だよね。何回か食べてみ、そのうち好きになるかもよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "You're close! It's cardamom. Just a tiny bit, but it changes the whole thing, doesn't it?",
        ],
        jaTranslations: [
            '何入ってるの？この味。',
            'この味なに？何か分かんないんだけど。',
            'なんか正体が分かんない味がする。何入れたの？',
            '惜しい！カルダモンだよ。ほんのちょっとだけど、全然変わるでしょ？',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "I know, right? I've already gone through two bowls and I can't stop. Pass me the rice cooker.",
        ],
        jaTranslations: [
            'ご飯がすすむ味だね。',
            'これご飯が止まらなくなるやつ。食いすぎ注意。',
            'うまい料理ってご飯が止まらなくなるよね。俺もう3杯目だわ。',
            'わかる。俺ももう2杯いっちゃったし、止まんない。炊飯器こっち回して。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Wait, don't touch it yet! Let me get a picture first. This is way too pretty to just eat without documenting it.",
        ],
        jaTranslations: [
            '見た目もきれいだね。',
            '盛り付けきれいすぎて食べるのもったいない。',
            'この盛り付け見てよ。芸術じゃん。崩すのが申し訳ない。',
            'ちょっと待って、まだ触らないで！先に写真撮らせて。記録せずに食べるのもったいなさすぎる。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "No worries at all. Wanna try some of mine instead? It's way more straightforward.",
        ],
        jaTranslations: [
            'ちょっと口に合わないかも。',
            '正直、これあんまり自分の好みじゃないかな。',
            '手間かけてくれたのは分かるんだけど、ちょっと自分には合わないかな。',
            '全然いいよ。代わりに俺のちょっと食べてみる？こっちの方がシンプルだよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Help yourself! There's a ton left in the pot. I made way too much anyway.",
        ],
        jaTranslations: [
            'おかわり！',
            'おかわりいい？うますぎて止まんない。',
            '絶対おかわりする。っていうか3杯目いくわ。恥もプライドもない。',
            '好きなだけ食べて！鍋にまだめっちゃ残ってるし。作りすぎたんだよね。',
        ],
...

    {
        ...
        english: [
            ...
            "That's totally fine! We'll find something you like. This place has a huge menu, so don't worry about it.",
        ],
        jaTranslations: [
            '好き嫌い多いんだよね。',
            '正直、食べ物に関してはけっこう好き嫌い激しいんだ。',
            '自分でも分かってるんだけど好き嫌い多くて。子供の頃からずっとで、直せないんだよね。',
            '全然いいよ！好きなもの見つけよう。ここメニューめっちゃ多いから心配しないで。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Must be nice! I wish I could say the same. There's like ten things I won't touch.",
        ],
        jaTranslations: [
            '何でも食べるよ。',
            '好き嫌い全然ないよ。何でも食べる。',
            '昔から好き嫌いなくて。食べられるものなら何でもいく。',
            'いいなあ！俺もそう言いたいわ。俺は10個くらい絶対食わないもんあるし。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Oh, good to know! The salad and the mushroom risotto are both vegetarian-friendly. Want me to double-check with the chef?",
        ],
        jaTranslations: [
            'ベジタリアンなんだ。',
            '実はベジタリアンなんだけど、大丈夫かな？',
            '2年前からベジタリアンにしたんだ。最初はキツかったけど、今は肉が恋しいとも思わない。',
            'あ、そうなんだ！サラダとマッシュルームリゾットはベジタリアンOKだよ。シェフに確認しようか？',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "I'm good with pretty much everything. Oh wait, no shellfish though. I break out in hives.",
        ],
        jaTranslations: [
            '苦手なものある？',
            '食べられないものある？先に教えて。',
            'テーブルまとめて頼む前に聞くけど、絶対ダメなものある？アレルギーとか嫌いなものとか。',
            '俺はだいたい何でもいけるよ。あ、待って、甲殻類だけダメ。蕁麻疹出るから。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Oh, same here! It's the worst. I heard it's genetic though, so at least we have an excuse.",
        ],
        jaTranslations: [
            'パクチーだけは無理。',
            '唯一絶対ダメなのがパクチー。',
            'パクチー以外なら何でも食べる。匂いだけでえずきそうになる。',
            'あ、俺も！最悪だよね。遺伝子のせいらしいから、少なくとも言い訳にはなるけど。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "So true. Even when I travel and don't speak the language, food is always the icebreaker.",
        ],
        jaTranslations: [
            '食べ物の話で盛り上がるよね。',
            '食べ物の話ってみんなを一つにするよね。',
            '面白いよね、食べ物だけは全員に意見があって。中立な人いないもん。',
            'ほんとそれ。旅行で言葉通じない時でも、食べ物の話だけはいつもアイスブレイクになる。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "How are you still eating? I'm so full I can barely move. ...Okay fine, what's on the dessert menu?",
        ],
        jaTranslations: [
            '甘いもの別腹。',
            'どんなに満腹でもデザートは入る。',
            '胃は満杯だけどデザート用の胃はまだ空いてる。別なんだよ。',
            'なんでまだ食えんの？俺もう動けないくらいパンパンなんだけど。...分かったよ、デザートメニュー何がある？',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Oh no, you're right. I just had one and now I can't stop. Why did you let me try this?",
        ],
        jaTranslations: [
            'これハマるやつ。',
            'やばい、これ止まらなくなるやつだ。',
            '先に言っとくけど、これめっちゃ中毒性あるから。一回食べたら止まらない。',
            'うわ、ほんとだ。一個食べたら止まんなくなった。なんで食べさせたんだよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "You should totally try it! It's kinda like a mix between a pear and an apple. Here, have a piece.",
        ],
        jaTranslations: [
            'それ食べたことないなあ。',
            'え、マジ？食べたことない。どんな感じ？',
            '人生で一度も食べたことない。おいしいの？どんな味？',
            '絶対食べてみて！梨とりんごの間みたいな感じ。ほら、一切れどうぞ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Really? That's funny, I'm the opposite. I actually liked the first one better. Guess we'll have to order both next time!",
        ],
        jaTranslations: [
            'こっちの方が好み。',
            'こっちの方が好きかも、正直。',
            '二つから選ぶなら、こっちかな。こっちの方が自分の好み。',
            'え、マジ？俺は逆だわ。最初の方が好きだった。じゃあ次は両方頼もう！',
        ],
...

    {
        ...
        english: [
            ...
            "Sure, I'll write it down for you. Fair warning though, it looks simple but the timing is everything.",
        ],
        jaTranslations: [
            'レシピ教えてよ。',
            'これのレシピ教えてほしいんだけど。共有してくれない？',
            'このレシピ絶対教えて。家で作ってみたいんだ。',
            'いいよ、書いてあげる。ただ先に言っとくけど、見た目はシンプルでもタイミングが全てだからね。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Got it. So soy sauce, ginger, garlic, and how long should I let it sit? Like thirty minutes?",
        ],
        jaTranslations: [
            'まず下味をつけて。',
            'まず鶏肉を漬け込む。これが一番大事なステップ。',
            '最初にやるのは肉にしっかり下味をつけて、最低30分は置くこと。',
            '了解。じゃあ醤油、生姜、にんにくで、どれくらい置けばいい？30分くらい？',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "That's the part I always mess up though. My eyeball measurements are way off. Last time I added too much salt and ruined it.",
        ],
        jaTranslations: [
            '目分量でいいよ。',
            '計らなくていいよ。目分量でやれ。',
            '俺は何も計ったことない。感覚でいけ。これをひと掴み、あれをひとつまみ。',
            'そこがいつも失敗するんだけどな。俺の目分量めちゃくちゃズレてて、この前塩入れすぎて台無しにした。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Wait, seriously? That's the secret? I've been doing it once this whole time. No wonder mine gets soggy.",
        ],
        jaTranslations: [
            '二度揚げするとサクサクになる。',
            'コツは二度揚げ。これでカリッとなるんだ。',
            '完璧なサクサク感が欲しいなら二度揚げ必須。最初は低温で、休ませて、次は高温でもう一回。',
            'え、マジで？それが秘訣？俺ずっと一回しか揚げてなかった。どうりでベチャッとなるわけだ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Honestly? It's the oil temperature. Most people don't let it get hot enough before dropping the chicken in.",
        ],
        jaTranslations: [
            'コツは何？',
            '何か秘訣あるでしょ。教えてよ。',
            'ねえ、こんなにうまく作れる秘密が絶対あるでしょ。何が違うの？',
            '正直？油の温度だよ。みんな十分に熱くなる前に鶏肉入れちゃうんだよね。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Yeah, go ahead. I'll slow down. Want me to start from the beginning?",
        ],
        jaTranslations: [
            '分量メモっていい？',
            'ちょっと待って、忘れる前にメモさせて。',
            'ちょっとスピード落として。スマホ出してメモるから。何も聞き逃したくない。',
            'うん、どうぞ。ゆっくり言うね。最初からやり直す？',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Thanks, that actually makes me feel a lot better. I'll give it a shot this weekend and see what happens.",
        ],
        jaTranslations: [
            '失敗しても気にしないで。',
            '最初から完璧じゃなくても気にすんな。',
            '最初がうまくいかなくても落ち込むなよ。料理は試行錯誤が全てだから。',
            'ありがとう、それ聞いてちょっと気が楽になった。今週末やってみるわ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "In a pinch, yeah. It won't taste exactly the same, but it'll get you pretty close. Go for it.",
        ],
        jaTranslations: [
            '代わりにこれ使ってもいい？',
            'みりんなかったら、他のもので代用できる？',
            '多分全部の材料は揃えられないと思うんだけど、何で代用できる？',
            '急場しのぎならいけるよ。全く同じ味にはならないけど、かなり近い線いくから。やってみ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "That's for about four people. If you're cooking for two, just halve everything. Easy enough.",
        ],
        jaTranslations: [
            '何人前の量？',
            'このレシピ何人分？',
            'このレシピ何人前？倍にした方がいいか知りたくて。',
            'だいたい4人前かな。2人分なら全部半分にすればいいよ。簡単でしょ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Please do! I wanna see how it turns out. And don't forget the double-fry, that's the key part.",
        ],
        jaTranslations: [
            '作ったら写真送るね。',
            '作ってみたら、出来上がりの写真送るよ。',
            '今週末絶対作ってみる。写真送るから採点してよ。',
            'ぜひ送って！出来上がり見たい。二度揚げ忘れるなよ、そこが一番大事だから。',
        ],
...

    {
        ...
        english: [
            ...
            "Yeah but you're not counting the time you spend shopping and cooking. Time is money too, you know.",
        ],
        jaTranslations: [
            '自炊した方が安いよ。',
            '外食は高い。自炊すればめっちゃ節約になる。',
            '節約したいなら自炊一択だろ。外食はすぐ積み重なるぞ。',
            'でもさ、買い物と料理にかかる時間計算に入れてないだろ。時は金なりだよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "I feel you. Have you tried meal prepping on Sundays though? That way you don't have to cook after work.",
        ],
        jaTranslations: [
            '時間がないから外食しちゃう。',
            '自炊したいんだけど、仕事終わると時間ないんだよね。',
            '仕事から帰ってきたら、一番やりたくないのが料理。結局ほぼ毎晩外食しちゃう。',
            '分かるわ。でも日曜に作り置きしてみた？そうすれば仕事の後に作らなくて済むよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Totally agree. I cook maybe four times a week and eat out the rest. Best of both worlds.",
        ],
        jaTranslations: [
            'たまには外食もいいよね。',
            '毎日じゃなければ外食もいいと思うよ。',
            '毎日自炊は疲れる。たまには自分にご褒美で外食したっていいじゃん。',
            '完全同意。俺は週4くらい自炊して残りは外食。いいとこどりだよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Doesn't the food get kinda boring by Thursday though? I feel like I'd get sick of eating the same thing.",
        ],
        jaTranslations: [
            '作り置きしてるよ。',
            '日曜に作り置きしてる。平日めっちゃ楽になるよ。',
            '日曜に数時間かけて一週間分全部作る。何食べるか悩まなくて済むし。',
            '木曜くらいになると飽きない？同じもの食べ続けるのキツくない？',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Come over tonight then. I'm making curry and there's always way too much for one person.",
        ],
        jaTranslations: [
            'コンビニ弁当飽きた。',
            'コンビニ弁当もう飽きた。ちゃんとしたもの食べたい。',
            '2週間コンビニ飯続いてて、体が抗議し始めてる気がする。',
            'じゃあ今夜うちおいでよ。カレー作るんだけど、一人分じゃ絶対多すぎるから。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Sure, until you check your credit card statement at the end of the month. That adds up fast, dude.",
        ],
        jaTranslations: [
            'デリバリーの方が楽じゃん。',
            'なんで自炊するの？デリバリーでいいじゃん。楽だし。',
            '正直、デリバリーアプリのせいで自炊する気が完全に失せた。',
            'そりゃいいけど、月末にクレカの明細見てみ。すぐ積み重なるぞ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Can confirm. My girlfriend's the one who got me into cooking, and I'm telling you, it works both ways.",
        ],
        jaTranslations: [
            '料理できる男子はモテるよ。',
            '料理できるとデートで超プラスだよ。',
            'うまい飯作れる人ほど印象いいものはないよ。魅力爆上がり。',
            '確かに。俺も彼女がきっかけで料理始めたけど、マジでお互い様だよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "That's why you gotta freeze stuff in portions. Make a big batch, freeze half, and you've got meals for later.",
        ],
        jaTranslations: [
            '一人暮らしだと自炊めんどくさい。',
            '一人暮らしだと自炊する気が起きないんだよね。',
            '一人暮らしの一番キツいのは自炊。全部ファミリーサイズで売ってて、半分腐らせる。',
            'だから小分けにして冷凍しとけって。まとめて作って半分冷凍すれば、後で使えるだろ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Hey, don't knock it! It tastes good and that's all that matters. Who needs fancy plating anyway?",
        ],
        jaTranslations: [
            '男の料理って感じだね。',
            'すごい男の料理だね。デカくてシンプル。',
            '男ってほんとに濃い味に一直線だよね。繊細さゼロ。とにかく味付け全開。',
            'おい、バカにすんなよ！うまけりゃいいんだよ。おしゃれな盛り付けとかいらねえし。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "There's no right answer, honestly. Just do what works for you and stop overthinking it.",
        ],
        jaTranslations: [
            '結局どっちが正解なの？',
            '結局、外食と自炊どっちが勝ち？',
            'さっきからずっと行ったり来たりだけど、正解あんの？',
            '正解なんてないよ、正直。自分に合うやり方でやれ。考えすぎんな。',
        ],
...

    {
        ...
        english: [
            ...
            "That's actually really cool. We don't have anything like that. Some people say grace, but it's not the same thing at all.",
        ],
        jaTranslations: [
            '「いただきます」に相当する英語はない。',
            '英語には「いただきます」に当たる言葉がないんだよね。みんなただ食べ始める。',
            '英語では食べる前に何も言わない。まあ、お祈りする人はいるけど、あれは宗教的なものだし。',
            'それ実はすごいよね。英語にはそういうのないもん。お祈りする人はいるけど、全然別物だよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "No argument here. I still can't believe you can get a decent meal for two hundred yen. Back home that'd get you a bag of chips.",
        ],
        jaTranslations: [
            '日本のコンビニは最強だよ。',
            '正直、日本のコンビニは他の国を圧倒してるよ。',
            '日本のコンビニみたいなものは世界のどこにもない。食のクオリティが完全に次元が違う。',
            '異論なし。200円でまともな飯が買えるのいまだに信じられない。俺の国じゃポテチ一袋だよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "The night markets in Taipei were insane. I think I ate at like twelve stalls in one night and spent maybe ten bucks total.",
        ],
        jaTranslations: [
            '食べ歩きが楽しい。',
            '食べ歩き好き。どの街にもご当地グルメがあるし。',
            '旅行の一番いいところは、その土地の屋台メシを食べ歩くことだよね。',
            '台北の夜市やばかったよ。一晩で12軒くらい回って、全部で千円くらいだった。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Yeah, my American friend almost choked when I slurped ramen in front of her. She couldn't believe it was normal here.",
        ],
        jaTranslations: [
            '麺をすするのは日本だけ？',
            '麺をすするのって日本人だけ？みんなやると思ってた。',
            '麺をすするのがほとんどの国で失礼って知ってびっくりした。',
            'そうそう、アメリカ人の友達の前でラーメンすすったらめっちゃ驚かれた。ここでは普通だって信じてもらえなかった。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "I learned that one the hard way in China. I kept finishing my plate and they kept bringing more food. I was so full I thought I'd die.",
        ],
        jaTranslations: [
            '食べ残すのは失礼？',
            '日本では残すのはもったいないって言われるけど、他の国もそう？',
            '皿のもの全部食べなさいって育てられたけど、一部の文化では残す方がいいって聞いた。',
            '中国で痛い目見て学んだよ。全部食べ切ったらどんどん追加されて、死ぬほど満腹になった。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "My cousin in London pays like fifteen pounds for a bowl now. He'd flip if he saw what we pay here.",
        ],
        jaTranslations: [
            'ラーメンは世界を制覇した。',
            'ラーメンは完全に世界を制覇したよね。どこでも食べられるようになった。',
            'ラーメンが安い日本のファストフードから世界的な現象になったのすごくない？',
            'ロンドンの従兄弟、今一杯15ポンドくらい払ってるよ。こっちの値段見たらひっくり返るだろうな。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "It's getting there. My friend in New York says there's a sake bar near his place and it's packed every weekend.",
        ],
        jaTranslations: [
            '日本酒って海外で人気あるの？',
            '日本酒が海外で人気出てるって聞いたけど、ほんと？',
            '日本酒ブームが海外で本当に起きてるのか、ニュースで見るだけなのか気になって。',
            'じわじわ来てるよ。ニューヨークの友達が言ってたけど、近所の日本酒バー毎週末満席だって。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "For real. When I told my host family in America I eat raw eggs, they looked at me like I was insane.",
        ],
        jaTranslations: [
            '食の安全基準が全然違う。',
            '国によって食品の安全基準がこんなに違うなんて衝撃。',
            '海外行くまで食の安全基準がこんなに違うなんて気づかなかった。',
            'マジで。アメリカのホストファミリーに生卵食べるって言ったら、頭おかしいやつ見る目で見られた。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "That's deep, and honestly so true. You can learn more about a country from one meal than from a whole textbook.",
        ],
        jaTranslations: [
            '食は文化そのものだよね。',
            '何を食べてるかでその人やルーツが分かるよね。',
            '国を理解したいなら、その国の食を理解するところから始めるべきだと本気で思う。',
            '深いね、そしてマジでその通り。教科書一冊より一食の方がその国のこと学べるよ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Health stuff? That's actually super practical. I never know how to explain my symptoms in English at the doctor.",
        ],
        jaTranslations: [
            '来週は健康と体の話だぞ。',
            '来週は健康と体がテーマだ。覚悟しろ。',
            '来週は健康と体の話に移るぞ。役に立つ内容だからな。',
            '健康系？それめっちゃ実用的じゃん。病院で英語で症状説明できたことないもん。',
        ],
