...
export const MONTH4_W15_EXPRESSIONS: MasterExpression[] = [
...

    {
        ...
        jaTranslations: [
            '最近何やってる？',
            'で、最近なにやってんの？',
            '新しいゲーム探してんだけど、最近なにやってんの？',
            'おい、このローグライクやってみろって。2週間ぶっ通しでハマってるわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'めっちゃハマってる。',
            'マジで中毒になってるわこのゲーム。',
            '2週間ぶっ通しでやってる。もう病気だと思う。',
            'だろうな。今日ずっとスマホにへばりついてたじゃん。今何レベ？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            '今度一緒にオンラインでやろうぜ。',
            '今夜やらない？フレンド申請送るわ。',
            'いいね、やろう。ユーザー名送ってくれたら家帰ったら追加するわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'このゲーム金食い虫だわ。',
            'このゲームに金使いすぎた。',
            'いくら使ったか聞くなよ。課金がエグすぎる。',
            'わかる。「あと1回だけ」って言って昨日5000円溶かしたわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'レベル上げだるい。',
            'レベル上げ飽きたわ。全然上がんない。',
            '1週間同じレベルで止まってる。マジでだるい。',
            'オートバトル機能使って飯食ってる間に回しとけよ。俺はそうしてる。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '死んだ。',
            'また死んだわ。このボス無理ゲーだろ。',
            'ここで50回くらい死んでる。コントローラー投げそう。',
            'え、まだそのボスやってんの？コツあるんだよ。右じゃなくて左に避けろ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '一日一時間まで。',
            'ゲームは一日一時間にしてるんだ。',
            'ルールは一日一時間なんだけど、守ったことない。',
            'は？いつから？昨日夜中の2時にオンラインだったじゃん。ステータス見たぞ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '昔のゲームやりたい。',
            '懐かしくなってきた。レトロなのやりたいな。',
            '急に昔やってたゲームやりたくなったわ。',
            'わかるわ。Amazonでレトロゲーム機買ったんだ。うち来て一緒にやらない？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '見てる方が楽しい。',
            '自分でやるより人のプレイ見てる方が好き。',
            'ゲームやるより実況見てる時間の方が長いわ。',
            '正直わかる。誰の配信見てるの？新しい人探してるんだけど。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'eスポーツって今すごいらしいね。',
            'eスポーツってかなり盛り上がってるらしいね。',
            'eスポーツの選手ってプロのスポーツ選手より稼いでるらしいぞ。',
            'だよな？甥っ子がプロになりたいって言ってるわ。大会の賞金やばいもんな。',
        ],
...

    {
        ...
        jaTranslations: [
            'SNSやってる？',
            'SNSとか使ってる？',
            'インスタとかやってる？フォローしたいんだけど。',
            'うん、インスタはやってるよ。ちょっと見せるね。昔の投稿は見ないでね。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'いいね押したよ。',
            '投稿見ていいね押しといたよ。',
            '昨日の投稿にいいね押したよ。あの写真いいね。',
            'ありがとう！先週の旅行のやつね。フィルターが微妙で投稿するか迷ったんだけど。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'フォロワー何人いるの？',
            'ねえ、フォロワー何人いるの？',
            'ちょっと聞きたいんだけど、フォロワー何人？絶対多いでしょ。',
            '400人くらいかな？正直もう見てない。ほとんど知り合いだし。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'それ超映えるね。',
            '超映えるじゃん。投稿しなよ。',
            'インスタ映えやばい。食べる前に写真撮って。',
            'ちょっと待って、食べないで！先に写真撮らせて。今ライティング最高だから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '炎上してるの見た？',
            'ネットで炎上してるの見た？',
            '見た？Twitterで誰かボコボコにされてるぞ。',
            'ああ、一日中追ってたわ。リプ欄えぐいよな。目が離せない。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '既読スルーされた。',
            '既読スルーされてる。もう3時間経つんだけど。',
            '今朝メッセージ送ったのにまだ返事ない。読んだのは分かるんだけど。',
            'うわ、それ最悪だね。忙しいだけかもよ？気にしすぎない方がいいって。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'バズった。',
            '投稿が一晩でバズったんだけど。',
            'なんか適当に投稿したやつがバズった。なんでか分からん。',
            'マジで？いいね何個ついたの？見せて見せて！',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ストーリーに上げていい？',
            'これストーリーに上げてもいい？',
            'これ上げないともったいないわ。ちょっとストーリーに載せていい？',
            'いいよ。でも変な顔してたら消させるからな。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'フォロー外した。',
            'あの人やっとフォロー外した。',
            '投稿がうざかったからフォロー外した。後悔なし。',
            'いい判断だな。俺もそうしよ。タイムラインの半分もう話してない人だし。',
        ],
...

    {
        ...
        jaTranslations: [
            'YouTube一日中見てる。',
            'YouTubeに時間使いすぎてるわ。',
            'もうテレビ見てないわ。YouTubeで十分。',
            'わかる。昨日空港の仕組みの動画で沼って3時まで寝れなかった。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'チャンネル登録して。',
            'よかったら登録してベルも押してね。',
            '次の動画見逃さないようにチャンネル登録してね。',
            'したした！ちゃんと定期的に投稿しろよ。放置チャンネル嫌いなんだよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '再生回数すごい。',
            'その動画めっちゃ再生されてるね。',
            'どうやってそんな再生回数いったの？ヤバくない？',
            'だよね？たぶんアルゴリズムに拾われたんだわ。一晩で勝手に伸びてた。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'サムネは大事。',
            'いいサムネかどうかで全然違うよね。',
            'つまんないサムネだと誰もクリックしない。目を引かないとダメ。',
            'マジそれ。驚いた顔とデカい文字のやつ必ずクリックしちゃう。毎回やられる。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '広告多すぎ。',
            'この動画広告多すぎだろ。',
            '何も見れないんだけど。まず広告5本見させられるし。',
            'もうプレミアム入れって。先月負けて課金したけど正直めっちゃ快適。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'おすすめの動画ある？',
            'いいチャンネルない？おすすめ教えて。',
            'なんか新しいの見たいんだけど。最近どのチャンネル見てる？',
            'お前絶対好きなやつある。見つけた料理チャンネル、めっちゃ面白くてレシピも簡単。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '生配信見てた。',
            'さっき生配信見てたんだけどすごいよかった。',
            '昨日生配信見てたら夜更かししすぎた。',
            'どの配信者？見てみたい。TwitchとYouTubeどっち？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'コメント欄が面白い。',
            'コメント欄が動画で一番面白い。',
            'いつもコメント欄読むんだけど、動画より面白い時あるよね。',
            'だよね？トップコメントが動画全体より面白い時ある。いつも先にスクロールしちゃう。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '動画編集って大変そう。',
            '動画の編集ってめっちゃ大変そうだよね。',
            '一回動画編集やってみたけど永遠にかかった。クリエイターほんと尊敬する。',
            'だよね。友達がYouTuberなんだけど5分の動画に10時間かけてるって。ガチだよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '案件動画っぽいな。',
            'これ案件だろ。絶対金もらってるよ。',
            '案件動画ってすぐわかるよね。急に関係ない商品の話し始めるし。',
            'ほんとそれ。「ところで」って言った瞬間、あ、広告来るなってわかる。',
        ],
...

    {
        ...
        jaTranslations: [
            'ネットの方が安い。',
            '店で買うよりネットの方が安いじゃん。',
            'いつもまずネットで調べるんだけど、十中八九ネットの方が安い。',
            'ほんとそう。モールで靴8000円だったのにネットで同じやつ半額で買えたわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'カートに入れたまま忘れてた。',
            'カートに2週間くらい入れっぱなしのやつある。',
            'カートに入れるだけ入れて結局買わないんだよね。ウインドウショッピングみたいなもん。',
            'あるある。もうカートがほぼウィッシュリストだわ。一生買わないと思う。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'レビューを先に見る。',
            '何買うにしてもまずレビュー見る派。',
            'レビュー見ないで何も買わない。何回も痛い目見てるから。',
            '賢いな。俺レビュー見ないで充電器買ったら2日で壊れた。二度とやらん。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '届くのが遅い。',
            '1週間前に注文したのにまだ届かない。',
            '5分おきに追跡確認してるんだけど、見たところで早くなんないよね。',
            '追跡見た？俺のは1週間「輸送中」って表示されたまま急に届いたよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            '写真と全然違うんだけど。',
            '届いたら写真と全然違うやん。金返せ。',
            'あるある。返品して星1レビューつけとけ。他の人が騙されないように。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'セール始まってる。',
            'ねえ、めっちゃでかいセールやってるよ。',
            'セール始まったって通知来た。売り切れる前に見なきゃ。',
            'やめて、言わないで。今月節約してるのに。いつまでやってるの？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'これ返品できる？',
            '返品できるか知ってる？',
            'これ返品したいんだけど箱もう捨てちゃった。受け取ってくれるかな？',
            'まず返品ポリシー確認しな。大体30日以内だけど元の箱いるかも。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ポイント結構貯まってる。',
            'この時のためにポイント貯めてたんだよ。',
            'ポイントでこれタダでもらえる。人生で一番幸せな日だわ。',
            'いいな！何に使うの？そんなに貯めてたならいいもの買えよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '衝動買いしちゃった。',
            '完全に衝動買い。いらないのに。',
            '何も買うつもりなかったのにセール見たら我慢できなかった。',
            '何買ったの？頼むからまた1回しか使わないキッチングッズって言わないで。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'サブスク多すぎ。',
            'サブスク7個も入ってることに気づいた。',
            'サブスクいくつか解約しないと。毎月めっちゃ金出てってる。',
            '俺も。半年開いてないアプリにまだ金払ってたの気づいて即解約した。',
        ],
...

    {
        ...
        jaTranslations: [
            'このアプリ便利。',
            'このアプリ試してみ。めっちゃ使える。',
            'このアプリ見つけたんだけど全部楽になるよ。見せようか。',
            'え、マジ？リンク送って。ずっとそういうの探してたんだよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            '大事な時にアプリが落ちたんだけど。',
            '大事な作業中にアプリ落ちて全部消えた。',
            '閉じて開き直してみた？俺のもなるよ。最新アップデートバグってると思う。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '通知オフにした。',
            '通知うざすぎて全部オフにした。',
            'もう無理。5分おきにどうでもいい通知でブブブブ鳴るし。',
            '正直最高の判断だよ。俺も先月やったけどスマホがめっちゃ平和。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ストレージがいっぱい。',
            '何もダウンロードできない。ストレージいっぱいだって。',
            'アプリ消さなきゃだけどどれ消していいかわかんない。',
            'まずキャッシュ消してみ。俺のは何も消さずに5GB空いたよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'アプデで使いにくくなった。',
            'アプデしたら最悪になった。',
            'なんで普通に使えてたものをわざわざ変えるかな？新しいレイアウト最悪。',
            'わかる。銀行アプリ同じことなった。振込ボタン見つけるのに永遠にかかった。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '課金する価値ある？',
            '有料版にした方がいい？価値ある？',
            '無料版使ってるんだけどアップグレードする価値あるか迷ってて。',
            '有料版にしたけど正直別物だよ。無料版は制限多すぎ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'パスワード忘れた。',
            'ログインできない。またパスワード忘れた。',
            'これでパスワードリセット10回目くらい。一生覚えられない。',
            'おい、パスワードマネージャー入れろって。全部覚えてくれるから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'このアプリ怪しくない？',
            'このアプリ信用できない。権限要求しすぎ。',
            'ライトのアプリがなんで連絡先とマイクのアクセス必要なの？',
            'うん、絶対ムリ。シンプルなアプリがそんな権限求めてきたら何かヤバいことしてる。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '地図アプリなしでは無理。',
            'Google Mapsなしじゃどこにも行けない。',
            'ナビ使ってる最中にスマホ切れたらマジで迷子。文字通り。',
            '同じ。この前コンビニ行くのに使ったわ。方向音痴レベルがやばい。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'フリマアプリで売れた。',
            '出品したら1時間で売れた。',
            'フリマアプリに出したらすぐ売れた。信じられない。',
            'え、もう？いくらで売れたの？俺も出品しなきゃいけないもの山ほどあるわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'それどういう意味？',
            'ちょっと待って、それどういう意味？',
            'ネットでよく見るけど意味わかんないんだよね。',
            'ああ、基本的に誰かの大胆な意見に賛成するって意味。俺も調べたから気にすんな。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ネットで見た。',
            'この前ネットで見たんだけど。',
            'ネットでこの投稿見つけてからずっと頭から離れないんだよね。',
            'へー何の？俺いつも深夜に謎のうさぎの穴に落ちてるわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'そのミーム見たことある。',
            'あーそのミーム知ってる。今どこにでもあるよね。',
            'そのミームめっちゃタイムラインに流れてくる。みんな使ってるよ。',
            '今日10人くらいに送ったわ。今起きてること全部に当てはまるんだよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'フェイクニュースっぽい。',
            'それ本当？フェイクニュースかもよ。',
            '信じる前にダブルチェックした方がいいよ。デマめっちゃ多いから。',
            'うん、俺も見た。風刺サイトだったってよ。本物みたいにシェアされてたけど。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ググれ。',
            'なんで俺に聞く？ググれよ。',
            'ポケットにインターネット入ってるの知ってるよね？調べろって。',
            'わかってるわかってる。でも聞いた方が画面見るより楽しいじゃん。教えてよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'バズりたい。',
            '一回くらい投稿バズってほしい。',
            'バズる投稿しようとしてるんだけど何やっても全然ダメ。',
            'てきとうに投稿して力抜けって。バズるやつって計画したやつじゃないから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '直接会おうよ。',
            'リアルで遊ぼうよ。',
            'ネットではいつも話してるのに全然会わないよね。なんとかしよう。',
            'そうだよね、久しぶりすぎる。今週の土曜は？どっかでご飯食べよう。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ネットの情報を鵜呑みにするな。',
            'ネットの情報は話半分に聞いた方がいいよ。',
            'ネットに書いてあるからって本当とは限らないからな。',
            'それうちの親父に言ってくれ。Facebook全部信じてるよ。マジイライラする。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ネットなしじゃ生きれない。',
            'ネットなしで何したらいいか正直わかんない。',
            'もし1週間ネット止まったら社会崩壊すると思う。',
            'マジで。先週Wi-Fi切れた時、迷子の犬みたいに壁見つめてた。',
        ],
...

    {
        ...
        jaTranslations: [
            'スマホ見すぎ。',
            'スマホの時間使いすぎてるのわかってる。',
            'スクリーンタイム見たら恥ずかしくなった。1日7時間。',
            '7時間？えぐ。俺5時間で既に現実逃避してたのに。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'デジタルデトックスしてみた。',
            '週末ずっとスマホなしで過ごしてみた。',
            '先週末デジタルデトックスした。スマホもPC も画面一切なし。',
            'マジで？週末ずっと？俺3時間で負けると思う。どうやって生き延びたの？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '通知が気になる。',
            '何か見逃してないか気になって仕方ない。',
            'スマホないのにポケットでブブってなった気がするんだよ。',
            'それまさにFOMOだよ。何か大事なこと見逃してるって脳が騙してるだけで、実際は何もない。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '寝る前のスマホやめたい。',
            '寝る前のスクロールが体に悪いのはわかってるけどやめられない。',
            '毎晩11時にスマホ置くって決めるのに毎晩失敗する。',
            '寝る前にスマホ部屋の向こうに置いてみ。最初うざいけどマジで効く。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'たまにはオフラインもいい。',
            'たまにはネット切るのもいいもんだよ。',
            '5分おきにスマホ確認しないで「今」にいるのがこんな気持ちいいの忘れてた。',
            'やってみようかな。数時間だけでもスマホなしって今ちょっと魅力的。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '目がめっちゃ疲れた。',
            '一日中画面見てたら目が限界。',
            '目を休ませないとダメだわ。全部ぼやけてきた。',
            'ブルーライトカットメガネ試した？先月買ったら頭痛がすぐなくなったよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'Wi-Fiが繋がらない。',
            'なんでWi-Fi繋がらないの？イライラする。',
            '10分くらい接続しようとしてるんだけど。ルーター再起動しなきゃかな。',
            'ルーター再起動してみた？大体それで直る。10秒くらいコンセント抜くだけ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '充電がもうない。',
            '残り3%。誰か充電器持ってない？',
            'スマホ死にそうなのに充電器持ってない。緊急事態だわ。',
            'ほら使って。カバンにモバイルバッテリーあるから。帰るまで貸すよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'アナログな時間も大事。',
            'もっと画面から離れる時間が必要だよ。',
            'たまには昔ながらのやり方でやるのもいいもんだよ。',
            'じいちゃんみたいなこと言うね。でも正直一理ある。今週末紙の本読んでみようかな。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'テクノロジーと健全に付き合いたい。',
            'テクノロジーとのバランスを見つけたい。',
            'ネットやめたいんじゃなくて、もっと意識的に使いたいんだよね。',
            'いい言い方だね。全部やめたいんじゃなくて、夜中2時のドゥームスクロールをやめたいだけ。',
        ],
