...
export const MONTH3_W9_EXPRESSIONS: MasterExpression[] = [
...

    {
        ...
        jaTranslations: [
            '会わせたい人がいるんだ。',
            '紹介したい人がいるんだけどさ。',
            'みんな、ずっと会わせたかった人がいるんだよね。',
            'いいじゃん、連れてきなよ！一人くらい全然余裕だって。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'いらっしゃい、くつろいでね。',
            'いらっしゃい！リラックスして自分の家だと思ってくれよ。',
            'よく来たな！適当に座って、楽にしてくれ。',
            'ありがとうございます！もうめっちゃ居心地いいです。最高ここ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'はじめまして。お話は聞いてます。',
            'はじめまして！ユキがいっつもあなたの話してるんですよ。',
            'やっと会えた！ユキがこの店すごいって話してばっかりで。',
            'うれしい！ユキからめっちゃ聞いてるよ。来てくれてありがとね！',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'はじめまして。',
            '会えてうれしいよ！これからよろしくね。',
            'ほんとに会えてうれしい。もっとみんなで遊べたらいいな。',
            'こちらこそ！今日ゆっくりしてけば、ユキがこの店の話ばっかする理由わかるから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '何の仕事してるの？',
            'で、仕事は何やってるの？',
            '聞いていいかわかんないけど、何の仕事してるの？',
            '実はマーケティングなんだ！主にデジタル系。忙しいけど好きなんだよね。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '日本にはどれくらいいるの？',
            '日本に住んでどれくらいになるの？',
            'で、日本にはどれくらいいるの？しばらくいる予定？',
            '1年半くらいかな。正直あっという間だった。もうそんな経つのかって感じ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '日本語上手だね。',
            'えっ、日本語めっちゃうまいじゃん！',
            'ちょっと待って、日本語ほんとにうまいね！どれくらい勉強してるの？',
            'あはは、ありがとう！3年やってるけど漢字には毎日ボコボコにされてるよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '俺たちここの常連なんだ。',
            'いつも来てるんだよ。もう常連みたいなもん。',
            'うん、俺たち全員ここの常連。毎週のように来てるよ。',
            'いいね！だからみんな仲良さそうなんだ。付き合い長いの伝わるよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '遠慮しないでね。',
            '遠慮しないで。好きなもの言ってくれよ。',
            '好きなもの何でも頼んでくれ。遠慮すんなよ。今夜はおごりだ。',
            'みんな優しすぎるって！じゃあ遠慮なく、みんなと同じのもらおうかな。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'この店に来ると元気出るよ。',
            'ここに来るといつもいい気分になる。',
            'しんどい日でもここ来るとすぐ元気になるんだよね。',
            'わかる！こっちも仕事最悪だったのにもう全然平気。ここ魔法かよ。',
        ],
...

    {
        ...
        jaTranslations: [
            '第一印象って大事だよね。',
            '第一印象ってやっぱ大事だよね？',
            '第一印象がすべてだっていつも思う。一発勝負だからね。',
            'それな。いつも笑顔でリラックスしようとするけど、正直毎回考えすぎちゃうんだよね。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '最初はちょっと怖そうに見えた。',
            '正直、最初ちょっと近寄りがたかったよ。',
            '嘘つかないけど、初めて会ったときちょっと威圧的に見えたんだよね。',
            'え、マジで？それよく言われるんだよね。ほんとは優しいんだって、顔がそう見えないだけで。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '見た目は当てにならない。',
            '見かけで判断できないよね。',
            '人って見た目通りじゃないよね。見かけってほんとあてにならない。',
            'ほんとそれ。うちの会社で一番静かなやつが実は一番おもしろかったもん。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'すぐ仲良くなったよね。',
            '最初から気が合ったよね。',
            'すぐ意気投合したのおもしろいよね。前から知ってたみたいだった。',
            'だよね？こんなの珍しいよ。普通は慣れるまで何週間もかかるのに。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '人見知りだから最初きつかった。',
            '初対面の人苦手だから、最初しんどかったんだよね。',
            '昔から人見知りだから、知らない人の集まりとかマジ緊張するんだよ。',
            '緊張してたの全然わかんなかった！あの夜めっちゃ自然に見えたよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '話してみたら全然違った。',
            'でも実際話してみたら全然違ったよ。',
            '最初は勘違いしてたけど、話してみたら想像と全然違う人だった。',
            'あはは、こっちもだよ！超真面目な人かと思ったらめちゃくちゃおもしろいし。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'あの人、感じいいよね。',
            'あの子、いい雰囲気出してるよね。',
            'あの子からすごくいいオーラ感じた。ほんとにいい人っぽい。',
            'ね？5分で昔から知ってるみたいに感じるタイプの人だよね。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '目を見て話す人は信用できる。',
            '話すとき目を見る人は信頼できるよ。',
            '目を見て話せる人はずっと信用できるって思ってる。',
            'うーん、確かにね。でも目が合わせられないだけですごく優しい人もいるよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '笑顔がすてきだった。',
            '笑顔がすごく温かくて自然だったよね。',
            '最初に気づいたのが笑顔。嘘がなくて、こっちまで安心した。',
            'ね、本物の笑顔ってわかるよね。パーティーで見る作り笑いとは全然違う。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '俺は人を見る目がある。',
            '人を見る目にはずっと自信あるんだよね。',
            '人を見る目はあると思ってる。会った瞬間にだいたいわかるんだよ。',
            'じゃあ俺の第一印象は？聞くの怖いけど知りたい。',
        ],
...

    {
        ...
        jaTranslations: [
            'どんな見た目だった？',
            'で、どんな見た目だった？描写してよ。',
            'ほら教えてよ、どんな子だった？詳しく言ってよ。',
            'うーん、何から言えばいいかな…かわいかった？めっちゃかわいい感じ。それしか出てこない。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '背が高くて細かった。',
            '背が高くて、すごくスラッとした体型だった。',
            'けっこう背高かったな、170くらい？で、なんか上品にスラッとしてた。',
            'え、どんくらい背高いの？お前より高い？ぶっちゃけそれアリだわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '髪が長くて茶色かった。',
            '髪がすごく長くて、明るめの茶色だった。',
            '髪がめっちゃきれいな長い茶色で、腰くらいまであった。',
            'え、茶色のロングヘア？お前の好きなタイプじゃん。ちゃんと話した？見てただけ？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '丸顔で優しそうだった。',
            '柔らかい丸顔で、すごく穏やかそうに見えた。',
            '丸顔で顔立ちが柔らかくて、なんか話しかけやすい温かい感じの人だった。',
            'えーかわいい。もう写真見せてよ絶対。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'メガネかけてた？',
            'メガネかけてた？',
            'ちょっと待って、メガネかけてた？なんかそれ重要情報な気がする。',
            'うん、かわいい丸メガネかけてた。正直めっちゃ似合ってた。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ちょっとぽっちゃりしてた。',
            'ちょっとふくよかな感じで、俺は全然アリだと思う。',
            'ガリガリって感じじゃなくて、ふくよかな感じ。健康的で自信ありそうだった。',
            'おい、言い方気をつけろよ。「ふくよか」はいいけど、本人に言ったら殺されるぞ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'おしゃれだった。',
            'すごくおしゃれで、ちゃんとしてた。',
            'なんか頑張ってない感じなのに全部キマってた。ナチュラルにおしゃれなタイプ。',
            'いいなー。こっちは1時間かけて準備してもボロボロなのに。',
        ],
        context: 'put together は「きちんとまとまっている」。effortlessly stylish は「頑張ってない風にオシャレ」。fashionable は少し古臭い響きもある。stylish の方がモダン。got dressed in the dark は「暗闘で着替えた」＝センスがない、の自虐。',
        character: 'lisa', category: 'social', month: '2026-06',
    },
    {
        ...
        jaTranslations: [
            '年齢がわからなかった。',
            '年齢が全然読めない顔だった。',
            'マジで何歳かわかんなかった。25にも40にも見える感じ。',
            'アジア人あるあるだよね。俺もいっつも年齢間違えられるし。褒め言葉ってことにしとく。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '雰囲気がいい人だった。',
            'すごく温かくて、歓迎してくれるオーラがあった。',
            'なんかあの人がいるだけで場が和む感じだった。',
            'わかるわかる。ああいう自然な温かさって作れないもんな。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '写真と全然違った。',
            '写真と全然違う人だった。',
            '正直、プロフィール写真と全然違ったんだよ。でもいい意味で。',
            'いい意味で？悪い意味で？だってそれどっちにも転ぶやつじゃん。',
        ],
...

    {
        ...
        jaTranslations: [
            '真面目すぎるのが唯一の欠点。',
            '唯一の欠点は、何でも真面目に受け止めすぎるとこ。',
            'いいやつなんだけどさ。唯一の欠点は何もかも真面目に捉えすぎるとこだな。',
            'おい、俺ここにいるんだけど。てか俺そんな真面目か…？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '天然ボケだよね。',
            'ちょっと抜けてるけど、そこがかわいいんだよね。',
            '完全にぽわぽわ系なんだけど、みんなそこが好きなんだよね。',
            'あはは、確かに！でも正直、そこが一緒にいて楽しい理由だよね。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '自分のペースでやる人だよね。',
            '我が道を行くタイプだよね。',
            '完全にマイペース。周りの目とか全然気にしないの。',
            'いいなー。俺も人の目気にしないで生きたいけど、メンタル弱すぎて無理。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '空気が読めないやつだよ。',
            '場の空気を読むの完全にダメなんだよあいつ。',
            '空気読む力ゼロ。思ったこと全部そのまま言うの。',
            'うわ、ほんとそれ。葬式であのジョーク言った時覚えてる？消えたかった。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'あの子は気が利くよね。',
            'あの子、いつも細かいとこに気づくタイプだよね。',
            'めちゃくちゃ気が利くよね。誰も気づかないことに気づくもん。',
            'うん、先週俺が落ち込んでた時、何も言ってないのにLINEくれたんだよ。びっくりした。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'あの子は嘘がないよね。',
            '見たまんまの人だよね、あの子。',
            '俺が知ってる中で一番裏表がない人。隠してることなんか何もない。',
            '最近珍しいよね。会う人みんな何かしら演じてる感じするもん。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ノリがいい人っているよね。',
            'ノリがいい人って自然と場が盛り上がるよね。',
            '何にでも乗ってくれる人好きだわ。何やっても楽しくなるもん。',
            'タケシがまさにそれだよね。「カラオケ」って言った瞬間、言い終わる前にもう出口にいるし。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '頑固だけど悪い人じゃない。',
            'ロバみたいに頑固だけど、根はいいやつだよ。',
            'まあ確かに頑固だけど、心の奥ではみんなのこと本気で大事にしてるよ。',
            'あはは、「頑固」って優しく言ったね。あの人、醤油のブランドすら変えないんだぜ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '実はけっこうさみしがり屋なんだよね。',
            '強そうに見えるけど、実はすぐ寂しくなるタイプ。',
            'あんなに自立してるフリしてるのに、一人でいるの本当はめっちゃ嫌いなんだよ。',
            'マジ？いつもクールぶってるのに。まさかベッタリタイプだとは思わなかった。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'みんな違うからね。',
            'まあ、人それぞれ性格あるからさ。',
            '結局、人ってみんな違う作りしてるわけで、だからおもしろいんだよ。',
            'ほんとそれ。このメンバーのいいとこって、全員バラバラなのになぜかうまくいってるとこだよね。',
        ],
...

    {
        ...
        jaTranslations: [
            '孫が歩けるようになったんだ。',
            'うちの孫がやっと歩き始めてさ、もう最高にかわいいの。',
            'みんな聞いてよ、先週孫が初めて歩いたんだけど、泣きそうになったわ。',
            'うそ、かわいい！動画見せて！絶対めちゃくちゃかわいいでしょ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '嫁姑の関係って大変だよね。',
            '嫁と姑の関係ってほんと難しいよね。',
            '義理の家族とうまくやるのって結婚で一番キツいとこだわマジで。',
            'わかるわー。うちの嫁と母親がめっちゃ遠回しにバチバチで頭痛い。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            '兄弟か姉妹いる？',
            '一人っ子？それとも兄弟いる？',
            'うん、兄貴が一人。子供の頃はめちゃくちゃケンカしたけど今はめっちゃ仲いいよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '自分が親に似てきてる。',
            'だんだん親父に似てきてて怖い。',
            '歳とるにつれて、自分が親父と全く同じことしてるのに気づくんだよ。マジ怖い。',
            'あはは、仲間だな。先週「俺の時代はな」って言ってる自分に気づいて発狂しかけた。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '親が過保護なんだよね。',
            '親が過保護すぎてマジしんどい。',
            '親のこと好きだけど、過保護すぎて息苦しい時あるんだよね。',
            'わかる！うちの母親毎晩電話してくるの。もう大人なんですけど？って感じ。聞いてくれないけど。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '親にもっと良くしなきゃなと思う。',
            '親にもっと何かしてあげなきゃなってずっと思ってる。',
            '親にもっと会いに行こうっていっつも言うんだけど、結局行かないんだよな。',
            'わかるわー。親がどんだけやってくれたか、歳とらないと気づかないよな。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '娘が反抗期なんだ。',
            'うちの娘、今がっつり反抗期でさ。',
            '娘が反抗期で、俺が何言っても全部嫌がるんだよ。',
            'うわー、頑張れ。うちの姉ちゃんも同じだったけど、今は毎週日曜に親父に電話してるよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'うちの親は放任主義だった。',
            'うちの親は基本何でも好きにさせてくれた。',
            'けっこうゆるい家庭で育ったんだよね。自由にやらせてもらえた。',
            'へー面白いね。うちもそうだったら良かったのにな。隣の芝は青いってやつか。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '今なら親の気持ちわかるわ。',
            '親があんなこと言ってた理由、やっとわかった。',
            '昔は親のこと頭おかしいと思ってたけど、今なら完全に気持ちわかるわ。',
            'ほんとそれ。うちの母親いつも「貯金しろ」って言ってたのに聞かなかった。聞いときゃよかった。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '家族の写真見せてよ。',
            'ほら、家族の写真見せてよ！',
            'そんだけ話すなら写真見せろよ！家族見たいわ。',
            'あーあ始まった。ケンジさんが孫の写真出したら1時間コースだぞ。',
        ],
...

    {
        ...
        jaTranslations: [
            '幼なじみなんだって。',
            '小さい頃からの友達らしいよ。',
            '一緒に育ったんだって。5歳くらいからの付き合いらしい。',
            '幼稚園から？やばいね。俺なんか幼稚園の友達一人も覚えてないわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '親友って何人いる？',
            '親友って本気で呼べる人、何人いる？',
            'ガチの話、人生で本当に親友って言える人何人いる？',
            'うーん、正直？2人かな。甘く見て3人。でもその3人は鉄板だわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '気まずくなっちゃった。',
            'あのことがあってから友達関係ちょっと気まずくなっちゃって。',
            'あの一件の後、なんか二人の間がめっちゃ変な空気になっちゃって。',
            'それきついね。正直に話してみたら？空気変わるかもよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '友達の友達ってだけだった。',
            '共通の友達を通じて知り合っただけだった。',
            '別に友達ってわけじゃなくて、たまたま同じ人を知ってただけだった。',
            'あー、俺の友達もほとんどそんな感じで始まったわ。ランダムだよね。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '縁を切ったんだ。',
            'あの人とは完全に縁を切った。',
            '去年友達と縁切らなきゃいけなくて。人生で一番きつい決断だった。',
            'うわ、それはキツかったね。でもたまには自分のためにそうするしかない時もあるよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '仲直りしたいんだけど。',
            '仲直りしたいんだけど、どうしたらいいかわかんなくて。',
            'ずっと連絡したいと思ってたんだけど、何から始めたらいいかわかんないんだよね。',
            '軽い感じでLINEしてみなよ。考えすぎるなって。向こうも寂しいと思うよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'あの二人めっちゃ仲いいよね。',
            'あの二人いつも一緒。何するにも一緒だよね。',
            'あの二人ほんとにいっつも一緒じゃない？親友の超強化版って感じ。',
            'だよね！お互いの言葉の続き言うし。正直ちょっと怖いけどかわいい。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '距離感って大事だよね。',
            '友達との距離感ちゃんと保つのって大事だよね。',
            '長く友達でいるコツって、お互いにどれだけスペース与えるかだと思う。',
            'ほんとそれ。俺の親友とか何ヶ月も連絡とらなくても、再会した時全然気まずくないし。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '推しの良さをあの子に伝えたい。',
            '推しがどんだけすごいか英語で説明したくて仕方ない。',
            'あの子にこのグループ布教しようとしてるんだけど、英語でうまく言えないの。',
            'あの舞台裏の動画見せなよ。俺もあれでハマったから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'いい友達がいることに勝るものはないよ。',
            '結局、周りにいる人が一番大事なんだよな。',
            'それに乾杯。マジでお前らがいなかったらどうなってたかわかんない。本気で言ってる。',
        ],
...

    {
        ...
        jaTranslations: [
            'よし、俺を英語で描写してみろ。',
            'いいか、お前ら一人ずつ俺を英語で描写しろ。いけ。',
            'チャレンジだ。俺を英語だけで描写しろ。正直に言え。',
            'え、これテスト？やばい、英語の準備できてないんだけど。最後でいい？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '厳しいけど優しい人。',
            'えーっと、外は厳しいけど中は柔らかい人…？',
            'なんて言えばいいかな…厳しい先生なんだけど、実は生徒のこと本気で大事にしてるみたいな。',
            'ドンピシャ！まさにそれだよ。厳しいけど優しいって完璧な表現だわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '基本的にツンデレです。',
            '一言で？完全にツンデレ。',
            '一言でまとめるなら、ツンデレ。表面は冷たいけど中はあったかい。',
            'はは！マスターの今の顔、最高。笑うの我慢してる。完全にツンデレの動き。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'リサは頼れるお姉さんのような人です。',
            'リサって完全にお姉さんオーラ出てるよね。',
            'リサはグループの頼れるお姉さんポジション。みんな相談しに行くんだよ。',
            'やめてよ照れるじゃん。でもまぁ、誰かがお前らの面倒見ないとね。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'タケシはうるさいです。',
            'タケシ？一言で。うるさい。',
            'タケシをどう描写するか？あいつはどの部屋に入っても一番声がデカい。',
            'おい！それだけ？「うるさい」だけ？もうちょいなんかあるだろ俺に！',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ケンジさんは静かですが存在感があります。',
            'ケンジはあんまり喋らないけど、喋ったらみんな聞く。',
            'ケンジは寡黙な実力派。喋らなくても影響力がある。',
            'それ、めっちゃうまい表現。完璧に言い当ててる。まさに寡黙な実力派。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ミナはエネルギーの塊です。',
            'ミナって歩くエネルギーの塊みたいなもんだよね。',
            'ミナがこのグループにどんだけ活気くれてるか。入ってくるたびに太陽みたいなんだよ。',
            'えーみんなやめてよ！今まで言われた中で一番嬉しい。泣いてないよ、泣いてるのそっちでしょ！',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'え、俺の描写ひどくないですか？',
            'ちょっと待って、俺のことそう描写するの？ひどくない？',
            'マジで？俺について言えることが「うるさい」だけ？傷ついたんだけど。',
            '落ち着けよ、エネルギーを与えるとも言ってたじゃん。褒め言葉だろ、このうるさい玉ねぎ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '英語で人を描写するのは難しいです。',
            '英語で人を正確に描写するのって結構難しい。',
            '英語で人を描写するの、思ったより全然難しいって気づいた。ニュアンスがめっちゃ消える。',
            'わかる。「天然」って言いたかったのに、英語にそれを表す言葉がないんだよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '来週もこの調子で頑張りましょう。',
            'いい感じだぞ。来週もこの勢いで行こう。',
            'お前ら全員、誇りに思うぞ。来週も同じ熱量で。まだまだ学ぶことあるからな。',
            'え、今マスターおごりって言った？誰かスクショして。二度とないから！',
        ],
