...
export const MONTH6_W23_EXPRESSIONS: MasterExpression[] = [
    ...
    },
    {
        ...
        jaTranslations: [
            'この道で合ってる？',
            'こっちの方向で合ってる？',
            'どっかで曲がるとこ間違えた気がする。ここ合ってると思う？',
            '正直、違うと思う。引き返して駅に戻ろうよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'すみません、助けてもらえますか？',
            'すみません、道を教えてもらえますか？',
            'すみません、ちょっと迷っちゃって。駅はどっちの方向ですか？',
            'いいよ！2ブロックまっすぐ行って、大きい教会のとこ左に曲がって。すぐわかるよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '地図アプリが動かない。',
            'Google Mapがバグってる。ずっと海の上にいることになってるんだけど。',
            '電波入んないしGPS全然ダメ。もう自力で行くしかないわ。',
            '俺のも死んでる。ホテル出る前にオフライン地図ダウンロードしとけばよかった。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '誰かに聞こう。',
            'あそこの人に聞いてみよう。',
            'あの人、地元の人っぽい。行っちゃう前に聞こうよ。',
            'いいね。この辺詳しそうだし。でもお前が行けよ。俺、英語ダメだから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '地図読むの苦手。',
            '地図、マジで読めないんだよね。',
            '地図は昔からダメ。いっつも逆方向に行っちゃう。',
            'わかる。俺なんか10ブロックも逆に歩いて、番号が増えてくのでやっと気づいたことあるよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'こっちだと思う。',
            'たぶんこっちだよ。',
            'この地図が合ってれば北に行くはず。北は……あっちかな。',
            'わかった、信じるよ。でももっと迷ったら飯おごりな。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'タクシー拾おうよ。',
            'もう歩くのやめてタクシー乗ろう。',
            'もうウロウロするのは限界。タクシー止めてここから出ない？',
            '正直、賛成。足が死にそう。あ、あそこにいるよ、手振って！',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '迷うのも旅のうちだよ。',
            '迷子になったのも、あとでいい話になるって。',
            '何年か後に絶対笑い話になるよ。あのとき絶望的に迷ったよなーって。',
            'たしかにね。この辺、意外といい雰囲気じゃん。迷わなきゃ来なかったよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'やっと着いた。',
            'あーやっと着いた、よかった……。',
            'マジでたどり着けるとは思わなかった。あと2分で完全に諦めてたよ。',
            'やっとかよ！次どこか行く前に、世界中のオフライン地図全部ダウンロードするわ。',
        ],
...

    {
        ...
        jaTranslations: [
            'パスポートが見つからない。',
            'パスポートがない。どこ探してもない。',
            'うそでしょ……パスポートなくしたかもしれない。',
            'まだ焦るな。最後に持ってたのいつ？よく思い出して。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '最後に見たのどこ？',
            'よく思い出して。最後に持ってたのいつ？',
            'じゃあ行動を振り返ろう。最後にパスポートを手に持ってたの、どこ？',
            'ホテルだと思う。今朝フロントで使って……そのあとは覚えてない。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'どこかで落としたかも。',
            '気づかないうちに落としたかもしれない。',
            'カバンから落ちたんだと思う。昨日からジッパー壊れてたし。',
            'あの壊れたジッパー？それならありえるわ。誰かに拾われる前に来た道戻ろう。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '盗まれたかもしれない。',
            '誰かに取られたんじゃない？さっきぶつかってきた人いたし。',
            '地下鉄であの男がぶつかってきたの覚えてる？あの時やられたんだと思う。',
            '覚えてる。めっちゃ怪しかったよね。ケンジが言ったようにカバン前で持てばよかったのに。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '大使館に連絡しないと。',
            'まず日本大使館に連絡するべきだ。',
            '本当になくなったなら届け出して、明日一番で大使館に行かないと。',
            'そうだね、先に警察の届出がいる。それがないと大使館も動いてくれないよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '見つかった！',
            'あった！ずっとジャケットの中にあった！',
            'ちょっと待って。勘違いだった。ジャケットの内ポケットにずっと入ってた。',
            'うそでしょ。1時間もパニクってたのに、ジャケットの中？今夜おごりな。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '貴重品はちゃんとしまっとけ。',
            'もうちょっと自分の持ち物気をつけなよ。',
            'この騒ぎのあとだし、全員もっと貴重品に気をつけよう。',
            'わかってるって。これからはホテルの金庫に入れる。もう二度とあんな思いしたくない。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'コピー取っとけばよかった。',
            '全部コピーしとくべきだったってわかってたのに。',
            'だから大事な書類はコピーしとけって言われるんだよ。',
            'それ賢いな。俺も今夜全部自分にメールで送っとく。もうあんなミスしない。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'いっつも物なくすんだよね。',
            '自分の持ち物管理、マジで最悪なんだよ。',
            '頭がくっついてなかったら頭もなくしてると思う、マジで。',
            'もうGPSトラッカーつけたほうがいいよお前の荷物。冗談じゃなくて本気で。',
        ],
...

    {
        ...
        jaTranslations: [
            'お腹痛い。',
            'めっちゃ腹痛いんだけど。',
            '何か食ったのが当たったっぽい。朝からずっと腹が死んでる。',
            '顔色やばいよ。昨日の屋台のやつじゃない？あそこ嫌な予感してたんだよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '薬局どこ？',
            'この辺に薬局ある？',
            '一番近い薬局どこか教えてもらえますか？胃薬がほしくて。',
            '2本先の通りの左側にあるよ。市販の胃薬なら置いてるはず。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            'なんか体めっちゃ熱い。熱あるかも。',
            '暖かいのに寒気がする。たぶん熱出てる。',
            'おでこ触らせて。うわ、めっちゃ熱いじゃん。誰か体温計持ってない？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '病院行ったほうがいい？',
            '医者に診てもらったほうがいいかな？',
            '今夜までに良くならなかったら病院探さないとダメだな。',
            '水も飲めない状態なら医者行こう。悪化する前に動いたほうがいい。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '海外旅行保険入ってる？',
            '頼むから旅行前に保険入ったって言ってくれ。',
            '病院行く前に旅行保険確認しよう。海外の医療費シャレにならないから。',
            'うん、出発前に入ったよ。ホットラインの番号出すわ、24時間対応だから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '水だけでも飲んで。',
            '食べれなくても水分だけは取って。',
            '食欲ないのはわかるけど水だけは飲み続けて。脱水になったらもっとやばいから。',
            'やってみる。ちょっとずつだよね？今は胃がそれ以上受け付けない。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'アレルギーがあるんです。',
            '食物アレルギーがあるんで先に言っときます。',
            '何か出す前に言っときますけど、ペニシリンと甲殻類のアレルギーがあります。',
            'わかった、ペニシリンと甲殻類ダメね。薬剤師に何か出す前に伝えとくよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '日本の薬持ってきた？',
            '誰か日本の薬持ってない？',
            'いつも日本から薬セット持ってくるんだよね。何か効きそうなのあるか見てみる。',
            'お前神かよ。胃薬入ってるって言ってくれ。もう何でもいいから飲みたい。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '今日は部屋で休んだほうがいい。',
            '今日はベッドから出るな。無理すんな。',
            '観光なんかいいから。体が先だ。部屋でゆっくり休め。',
            'だよな。どうせみんなの足引っ張るだけだし。写真だけ撮ってきてくれ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '気分がだいぶ良くなりました。',
            '薬が効いてきた。だいぶ楽になったよ。',
            'やっと人間に戻った感じ。一番ひどいとこは超えたわ。',
            'マジ良かった！心配したんだぞ。でも無理すんなよ、今夜はおとなしくしとけ。',
        ],
...

    {
        ...
        jaTranslations: [
            '私の予約がシステムに入っていません。',
            '予約が入ってない？そんなはずないんですけど。',
            '3週間前に予約して、確認メールもここにあるんですけど。',
            'もう一度システム確認しますね。確認番号見せてもらえます？不具合かもしれません。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ダブルブッキングがあったと思います。',
            'そっちがダブルブッキングしたんじゃないの。',
            '俺が先に予約したのに、他の人に部屋渡したってこと？',
            '本当に申し訳ございません。対応させてください。今夜は別の部屋に移れるかもしれません。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'これは予約した部屋と違います。',
            'ダブルで予約したのにシングルなんですけど。',
            '手違いがあったみたいで。オーシャンビューのダブルルームって指定したんですが。',
            'おっしゃる通りです。空き状況確認して、すぐお部屋変えますね。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'マネージャーと話がしたいです。',
            'この件でマネージャーに話せますか？',
            'すみませんがこれ解決しないんで、責任者に話させてもらえます？',
            'もちろんです。夜間マネージャーを呼びますね。すぐ対応させますので。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'アップグレードできますか？',
            '部屋のアップグレードは可能ですか？',
            '今夜のトラブル考えたら、追加料金なしでいい部屋にしてもらえません？',
            'できると思います。今夜スイートが空いてるか確認しますね。もちろん追加料金はなしで。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '返金をお願いしたいのですが。',
            'これ、全額返金してほしいんですけど。',
            'こういう状況なんで、返金は最低限の対応でしょ。',
            'もちろんです。今すぐクレジットカードに返金処理して、確認メールもお送りしますね。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'カードの請求額が間違っています。',
            '多く請求されてます。同意した金額じゃないんですけど。',
            'この請求なんですか？確認メールの金額と全然違うんですけど。',
            '確かにおかしいですね。明細付きレシート出しますんで、どこで余計な請求が入ったか確認しましょう。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '他のホテルを探さないと。',
            'ここが解決しないなら、他の宿を探すしかないね。',
            '近くの他のホテル探し始めて。今夜中に解決しなさそうな予感がする。',
            'もうやってる。2ブロック先に口コミいいとこあるよ。埋まる前に押さえとく？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '悪い口コミを書いてやる。',
            'TripAdvisorに知らしめてやる。',
            'このホテル史上最も詳細な星1レビュー書いてやるからな。',
            'やれやれ。他の旅行者にも知らせないとな。俺もレビュー書いて援護するわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '結果的にはうまくいった。',
            'まあ結局いい部屋になったし、結果オーライかな。',
            '悔しいけど、もらったスイート元の予約よりめちゃくちゃいいんだよな。',
            'だよね？このジャグジーだけであのストレス帳消しだわ。でもレビューは書くけどな。',
        ],
...

    {
        ...
        jaTranslations: [
            'ここ誰も英語通じない。',
            'この国じゃ俺の英語まったく役に立たん。',
            '一日中英語で話しかけてんのに、誰一人わかってくれない。',
            'ほんとそれ。今朝コーヒー頼んだらスープ出てきたわ。指差しにも限界あるよな。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ジェスチャーを使えばいい。',
            '言葉がダメならボディランゲージだ。',
            '手と表情だけでも、意外なくらい伝わるもんだぞ。',
            'まあな。でもこの前「食べる」ジェスチャーしたら喉詰まってると思われたわ。思い切りが大事だな。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '翻訳アプリを使おう。',
            'ちょっと待って、Google翻訳開くから。',
            '待って、翻訳アプリあるから。打ち込んで画面見せるわ。',
            'ナイス判断。でも100%信用すんなよ。前に俺のやつ「チキン」が侮辱語に翻訳されたから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '基本的なフレーズだけでも覚えよう。',
            'せめて「こんにちは」「ありがとう」「すみません」は現地語で覚えよう。',
            '基本フレーズ5〜6個知ってるだけで、旅行の体験が全然変わるんだよ。',
            'それな。昨日現地語で「ありがとう」って言ったらおばちゃんの顔がパッと明るくなった。マジで効くよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '伝わった！',
            'うそ、ちゃんと理解してくれた！',
            '信じらんない。外国語で料理頼んだら、ちゃんと注文通りのが来た。',
            'いいね！ほらな、努力すればこうなるんだよ。みんな自分の言葉で話してくれると嬉しいんだって。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '発音が難しすぎる。',
            '何回やってもこの音出せないんだけど。',
            '10分間ずっと同じ単語言おうとしてんのに、毎回みんなポカーンとしてる。',
            'あはは、わかる。俺も1時間巻き舌Rの練習してんのに、喉詰まってるみたいな顔で見られるわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '書いて伝えよう。',
            '筆談でコミュニケーションできるかも。',
            '喋りがダメなら書いてみる。読める人は話せなくても読めるから。',
            '賢いな。英語話せなくても読める人って結構いるもんな。でっかく打ち込むわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'もっと英語を勉強しておけばよかった。',
            '英語の授業もっと真面目にやっとけばよかった。',
            'こういう時に痛感する。言語がちゃんと話せるって本当に大事だな。',
            'わかる。15年英語の授業受けてまともに注文もできないとか。帰ったら英会話教室申し込むわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'なんて言えばいいかわからない。',
            'これ英語でなんて言うの？全然わかんない。',
            '日本語では言いたいことわかってるのに、英語だと言葉が出てこない。',
            '焦んなくていいよ。簡単な言葉使って、必要なら指差せばいい。誰も責めないから、マジで。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '笑顔はどの言語でも通じる。',
            '困ったらとりあえず笑っとけ。どこでも通用する。',
            '完璧な語学力なんかいらない。心からの笑顔と優しい態度があれば結構いけるもんだ。',
            'ほんとそれ。今日すごく優しいおばちゃんが笑顔だけで助けてくれた。一言も通じてないのに最後まで案内してくれたよ。',
        ],
...

    {
        ...
        jaTranslations: [
            '財布をひったくられました。',
            '誰かに財布つかまれて走って逃げられた。',
            '道歩いてたらバイクの男に肩からバッグひったくられた。',
            'うそ、大丈夫？腕見せて。今すぐ警察呼ばないと。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '警察を呼んでください。',
            '誰か警察呼んで！今強盗にあったんです。',
            '今すぐ警察が必要です。バッグ盗まれて、犯人の特徴も説明できます。',
            '今電話してる。犯人の顔思い出してみて。特徴聞かれるから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'カードを止めないと。',
            '急いで銀行に電話してカード凍結しないと。',
            'まず最初にカード全部止めろ。使われる前に。',
            'ほら、俺の携帯使え。番号はメールのどっかにあるはず。使われる前に急げ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '大使館に連絡しないと。',
            '日本大使館に電話した方がいい。',
            'パスポートもバッグに入ってたなら、大使館行って緊急書類もらわないと。',
            '大使館の緊急番号保存してある。24時間対応だから。被害届出したらすぐ電話しよう。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '怪我してない？',
            '大丈夫？あいつに怪我させられてない？',
            'バッグはいいから。体は大丈夫か？腕見せてみろ。',
            '大丈夫、震えてるだけ。ストラップで腕にあざできたけど動くし。骨は折れてない。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '被害届を出したいです。',
            '盗難の届出をしたいんですが。',
            '30分くらい前に強盗にあったので、正式な届出を出したいんです。',
            '承知しました。今から調書を取ります。犯人の特徴とバッグの中身を教えてもらえますか？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '助けて！',
            '誰か助けてください！',
            '助けて！誰かいませんか？お願い、緊急なんです！',
            '大丈夫、英語わかるよ。警察呼んであげるから。座って深呼吸して。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'もう大丈夫だよ。落ち着いて。',
            'もう安全だから。深呼吸して。',
            '一番ひどいとこは終わった。俺たちがいるから。誰にも何もされない。深呼吸しろ。',
            'そうだよな。大丈夫。それが大事。物は全部替えがきく。ちょっと息つかせて。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '保険会社に電話しよう。',
            '旅行保険にすぐ電話した方がいい。',
            '保険のホットラインの番号保存してある。電話して状況説明するわ。',
            'ありがとうケンジ。代わりに電話してくれない？まだ震えて誰とも話せないから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'この経験から学んだことがある。',
            'まあ、今日は痛い教訓になったわ。',
            '二度とこんな目に遭いたくない。これからはできる対策全部やる。',
            'その姿勢だよ。正直、めちゃくちゃうまく対応したと思うぞ。残りの旅は俺たちがついてるから。',
        ],
...

    {
        ...
        jaTranslations: [
            'すみません、助けてもらえますか？',
            '本当にすみませんが、助けが必要なんです。',
            'お邪魔してすみません、ちょっと困ってまして、助けてもらえるとすごく助かるんですけど。',
            'もちろん、全然いいよ。何が必要？スマホで何か調べようか？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '道を教えてもらえますか？',
            '駅までの道を教えていただけますか？',
            '完全に迷ってスマホも電池切れなんです。セントラル駅への行き方教えてもらえませんか？',
            'セントラル駅？歩いて10分くらいだよ。俺もそっち行くから一緒に行こう。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '電話を借りてもいいですか？',
            '本当にすみませんが、1分だけ電話使わせてもらえませんか？',
            'スマホの電池が切れてホテルに電話しないといけないんです。ちょっと1本だけかけさせてもらえません？',
            'いいよ、どうぞ。手短にね。ホテルの番号は予約確認メールに載ってるはずだよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '日本語を話せる人はいますか？',
            'ここに日本語がわかる人はいませんか？',
            'ダメ元で聞くんですけど、この辺に日本語話せる人いたりしません？',
            '実はルームメイトが大学で日本語やってたんだ。電話してみるよ、通訳してくれるかも。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ここに連れて行ってもらえますか？',
            'この住所まで一緒に歩いてもらえませんか？',
            '住所は書いてあるんです。ここに行きたいんですけど何回も迷っちゃって。',
            'あ、ここ知ってる！すぐそこの角だよ。おいで、連れてってあげる。ついてきて。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '本当にありがとうございます。',
            '感謝しきれません。本当に助かりました。',
            'どれだけ助かったか言葉にできない。完全に迷子だったのに、今日一日を救ってくれた。',
            '気にしないで、マジで。俺も外国で迷ったことあるし。今度困ってる人見かけたらその人を助けてやって。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ちゃんとお礼がしたいです。',
            'コーヒーでもおごらせてください。',
            'わざわざ時間使ってくれたんだから、せめてランチおごらせて。お礼に。',
            '正直、笑顔見れただけで十分だよ。でもどうしてもっていうなら、帰国したら日本のお菓子送ってよ。約束な？',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "For real. That guy was gonna be late for work and he still walked us all the way there. I'll never forget that.",
        ],
        jaTranslations: [
            '親切が本当に身にしみる。',
            '人ってこんなに優しくできるんだな。心に響くわ。',
            '旅してると思い出す。世界のほとんどの人は本当に善い人で、助けたいと思ってくれてるんだよ。',
            'マジでそれ。あの人、仕事遅刻しそうだったのに最後まで案内してくれたんだぞ。一生忘れないわ。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "Ha, true. We'll be telling the 'lost passport, food poisoning, bag snatched' story for years. Best trip ever, honestly.",
        ],
        jaTranslations: [
            'トラブルがあったから記憶に残る。',
            '正直、問題があったからこそ忘れられない旅になった。',
            '何年後かに思い出すのは観光じゃない。このハチャメチャな出来事の方だよ。',
            'あはは、確かに。「パスポート紛失、食あたり、バッグひったくり」の話を何年も語るんだろうな。最高の旅だったよ、マジで。',
        ],
    ...
    },
    {
        ...
        english: [
            ...
            "I believe you. After everything we went through, we're all gonna be way more prepared next time. When's the next trip?",
        ],
        jaTranslations: [
            '次はもっとうまくやれる。',
            '次の旅行はもっと準備万端にする。',
            'いろいろあったけど、旅人としてレベルアップした気がする。',
            'そりゃそうだろ。あれだけ経験したんだから、次はみんなもっと準備するって。で、次の旅いつ？',
        ],
