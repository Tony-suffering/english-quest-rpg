...
export const MONTH5_W19_EXPRESSIONS: MasterExpression[] = [
...

    {
        ...
        jaTranslations: [
            '駅の近くで物件を探してる。',
            '駅から歩ける範囲で物件が欲しいんだよね。',
            '駅近のマンション探してるんだけど、まともなのは全部予算オーバーなんだよ。',
            'だよな、駅近はすぐ埋まるからな。一駅ずらして探してみた？家賃ガクッと下がるぞ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            ...
            '月々の家賃、どれくらいまでいける？',
            'で、家賃の上限いくら？光熱費込みの数字？',
            '正直8万がMAXかな。でも光熱費別だから、もうちょい余裕見とかないとな。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '内見って予約いる？',
            '内見って先に予約した方がいい？それともいきなり行っても大丈夫？',
            'ネットで最高の物件見つけたんだけど、内見って予約いる？飛び込みでも見れる？',
            '予約した方がいいよ。不動産屋に電話すればすぐ段取りしてくれる、だいたいその週中に見れるよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '日当たりはどう？',
            '自然光ちゃんと入る？',
            'どっち向き？日当たりいい部屋じゃないと絶対ムリなんだよね。',
            '南向きだから午後ずっと日が入るよ。窓もけっこうデカいし。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '初期費用どれくらいかかる？',
            '最初にかかるお金は？敷金とか全部込みで。',
            'テンション上がる前に聞いとくけど、初期費用いくら？前家賃と敷金で？',
            'ここは前家賃1ヶ月と敷金2ヶ月。礼金なしなんだよね、この辺じゃ珍しいよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ペット飼える？',
            'ペット可の物件ってある？',
            '小型犬いるからペット可の物件じゃないとダメなんだけど、予算内で何かある？',
            'そのマンション、実はペット可の部屋いくつかあるよ。追加の敷金払うだけで大丈夫。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '隣の音聞こえる？',
            '壁薄い？隣の音聞こえたりする？',
            '正直に教えて。壁越しに隣の音聞こえる？騒音だけは絶対ムリなんだよ。',
            'コンクリート造だからそんなに聞こえないはず。木造のやつと全然違うよ、あっちは筒抜けだから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'いつから入居できる？',
            '最短でいつから入れる？',
            '今日契約したらいつから入れる？今月中に引っ越さなきゃいけないんだけど。',
            '1日からって言ってたけど、ちょっと交渉すれば数日早く鍵もらえるかもよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'この辺って安全？',
            'この辺の治安ってどう？夜も大丈夫？',
            '正直に聞きたいんだけど、この辺の治安ってどう？特に女一人で夜歩いても平気？',
            '3年住んでるけど一回もトラブルないよ。街灯あるしコンビニも遅くまでやってるから、結構安心感あるよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '引っ越し業者頼んだ方がいい？',
            '引っ越し業者使う価値ある？それとも自力でやる？',
            'プロの業者頼むか、トラック借りて友達に手伝ってもらうか迷ってるんだよね。',
            '絶対業者頼め。金かける価値あるから。俺一回自力でやってソファ運んで腰やったわ。',
        ],
...

    {
        ...
        jaTranslations: [
            'このソファいいね。',
            'ねえ、このソファどう思う？めっちゃいい感じじゃない？',
            'ちょっとこれ見て。色もドンピシャだし座り心地よさそう。どう思う？',
            'わ、これめっちゃいい。色もいいじゃん。座って試してみなよ、決める前に！',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '部屋に合うかな？',
            'これ、うちの部屋の雰囲気に合うと思う？',
            '単体だとめっちゃ好きなんだけど、部屋のテイストに合うか微妙で。他は全部ミニマルだし。',
            'うーん、ちょっと攻めすぎかもね。落ち着いた色にしたら？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '組み立て難しい？',
            '組み立て式だよね？どれくらい大変？',
            '値段は最高なんだけど、組み立て必要って書いてある。どれくらい面倒？俺そういうの超苦手なんだけど。',
            '説明書通りにやればそんな大変じゃないよ。誰か一人呼んで二人でやれば1時間で終わる。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'カーテンの丈が足りない。',
            'このカーテン床まで届かない。もっと長いのが要る。',
            'また測り間違えた。カーテンが10センチくらい足りなくてダサいんだけど。',
            '交換できない？レシート持ってってワンサイズ上のやつにすればいいじゃん。解決。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '照明変えるだけで全然違うよ。',
            '照明変えるだけで部屋の雰囲気めちゃくちゃ変わるからね。',
            'ぶっちゃけ新しい家具買わなくていいから。照明だけ変えれば部屋の印象全然違うから。',
            'ほんとそれ。先月暖色の電球に変えたら部屋の雰囲気ガラッと変わったわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'これ返品できますか？',
            'サイズ合わなかったら返品できる？返品ルールってどうなってる？',
            'これ買いたいんだけどサイズが100%確信持てなくて。返品ポリシーってどうなってます？',
            'もちろん、レシートがあれば30日以内ならOK。元の箱だけ捨てないでね。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '収納が足りない。',
            '収納スペースがゼロ。どこに何置けばいいか分かんない。',
            'うちのマンション、クローゼットほぼなくて物を置く場所がもうない。収納なんとかしたい。',
            '縦型のシェルフ試した？床面積とらないし、めちゃくちゃ物入るよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'DIY得意？',
            '手先器用？DIYとかできる？',
            '棚つけたいんだけどやったことなくて。工具とか使える人？',
            'ドリルくらいならいけるよ。週末に棚持ってきな、つけてやるから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ここに植物を置きたい。',
            'ここに観葉植物置いたらめっちゃいい感じになると思う。',
            'このコーナーなんか寂しいんだよね。背の高い観葉植物置いたら部屋まとまりそう。',
            'モンステラとか最高じゃん。枯れにくいし、お前でも大丈夫だよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '部屋の配置を変えたい。',
            '模様替えしようかなって。気分転換したくて。',
            '1年以上同じレイアウトで飽きたんだよね。全部動かして雰囲気変えたい。',
            'やれやれ！ソファと机の位置入れ替えるだけでも全然違うからな。',
        ],
...

    {
        ...
        jaTranslations: [
            '大掃除いつやる？',
            '年末の大掃除いつやるの？',
            'もう大掃除始めた？俺いっつもギリギリまで放置して焦るんだけど。',
            '今週末からやる予定。去年30日まで先延ばしにして地獄だったから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '断捨離しなきゃ。',
            'いい加減いらないもの捨てなきゃ。',
            '何年も触ってないものだらけなんだよ。マジで断捨離しないとヤバい。',
            '俺もだわ。前の引っ越しから開けてない段ボールあるもん。2年使ってないなら捨てる。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ゴミの分別って面倒。',
            'ゴミの分別嫌い。何がどこに入るか分かんないし。',
            '分別ってちゃんとやらなきゃいけないのは分かるけど、正直ややこしすぎない？',
            'ほんとそれ。引っ越して区変わったらルール全然違くて覚え直しだよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '掃除機かけた？',
            '掃除機かけた？床ホコリっぽいんだけど。',
            '最後に掃除機かけたのいつ？ソファの下にホコリが文明築いてるんだけど。',
            'えーっと…「最近」の定義による。火曜にロボット掃除機回したけど、それカウントされる？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '風呂掃除が一番嫌い。',
            '風呂掃除だけはマジで無理。他のことなら何でもやる。',
            '家事で一番嫌いなのが水回り。カビ、水垢、全部ムリ。',
            '毎日シャワー後にシュッてやるスプレーあるじゃん。あれやるだけで汚れたまんないよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '洗濯物がたまってる。',
            '一週間ずっと洗濯さぼってたまってるわ。やんなきゃ。',
            '洗濯ずっと後回しにしてて、もうきれいなシャツ最後の一枚なんだけど。',
            '今夜寝る前に回せよ。5分でスタートできるし、朝には乾いてるから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '何がどこにあるか分からない。',
            '散らかりすぎて何も見つからない。',
            '今朝鍵探すのに20分かかった。部屋が壊滅状態。仕組み作んなきゃダメだ。',
            '全部に定位置決めろよ。まず鍵と財布から始めれば、あとは勝手についてくる。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'これまだ使う？捨てていい？',
            '最後にこれ使ったのいつ？覚えてないなら捨て時だよ。',
            'これマジで必要？「いつか使うかも」で取ってない？その「いつか」来ないから。',
            '捨てろ。半年触ってないなら要らない。考えすぎんな。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'カビが生えてきた。',
            '風呂の隅にカビ生えてきたんだけど。どうしたらいい？',
            '風呂の天井にカビ見つけたんだよね。先月はなかったのに。換気の問題かな？',
            'それたぶん換気の問題だわ。大家に電話しろ、直すのは大家の責任だから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '掃除のコツってある？',
            '何か掃除の裏技ない？俺やり方間違ってる気がする。',
            'なんでそんなきれいに保てるの？ルーティンとかあるの？それとも一気にやる派？',
            '正直、毎日10分だけやってる。カウンター拭いて床掃いて。それでたまんないんだよ。',
        ],
...

    {
        ...
        jaTranslations: [
            '隣に新しい人が引っ越してきた。',
            '隣に新しい人来たっぽい。昨日ダンボール運んでるの見た。',
            'ずっと空き部屋だった隣にやっと誰か入ったみたい。今朝引っ越しトラック来てた。',
            'おー、ずっと空いてたもんな。お菓子でも持ってって挨拶しなよ。そういうの嬉しいもんだよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '上の階の人がうるさい。',
            '上の階の足音が毎晩聞こえてマジでおかしくなりそう。',
            '上の住人、深夜にマラソン練習してんのかってくらい足音止まんないんだけど。',
            '直接言ってみた？本人がどんだけうるさいか気づいてないパターンあるから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ゴミ出しのルール知ってる？',
            '何曜日にどのゴミ出すか知ってる？',
            '引っ越してきたばっかでゴミのスケジュール全然分かんないんだけど。何曜が何？',
            '市のホームページに表あるはず。リンク送るよ、ロビーに貼ってあるやつより分かりやすいから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '回覧板って英語で何？',
            '近所の連絡が順番に回ってくるやつ、英語でどう説明する？',
            '日本って各家庭にお知らせが順番に回ってくる仕組みがあるんだけど、そっちにもそういうのある？',
            'アメリカにはないなー。近いのは地域のニュースレターだけど、家を順番に回すとかはしないね。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '町内会の集まりがあるらしい。',
            '町内会の集まりがあるんだって。行く？',
            '今週末に町内会の集まりがあるってお知らせ来たんだけど。行かなきゃダメ？',
            '一回くらい顔出しとけよ。顔覚えてもらえるし、だいたい1時間で終わるから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '挨拶くらいはするよね。',
            '会ったら挨拶くらいはするよ。基本だろ。',
            '隣の人とそんなに親しくなくても、すれ違ったら会釈くらいするべきだよね。',
            'だよな。軽く頭下げるか「おはようございます」の一言で全然印象違うからな。タダだし。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '宅配便が来る時間に家にいない。',
            '日中いつも家にいないから宅配便受け取れないんだよね。',
            '今週3回配達来て全部不在だったわ。再配達頼まなきゃ。',
            '宅配ロッカーに届けてもらえばいいじゃん。ドライバーと電話の追いかけっこするよりよっぽど楽だよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'この辺に美味しい店ある？',
            'この辺で美味しい店知ってる？',
            'まだこの辺よく知らないんだよね。行くべき店ある？穴場とか。',
            '2ブロック東に小さいカレー屋あるんだけど、看板ないけどランチセットが最高で800円。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '防災訓練ってやってる？',
            'マンションで防災訓練ってある？地震とか火事の。',
            'マンションの防災訓練があるって通知来たんだけど、参加したことある？',
            '去年行ったよ。非常口の場所知っとくだけでも一回行く価値あるよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '騒音の苦情ってどう言えばいい？',
            '騒音の苦情って直接言った方がいい？どうするのがベスト？',
            '隣の人が毎週末深夜に音楽かけるんだけど、直接言うべき？先に大家に言うべき？',
            '先に大家に言えよ。マンション全体への注意として出してもらえるから、個人的なもめ事にならないし。',
        ],
...

    {
        ...
        jaTranslations: [
            'うちの犬が太ってきた。',
            'うちの犬ちょっとぽっちゃりしてきた。あげすぎかも。',
            '先週獣医に連れてったら「あと2キロ痩せろ」って言われて。ダメ飼い主だわ。',
            'あー、かわいそうに。おやつの代わりに散歩増やしたら？構ってもらえるだけで喜ぶよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '猫派？犬派？',
            'で、猫派と犬派どっち？「両方」はナシで。',
            'ずっと気になってたんだけど、犬派？猫派？結構その人の性格出るよね。',
            '猫一択。手かかんないし、朝6時に雨の中散歩しなくていいし。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '散歩中に他の犬に吠える。',
            '散歩のたびにすれ違う犬全部に吠えるんだよね。',
            '散歩がストレスすぎる。他の犬見るたびに狂ったように吠えて止まんないの。',
            'トレーナーに相談した？友達の犬も同じだったけど、何回か通ったらかなり落ち着いたよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ペットって飼い主に似るよね。',
            'ペットってだんだん飼い主に似てくるって言うじゃん。あれマジだと思う。',
            '犬ってしばらく一緒にいると飼い主に似てこない？あれ面白すぎるんだけど。',
            'ほんとそれ。同僚とそいつのプードル、髪型完全に一緒なの。もう見るたび笑う。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '動物病院って高い。',
            '動物病院マジで高い。自分の病院代より高いんだけど。',
            '猫を定期検診に連れてったら自分の医療費の自己負担より高かったわ。ペットの医療費シャレにならん。',
            'ペット保険調べてみなよ。月3000円くらいで大きいのはだいたいカバーされるから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '一人にさせるの申し訳ない。',
            '仕事行くとき犬を一人にするのいつも罪悪感あるんだよね。',
            '出勤するたびに犬が「永遠に捨てられる」みたいな目で見てくるんだよ。罪悪感ハンパない。',
            'ペットカメラ買えよ。日中見たらずっと寝てるから。それ見たら気が楽になるって。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'うちの猫、夜中に暴れる。',
            'うちの猫、毎晩3時に部屋中走り回るんだけど。',
            '毎晩3時くらいに急にスイッチ入って、何かに追われてるみたいに全力で走り回るの。',
            'それズーミーズってやつだよ！寝る前にもっと遊んであげたらエネルギー消費するかも。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ペットショップで買うのってどうなの？',
            'ペットショップで買うのってアリだと思う？それとも保護施設から引き取るべき？',
            'ペットショップで買うか保護施設から引き取るかって結構議論あるじゃん。どう思う？',
            '正直、俺は引き取る派だな。保護施設にいい子いっぱいいるのに、チャンスもらえてないだけだから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'うちの子、芸を覚えた。',
            'やっと犬にお手を教えた。3ヶ月かかったけど。',
            '何週間もトレーニングして、やっとゴロンできるようになった。嬉しすぎて泣きそう。',
            'マジで！すごいじゃん！どれくらいかかった？うちの「待て」教えてんだけどすぐどっか行くんだよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'いつか犬を飼いたい。',
            'ずっと犬飼いたいんだけど、マンションがペット不可で。',
            'もっと広いとこに引っ越したら、まず犬飼う。ずっと夢だったんだよ。',
            'お前いい飼い主になるよ。引っ越す時教えて、保護犬探すの手伝うから。',
        ],
...

    {
        ...
        jaTranslations: [
            '今月もう金ない。',
            '今月もう金なくなった。使いすぎた。',
            'まだ月の半分なのにもう完全に金欠。マジで金の使い方見直さないと。',
            'もう？まだ15日だぞ！何に使ったの？当てようか、またコンビニだろ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '自炊した方が安い。',
            '外食って高いよね。もっと自炊しなきゃ。',
            '毎日コンビニ飯やめて自炊すればめちゃくちゃ節約できるのに。',
            '日曜に作り置きしてみろよ。カレーかシチュー大量に作れば一週間いけるから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'ポイントカード使ってる？',
            'ポイントちゃんと使ってる？俺いつも忘れるんだけど。',
            '今気づいたけどポイントカードに1万ポイントたまってて全然使ってなかった。もったいなすぎ。',
            '使えよ！それタダ金が寝てるのと同じだぞ。俺は1000ポイントたまるたびに使ってる。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '固定費を見直した方がいい。',
            '月額のサブスク最近チェックした？使ってないのに払ってるやつない？',
            '一番手っ取り早い節約は固定費削ること。スマホのプラン、サブスク、保険。全部見直せ。',
            '確かに。今チェックしたら何ヶ月も開いてないサブスク2つに金払い続けてたわ。今すぐ解約する。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '衝動買いがやめられない。',
            'いつも衝動買いして次の日後悔する。',
            '夜中にショッピングアプリ開くと、絶対いらないもの買っちゃうんだよね。',
            'アプリ消せ。マジで。わざわざサイトにアクセスしなきゃいけないなら、一回考え直すから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '給料日まであと何日？',
            '給料日いつ？マジで指折り数えてるんだけど。',
            '今調べたら給料日まであと10日。それまでどうやって生きていけばいいんだ。',
            '俺もだわ、あと8日で米と卵で食いつないでる。耐えろ、なんとかなる。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'セールの時しか買わない。',
            '定価で買わない主義。絶対セールまで待つ。',
            '俺のルールは定価では絶対買わないこと。セールじゃなきゃそこまで必要ないってこと。',
            'それすごい自制心だな。俺もいつも待つって言うけど、2日で折れるんだよ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'コンビニって便利だけど高い。',
            'コンビニ好きだけど、スーパーより全部高いんだよね。',
            'コンビニの問題は便利すぎること。毎日行っちゃって予定より金使うんだよ。',
            'わかるー。俺コンビニの前通らないルートに変えたら出費一気に減ったわ。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '家計簿つけてる？',
            '支出管理してる？アプリとか使ってる？',
            '先月から家計簿アプリ使い始めたんだけど、金がどこに消えてるか見えて正直怖い。',
            '俺もアプリ入れたけど、数字が辛すぎて見なくなった。もう一回やってみようかな。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '安いものには理由がある。',
            '安すぎるものにはだいたい理由があるよ。',
            '安物買いの銭失いって身をもって学んだわ。安いやつはすぐ壊れるか品質悪いかだよ。',
            'ほんとそれ。安いブーツ2回買い直して、やっとちゃんとしたの奮発したら3年持ってる。',
        ],
...

    {
        ...
        jaTranslations: [
            '朝何時に起きてる？',
            'いつも朝何時に起きる？',
            '気になるんだけど、目覚まし何時？朝型？それともスヌーズ10回押す派？',
            '7時くらい。でも正直コーヒー2杯目まで完全には起きてない。つまり…9時？',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '朝ごはんは食べる？',
            '朝ごはんちゃんと食べてる？それともコーヒーだけ？',
            '朝ごはんが一番大事って言うけど正直時間ないんだよね。毎朝食べてる？',
            'バナナとコーヒーだけ持って出る。大したことないけど、完全に抜くと昼まで使い物にならない。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '通勤時間どれくらい？',
            '職場まで何分くらいかかる？',
            '通勤片道1時間なんだよね。毎日電車で時間無駄にしてる感がすごい。',
            '1時間？きついな。でも本読んだりポッドキャスト聴けるじゃん。ぼーっと窓の外見てたら俺なら発狂する。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '夜型だから朝がつらい。',
            '毎晩夜更かしするから、朝起きるのが拷問なんだよね。',
            '完全に夜型人間で、脳みそが動き出すの昼過ぎなんだよ。朝はサバイバルモード。',
            '分かる。俺もできるだけ午前中に大事な予定入れない。脳がまだ来てないから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '寝る前にスマホ見ちゃう。',
            'ダメだと分かってるのに、ベッドでスマホいじっちゃうんだよね。',
            '毎晩「11時にはスマホ置く」って決めるのに毎晩失敗して1時までスクロールしてる。',
            'スマホを別の部屋に置いてみろ。最初の一週間は地獄だけど、めちゃくちゃよく眠れるようになるから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '休みの日こそ早起きする。',
            '休みの日に早起きする方が好き。やれること増えるから。',
            '変人って言われるけど、土曜も目覚ましかける。寝坊したら一日無駄にした気分になるんだよ。',
            'それできる人羨ましいわ。毎回やろうとするけど結局ベッドでスマホいじって昼になってる。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '運動する習慣がつかない。',
            '運動しようとするけど絶対続かない。',
            'ジム何回入って何回やめたか分かんない。会員証はもはや寄付だよ。',
            'まず小さいことから始めろよ、20分の散歩とか。最初からハードル高いと絶対続かないから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            'お風呂の時間が最高。',
            '一日の終わりに湯船に浸かるのが一番好き。',
            '一日の終わりに長風呂するのに勝るものはない。マジでリラックスできるの、あの時間だけ。',
            '羨ましいわ。うちシャワーしかなくて。ちゃんとした湯船がマジで恋しい。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '毎日同じことの繰り返し。',
            '毎日同じことの繰り返しって感じ。起きて、仕事して、食べて、寝て、また同じ。',
            '自分の人生って永遠のループなのかなって時々思う。同じ電車、同じ机、同じ昼飯、全部同じ。',
            'だから趣味とか何か作って変化つけろって。週に一個新しいことするだけで全然違うから。',
        ],
    ...
    },
    {
        ...
        jaTranslations: [
            '夜更かしがやめられない。',
            '早く寝なきゃって分かってるのに毎晩深夜まで起きちゃう。',
            '毎晩「今日こそ11時に寝る」って誓うのに、1時になっても全然眠くなくて何の生産性もないことしてる。',
            'それ「報復性夜更かし」って名前あるらしいよ。名前知ったところでやめられないけどな。',
        ],
