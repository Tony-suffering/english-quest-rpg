        ...
        items: [
            {
                ...
                points: {
                    ...
                    native: { en: "Can you pi-ki-tup for me on your way home?", ja: '頼み事の定型。3単語が1つの音の流れで出る。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "I'll have u-NAP-pul juice, please.", ja: 'カフェの定型。an + 母音始まり名詞の鉄板。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Can you tur-NOFF the TV? I'm tryna sleep.", ja: '家庭内の日常定型。句動詞がスムーズに出せると会話の速度が上がる。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Just go-WON, don't stop now.", ja: '励ましの定型。go on が go-WON で1つの流れ。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "See you thi-SEEV-ning.", ja: '別れ際の定型。連結なしだと「this _ evening」と不自然に間が空く。' },
                },
        ...
        items: [
            {
                ...
                points: {
                    ...
                    native: { en: "If I were you, I'd just walk away.", ja: 'アドバイスの定型。were + would で距離感を出す。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "I wish I could speak French.", ja: '憧れの定型。現在話せないから could。時制は現実からの距離で選ぶ。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "If I had time, I'd totally go with you.", ja: '誘いを断る時の定型。相手を傷つけない丁寧な断り方。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "What would you do? -- I'd probably call a friend.", ja: '仮定の質問に対する定型返答。would で仮定空間を保つ。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "She looks at me as if she didn't know me.", ja: '「知らない顔する」含意の定型。実際は知っている人の演技。' },
                },
