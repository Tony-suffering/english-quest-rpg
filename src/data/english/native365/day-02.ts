        ...
        items: [
            {
                ...
                points: {
                    ...
                    native: { en: "I'll pre-SENT the PRE-sent after dinner.", ja: '同じ綴りでも山が2回違う位置に来る。ネイティブは迷わず切り替える。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "I'll re-CORD this and save it to the record.", ja: '1文に両方入れてリズムを感じさせるのが効く練習。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "I have to ob-JECT -- this OB-ject shouldn't be here.", ja: '同語で品詞2つ、1文で練習すると山の移動が体に入る。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Sales will in-CREASE by 10% -- that's a significant IN-crease.", ja: 'レポートの定型。1文に両方入ると山の違いが際立つ。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "The workers re-FUSE to pick up the REF-use.", ja: '発音練習によく出る定番文。1文に2品詞が並ぶ。' },
                },
        ...
        items: [
            {
                ...
                points: {
                    ...
                    native: { en: "Doorbell rings. -- I'll get it!", ja: "家庭内の定型。瞬間的な決定は常に will + 短縮 'll で出る。" },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "I'm gonna visit my parents this weekend.", ja: '週末の予定を話す時の鉄板。gonna (going to の縮約) も一緒に覚える。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "What are you doing tomorrow? -- I'm having dinner with Sara.", ja: '週末予定を聞かれた時の王道返答。be -ing が確定のサイン。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Careful -- you're going to fall.", ja: '相手が危なっかしい動きをしている時の定型。証拠 (目の前の状況) があるから going to。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "My flight leaves at 9 tomorrow -- I should get going.", ja: '飛行機・電車・映画など時刻表がある未来の定型。' },
                },
