        ...
        items: [
            {
                ...
                points: {
                    ...
                    native: { en: "Well, that's one way to put it, I guess -- I would've probably said it a little differently myself, but yeah.", ja: 'まあ、そういう言い方もあるかもね。俺ならちょっと違う言い方するかもだけど、うん。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Honestly, she hasn't been well lately -- might be worth giving her a quick call, just to check in on her.", ja: '正直、彼女最近調子良くないみたいだから、ちょっと電話してあげるといいかも、様子見で。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Well then, that settles it -- let's just go with option A and stop going back and forth on this whole thing.", ja: 'じゃもう決まりだ。Aで行こう、これ以上迷ってても時間の無駄。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Hi, I'll have the grilled fish, and could I get a side salad as well, please? No croutons though, if that's okay.", ja: 'グリルフィッシュと、あとサイドサラダもいただけますか? クルトンは抜きでお願いします。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Didn't get the job. Oh well, on to the next one -- guess it just wasn't meant to be this time.", ja: '仕事ダメだった。まあ次行こう、今回は縁がなかったってことかな。' },
                },
        ...
        items: [
            {
                ...
                points: {
                    ...
                    native: { en: "Wow, it's such a beautiful day out there, isn't it? Literally perfect weather for a long walk in the park.", ja: 'やば、今日マジでいい天気だね? 公園でゆっくり散歩するのに最高の天気じゃん。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "You know what I mean, don't you? I shouldn't have to spell this whole thing out for you, come on.", ja: '分かってるよね? 全部最初から説明しなきゃダメってことじゃないよね、まさか。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Come on, we can absolutely pull this off, can't we? We've literally done way harder things than this before.", ja: 'おい、これぐらい絶対いけるだろ? もっとキツいこと乗り越えてきたんだし、俺たち。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Hey, could you pass me the salt, would you? Thanks, you're a total lifesaver.", ja: 'ちょっと、塩取ってくれる? ありがと、マジで助かった。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "You got my email this morning, didn't you? I sent it literally first thing before I even had my coffee.", ja: '朝のメール届いてるよね? マジでコーヒー飲む前に真っ先に送ったんだけど。' },
                },
