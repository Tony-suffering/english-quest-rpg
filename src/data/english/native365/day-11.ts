        ...
        items: [
            {
                ...
                points: {
                    ...
                    native: { en: "Honestly, she's the kind of girl who makes you wanna be a better person -- you know what I mean?", ja: '正直、一緒にいるともっと良い自分になろうって思える、そういうタイプなんだよ、分かる?' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Dude, it's literally a small world -- turns out her older brother actually works with my cousin up in Tokyo.", ja: 'おい、マジで世間狭いって。彼女の兄ちゃん、東京でうちの従兄弟と働いてるらしい。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Hey, just give me like five more minutes -- I'm almost done with this email, I swear.", ja: 'ちょっと、あと5分だけちょうだい。このメール書き終わるとこだから、マジで。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Honestly, good people are hard to find these days -- don't let that one slip away, seriously.", ja: '正直、こんな時代にいい人ってほんと見つからない。あの子は逃しちゃダメだって、マジで。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "I'm literally such an early bird -- I'm usually up and running around before the sun even comes up.", ja: '俺マジで超朝型で、日の出前にはもう起きて動いてる。' },
                },
        ...
        items: [
            {
                ...
                points: {
                    ...
                    native: { en: "Yo, he's the guy I was telling you about -- the one who owns that little bakery on Third Street.", ja: 'あ、あれが前話したやつ。3番街のあの小さいパン屋のオーナーの。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Hey, this is that book I was telling you about last week -- you're gonna love it, trust me on this one.", ja: 'これ、先週話してたあの本。絶対気に入るから、今回は信じて。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "So my brother, who lives down in Osaka, is actually coming up for my wedding next weekend -- first time we'll see each other in over a year.", ja: 'で、大阪にいる兄貴が来週末の結婚式に来るんだ。1年以上ぶりに会うわ。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Hey, see the guy sitting at the bar in the blue shirt? That's actually my younger brother, believe it or not.", ja: 'あそこ、バーに座ってる青いシャツの男見える? あれ俺の弟、信じられないだろうけど。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "So I have this friend whose dad's a doctor -- he might actually be able to help you out with this whole situation.", ja: 'あ、親父が医者の友達いるから、今の状況でマジで力になれるかも。' },
                },
