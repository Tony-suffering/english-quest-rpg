        ...
        items: [
            {
                ...
                points: {
                    ...
                    native: { en: "Dude, I'm literally gonna crash the second I get home -- what a day, I can barely keep my eyes open.", ja: 'あー、帰ったら即寝る、マジで。なんて一日だよ、もう目が開いてられない。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Hey, you wanna grab a drink after work? My treat -- I got some news I wanna run by you.", ja: 'ちょっと、仕事終わったら一杯どう? おごるから、ちょっと話聞いてほしいことあって。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Crap, I hafta run -- I think I left the stove on. I'll text you as soon as I know the house isn't on fire.", ja: 'やべ、急いで帰る、コンロ消し忘れたかも。家燃えてないか確認したらすぐ連絡する。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Hey I gotta jump on this call real quick -- can we catch up in like an hour? Sorry for the bail.", ja: 'ごめん、この電話ちょっと出なきゃ。1時間後くらいに話せる? 急に抜けてごめん。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Honestly I used to hate this song when it first came out, but now I catch myself humming it in the shower every morning.", ja: '正直、この曲出た時は嫌いだったのに、今じゃ毎朝シャワーで口ずさんじゃってる。' },
                },
        ...
        items: [
            {
                ...
                points: {
                    ...
                    native: { en: "I really enjoyed catching up with you today -- let's seriously not leave it this long next time, like actually put it in the calendar.", ja: '今日話せて本当に楽しかった。次はマジでこんなに間空けないようにしよ、ちゃんとカレンダーに入れとこう。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Hey, I want to swing by and see you before you head out tomorrow -- are you free around 4 or is that too tight?", ja: 'ちょっと、明日出発する前に顔見に寄りたいんだけど、4時ごろ空いてる? 時間的に厳しい?' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Okay, try turning it off and on again first -- honestly that fixes it like nine times out of ten, I swear to god.", ja: 'じゃとりあえず一回電源切って入れ直してみて。マジで10回中9回はそれで直るから。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "I actually stopped drinking last year, and honestly I haven't missed it at all -- sleep is so much better now.", ja: '去年酒やめたんだけど、正直全然恋しくない。むしろ睡眠の質が全然違う。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Hey, remember to text me the second you land, okay? I always worry if I don't hear from you for a few hours.", ja: 'ちょっと、着いたら即連絡してよ。数時間連絡ないと絶対心配になるから。' },
                },
