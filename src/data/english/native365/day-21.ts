        ...
        items: [
            {
                ...
                points: {
                    ...
                    native: { en: "Hey, I wanna grab a drink after work today -- you wanna join me or you got plans already?", ja: 'ちょっと、今日仕事終わったら一杯行きたいんだけど、一緒にどう? もう予定ある?' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Dude, that's literally exactly what I needed to hear right now -- seriously, thank you for saying that.", ja: 'おい、マジで今それを聞きたかったんだよ、本当にありがとう、そう言ってくれて。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "That's exactly what I meant, yeah -- I'm so glad we're finally on the same page about this whole thing.", ja: 'まさにそういうこと、そう。やっと話が噛み合ったね、この件で。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Honestly, it is what it is at this point -- no point in overthinking it anymore, let's just move on.", ja: '正直もう、なるようにしかならない。これ以上考え込んでもしょうがない、次行こう。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Hey, I want what that guy at the next table is having -- can you call the waiter over real quick?", ja: 'ちょっと、隣のテーブルの男が食べてるのと同じのがいい。ウェイター呼んでくれる?' },
                },
        ...
        items: [
            {
                ...
                points: {
                    ...
                    native: { en: "Honestly, it's really tough to say no to her once she's made up her mind -- you know exactly how she gets.", ja: '正直、彼女が決めたらノーって言うのは本当に難しいんだよ。あの子のこと分かるよな。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Look, it's really important that we're all on the same page before Monday's client call -- no surprises, please, not this time.", ja: 'あのさ、月曜のクライアント会議前に全員の認識揃えるの、マジで大事だから。想定外なしで頼む、今回は。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Honestly, it takes years to really get good at anything worthwhile -- there are literally no shortcuts, no matter what anyone tells you.", ja: '正直、何か意味のあるものをちゃんとうまくなるには何年もかかる。誰が何と言おうと、マジで近道はない。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "It seems like he really doesn't wanna talk about it tonight -- let's just drop it for now and circle back later.", ja: '今夜その話したくなさそうだね。とりあえず置いといて、また後で戻ろう。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Honestly, it's no use asking him for a loan -- he literally never lends money to anyone, not even family.", ja: '正直、あいつに金借りようとしても無駄。マジで誰にも貸さないから、家族にすら。' },
                },
