        ...
        items: [
            {
                ...
                points: {
                    ...
                    native: { en: "Hey, I'm about to head out -- mind grabbing the door for me? My hands are totally full.", ja: 'ちょっと、もう出るとこなんだけど、ドア押さえてくれる? 両手ふさがっちゃってて。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Okay, today's the day. If we don't ship this thing by tonight, I'm seriously gonna lose my mind.", ja: 'よし、今日こそ出す。夜までに出せなかったら、マジで気が狂う。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Could I get a banana muffin and a large oat milk latte to go? Actually, make it two -- I'm grabbing one for a friend.", ja: 'バナナマフィンとオーツミルクラテのラージ、持ち帰りで。あ、やっぱり2つお願い、友達の分も。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Dude, I could've sworn I left my keys on the kitchen counter like two minutes ago. Where the hell did they go?", ja: 'マジで2分前にキッチンのカウンターに鍵置いた気がするのに。どこ行った?' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "I'm gonna grab a coffee before the meeting starts -- you wanna come with me or should I get you one?", ja: '会議前にコーヒー取ってくる。一緒に行く? それとも買ってこようか?' },
                },
        ...
        items: [
            {
                ...
                points: {
                    ...
                    native: { en: "Okay so I've literally lost my keys again. I had them like five seconds ago, I swear to god -- have you seen them?", ja: 'ちょっと、また鍵なくしたんだけど。マジで5秒前まで持ってたよ誓って。見てない?' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Honestly, I've lived in Tokyo my whole life, so if you ever want a proper tour, just hit me up -- I know all the good spots.", ja: '正直、東京は生まれてからずっとだから、ちゃんと案内して欲しかったら連絡して。いい場所は全部知ってる。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Wait, have you seen the news about the earthquake? It's literally all my feed has been since this morning.", ja: 'ちょっと、地震のニュース見た? 今朝からマジでフィードそればっかりなんだけど。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "So wait, when did you two actually meet? 'Cause you guys act like you've known each other since kindergarten.", ja: 'ちょっと待って、お前ら実際いつ出会ったの? 幼稚園からの付き合いみたいなノリじゃん。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Okay I just wrapped up that call -- please tell me nothing insane happened while I was gone.", ja: 'やっと電話終わった。俺がいない間にヤバいこと起きてないよね?' },
                },
