        ...
        items: [
            {
                ...
                points: {
                    ...
                    native: { en: "Look, I can totally do it, but I honestly can't promise it'll be done by Friday -- things are kinda crazy this week.", ja: 'あのさ、やるのは全然いいんだけど、正直金曜までに終わるかは約束できない。今週ちょっと立て込んでて。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Okay, just meet me at the café at seven -- I'll grab us a table by the window if I get there first.", ja: 'じゃ7時にあのカフェで。先に着いたら窓際の席取っとくわ。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Hey, seriously, thanks for coming all the way out here tonight -- it genuinely means so much to me.", ja: 'ちょっと、マジで今夜こんな遠いとこまで来てくれてありがとう。本当に嬉しい。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "I just ran to the store real quick and grabbed some milk and eggs on the way home -- we were out of literally everything.", ja: 'さっきちょっとコンビニ寄って、帰りに牛乳と卵買ってきた。全部マジで切らしてたから。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Honestly, I should've told you sooner -- I'm really sorry I kept you waiting all week on this.", ja: '正直、もっと早く言えばよかった。この1週間待たせちゃって本当にごめん。' },
                },
        ...
        items: [
            {
                ...
                points: {
                    ...
                    native: { en: "I used to smoke like a pack a day back in my twenties, but I quit the exact day my daughter was born -- haven't touched one since.", ja: '20代の頃は一日一箱吸ってたけど、娘が生まれた日にきっぱりやめた。それ以来一本も吸ってない。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "I used to live in Kyoto back in my twenties -- honestly, those were the best years of my entire life, no contest.", ja: '20代で京都に住んでたんだけど、正直あれが人生最高の時期だった、間違いなく。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Every summer growing up, my grandpa would take us fishing at this tiny lake before the sun even came up -- I still remember it so clearly.", ja: '夏休みは毎年、じいちゃんが日の出前からあの小さな湖へ釣り連れてってくれた。今も鮮明に覚えてる。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Dude, I never used to like sushi at all growing up, but now honestly I can't get enough of it -- what happened to me?", ja: 'おい、俺昔は寿司全然無理だったのに、今じゃマジでハマりすぎ。俺どうしちゃったの。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Wait, didn't you use to play guitar in a band back in college? I swear I caught one of your gigs at that bar downtown.", ja: 'ちょっと待って、お前大学の時バンドでギター弾いてなかった? ダウンタウンのあのバーでライブ見た記憶あるんだけど。' },
                },
