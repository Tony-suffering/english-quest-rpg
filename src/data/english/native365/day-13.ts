        ...
        items: [
            {
                ...
                points: {
                    ...
                    native: { en: "This seat is taken. / Sit down, please.", ja: '口の形が違えば音が違う。長さで誤魔化さない。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "I bought it but I don't like it.", ja: 'bought と but を1文に入れて口の形の切り替えを練習。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "My father came home. -- /ɑː/ then /ʌ/ then /eɪ/.", ja: '1文に3つの「ア系」母音が並ぶ。それぞれ別音。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "I got a bad haircut. -- /æ/ and /ʌ/ both in one phrase.", ja: 'bad /æ/ と cut /ʌ/ を隣接させると口の形の切り替えが練習できる。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "I pulled her out of the pool.", ja: '1文で pull と pool の両方を練習。口の緊張度で区別。' },
                },
        ...
        items: [
            {
                ...
                points: {
                    ...
                    native: { en: "If I'd left earlier, I wouldn't have missed the flight.", ja: '肯定・否定を自由に組み合わせる。型は1つ。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "I could've been a contender.", ja: '映画の名台詞。「俺はなれたはずだった」の後悔の定型。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "I shoulda called you back.", ja: 'shoulda は should have の音声縮約。日常会話の標準形。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "If I'd studied English earlier, I'd be fluent by now.", ja: '過去の行動と現在の状態をつなぐ。年齢を重ねるごとに使う頻度が上がる後悔型。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Had I known you were coming, I'd have baked a cake.", ja: '歌詞にもなっているフレーズ。フォーマルだが暖かみのある定型。' },
                },
