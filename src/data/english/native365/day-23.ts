        ...
        items: [
            {
                ...
                points: {
                    ...
                    native: { en: "Dude, this ramen is literally sooo good -- I'm seriously coming back tomorrow, and probably the day after too.", ja: 'おい、このラーメンマジで美味すぎ。絶対明日また来る、あさってもかも。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "It was absolutely pouring outside last night, so we honestly just ended up staying in and ordering pizza -- zero regrets.", ja: '昨日の夜土砂降りだったから、結局家でピザ頼んで過ごしたんだけど、正直全然後悔してない。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Okay so here's what I'm thinking -- tell me honestly if this sounds totally crazy or if it actually makes sense.", ja: 'じゃあさ、俺こう思うんだけど、正直に言ってくれ、これマジでおかしいかちゃんと筋通ってるか。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Dude, he talks so fast I literally can't keep up -- can you just ask him to slow down a little bit, please?", ja: 'おい、あの人早口すぎてマジでついていけない、ちょっとペース落としてもらえない? 頼む。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Honestly, the movie was so-so at best -- I'd just wait for streaming, it's really not worth the theater price.", ja: '正直、映画はまあまあってとこ。配信待ちで十分、映画館の値段払うほどじゃない。' },
                },
        ...
        items: [
            {
                ...
                points: {
                    ...
                    native: { en: "Dude, it was Tom who actually told her, not me -- I swear to god I had nothing to do with any of this whole mess.", ja: 'おい、彼女に話したのトムで、俺じゃないから。マジで俺このゴタゴタに何も関わってない、誓って。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Honestly, it's the thought that counts -- the gift itself doesn't really matter, it's the fact that you remembered.", ja: '正直、大事なのは気持ちだから。プレゼント自体はどうでもよくて、覚えててくれたってことが。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Honestly, it wasn't until yesterday that I truly realized how much she actually meant to me -- and now it's too late.", ja: '正直、昨日やっと彼女が自分にとってどれだけ大切か気づいた。でももう遅い。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "It was actually in Kyoto that we first met -- ten years ago this spring, at this tiny little coffee shop downtown.", ja: '俺たち、最初に出会ったのは京都なんだ。今年の春でちょうど10年、小さなコーヒー屋で。' },
                },
            ...
            },
            {
                ...
                points: {
                    ...
                    native: { en: "Honestly, it's you I'm worried about, not the money -- I can always earn more money, but there's only one of you.", ja: '正直、心配してるのはお前で、金じゃない。金はまた稼げるけど、お前の代わりはいないから。' },
                },
