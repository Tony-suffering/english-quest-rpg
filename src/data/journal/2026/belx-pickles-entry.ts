...
export const belxPicklesEntry: JournalEntry = {
    ...
    featured: true,
    readTime: 10,
    businessTags: ['食', '観察', 'コスパ', '地域密着'],
    techTags: ['発酵', '乳酸菌', '浸透圧', '微生物'],
    heroImage: 'https://imagedelivery.net/k1Zw56y2FNiZaFcOP7Rs2Q/9db58cf3-eb08-4343-33a8-45885d47c800/public',
    englishSummary: {
        title: "Why 78-Yen Pickles Taste This Good -- A Deep Dive into Fermentation and a Supermarket Called Belx",
        readTime: 8,
        sections: [
            {
                heading: "The Holy Land of Belx",
                paragraphs: [
                    "OK so there's this supermarket in Adachi Ward, Tokyo, called Belx. And it's ridiculously cheap. Like, featured-on-TV cheap.",
                    "They restock the deli section all day -- not just mornings. Yakitori is 108 yen per skewer, domestic chicken, buffet style. And unlike Costco, you don't need to buy enough for a family of twelve.",
                    "One-person-household friendly. This place is a godsend."
                ]
            },
            {
                heading: "The Pickle Question",
                paragraphs: [
                    "So I bought some nukazuke -- rice bran pickles -- from the deli. Daikon, carrot, cucumber. Just plain vegetables.",
                    "But they're sour, salty, complex, and weirdly addictive. And I'm like... why? They're literally just vegetables that sat in some rice bran. What's goin' on?"
                ]
            },
            {
                heading: "Osmotic Pressure is Basically Alchemy",
                paragraphs: [
                    "Turns out the salt concentration in the nuka bed is way higher than in the veggies. So osmotic pressure kicks in -- moisture gets pulled outta the vegetables, and umami compounds from the bran seep in.",
                    "Plain daikon goes in, delicious daikon comes out. It's not magic. It's physics. But honestly? It feels like magic."
                ]
            },
            {
                heading: "100 Million Bacteria Doin' Their Thing",
                paragraphs: [
                    "The nuka bed is crawlin' with lactobacilli. Plus yeast, plus butyric acid bacteria. These little guys eat the sugars in rice bran and pump out lactic acid.",
                    "That's where the sourness comes from. And the acid kills off harmful bacteria. So the good bacteria are literally protecting the flavor by murdering the competition. It's an ecosystem."
                ]
            },
            {
                heading: "The Umami Factory",
                paragraphs: [
                    "During fermentation, Bacillus bacteria break down proteins into amino acids. Glutamic acid -- that's your umami -- just skyrockets.",
                    "Microorganisms are doin' the cookin'. Not humans. Bacteria. We're just... watchin'."
                ]
            },
            {
                heading: "Veggies on Steroids",
                paragraphs: [
                    "Here's the crazy part. Vitamin B1 in nukazuke cucumber is 5 to 10 times higher than raw cucumber. The rice bran is packed with B vitamins, and they literally soak into the veggies through fermentation.",
                    "It's like the Hyperbolic Time Chamber from Dragon Ball. Vegetables go in weak, come out jacked."
                ]
            },
            {
                heading: "Three Worlds in One Pot",
                paragraphs: [
                    "The nuka bed actually has three distinct layers. Yeast on top -- they love oxygen, make nice aromas, but too many and you get paint thinner smell. Lactobacilli in the middle -- the MVPs, makin' the sour and umami magic happen. Butyric bacteria on the bottom -- good for your gut, but let 'em get outta control and things get stinky.",
                    "Balance is everything. That's why you gotta mix it every day."
                ]
            },
            {
                heading: "Cost Performance Violence",
                paragraphs: [
                    "And Belx sells this for 78 yen. Seventy-eight yen! That's like 50 cents.",
                    "I bought two. Obviously. When it's this cheap and this good, you just... buy two."
                ]
            },
            {
                heading: "The Dumbest Use of AI",
                paragraphs: [
                    "Oh, and I used a genius AI to analyze a photo of my 78-yen pickles. It identified everything perfectly -- the Shinkansen table, the nuka pack, the chopsticks, the water bottle.",
                    "Then I had it write a full scientific breakdown of lactobacilli ecosystems, osmotic pressure physics, and vitamin B1 absorption mechanisms. All for pickles.",
                    "This might be the most meaningless use of artificial intelligence in human history. And honestly? It was the most fun I've had all week."
                ]
            }
        ]
    },
...
![AIが写真解析してる様子](https://imagedelivery.net/k1Zw56y2FNiZaFcOP7Rs2Q/9db58cf3-eb08-4343-33a8-45885d47c800/public)
