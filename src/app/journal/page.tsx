...
import RandomWisdom from '@/components/journal/RandomWisdom'

// 動画サムネイルコンポーネント（ホバーで再生）
function VideoThumbnail({
  ...
  return (
    ...
    >
      ...
      {isHovering && (
        <iframe
          src={`https://customer-g3tngdysgdne3fza.cloudflarestream.com/${videoId}/iframe?muted=true&autoplay=true&loop=true&controls=false&preload=auto`}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap gap-3 mb-6">
            <button
              ...
              className={`px-4 py-2 font-semibold transition-all ${selectedCategory === 'all' && !selectedTag
            ...
            <button
              ...
              className={`px-4 py-2 font-semibold transition-all ${selectedCategory === 'featured' && !selectedTag
            ...
            <button
              ...
              className={`px-4 py-2 font-semibold transition-all ${selectedCategory === 'business' && !selectedTag
                  ? 'bg-[#10B981] text-white'
                  : 'bg-white text-slate-700 border border-slate-300 hover:border-[#10B981]'
                }`}
            >
            ...
            <button
              ...
              className={`px-4 py-2 font-semibold transition-all ${selectedCategory === 'tech' && !selectedTag
              ...
              <div className="flex flex-wrap gap-2">
                {allBusinessTags.map(tag => (
                  <button
                    ...
                    className={`px-3 py-1 text-sm transition-all ${selectedTag === tag
                        ? 'bg-[#10B981] text-white'
