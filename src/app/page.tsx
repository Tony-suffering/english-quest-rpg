            ...
            <section className="min-h-[80vh] flex flex-col justify-center px-6 sm:px-12 lg:px-24 py-24 relative">
                ...
                <motion.div initial="hidden" animate="visible" transition={{ staggerChildren: 0.15 }} className="max-w-3xl">
                    ...
                    <motion.div variants={f} className="flex flex-wrap gap-4">
                        <Link href="/english/izakaya-toeic/kaiwa/lp" className="inline-flex items-center gap-3 px-6 py-3 bg-[#D4AF37] text-white text-sm font-bold tracking-wide hover:bg-[#252423] transition-colors">
                            英会話マスター365 <span className="text-xs opacity-50">→</span>
                        </Link>
                        <Link href="/english/izakaya-toeic/lp" className="inline-flex items-center gap-3 px-6 py-3 bg-[#10B981] text-white text-sm font-bold tracking-wide hover:bg-[#252423] transition-colors">
                            居酒屋TOEIC <span className="text-xs opacity-50">→</span>
                        </Link>
