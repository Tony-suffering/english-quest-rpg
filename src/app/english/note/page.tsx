    ...
    return (
        <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: '#f5f5f5' }}>
            ...
            <div style={{
                ...
                <div style={{
                    padding: '16px 20px',
                    background: 'linear-gradient(135deg, #0a0a0a, #1a1510, #0d0d0d)',
                    borderBottom: '3px solid #D4AF37',
                    color: '#fff',
                    flexShrink: 0,
                }}>
                    <div style={{ fontSize: '11px', fontWeight: '700', color: '#D4AF37', letterSpacing: '2px', marginBottom: '6px' }}>
                        TOEIC 900
                    </div>
                    <div style={{ fontSize: '13px', fontWeight: '600', color: '#a8a29e', marginBottom: '8px' }}>
                        読める。聞ける。書ける。喋れない。
                    </div>
                    <div style={{ fontSize: '12px', color: '#d6d3d1', lineHeight: '1.7' }}>
                        4技能のうち3つクリアして最後の1つで永遠に死んでる男。
                        <br />
                        原因を調べて、だれも考えたことないことだけやったら、アプリ1個できてた。
                    </div>
                    <div style={{ fontSize: '11px', fontWeight: '700', color: '#D4AF37', marginTop: '8px' }}>
                        最強の英会話アプリを作る。毎日更新中。
                    </div>
                </div>
