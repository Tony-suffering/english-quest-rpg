    ...
    <div style={{ minHeight: '100vh', background: T.bg, color: T.text }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <img
            src="https://imagedelivery.net/k1Zw56y2FNiZaFcOP7Rs2Q/toeic-group-portrait/public"
            alt="のれんの常連たち"
        ...
        <div style={{
          ...
          {[
            { step: 1, label: 'STEP 1', title: '常連たちに会う', sub: '6人のキャラを読む（TOEIC読解練習）', href: '/english/toeic/characters', done: hasReadChars },
            { step: 2, label: 'STEP 2', title: 'のれん30夜を確認', sub: '30日カレンダーで全体を把握', href: '#calendar', done: completed.length > 0 },
            { step: 3, label: 'STEP 3', title: `第${nextDay}夜を始める`, sub: 'エピソードでリスニング特訓', href: `/english/toeic/episodes/${nextEpisode.id}`, done: isReturning },
          ].map((s, i) => {
      ...
      {mounted && rankInfo && (
        <div style={{
          ...
          <Link href="/english/toeic/tonight" style={{
      ...
      <div style={{ padding: '48px 16px', maxWidth: 640, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 10 }}>
          {IZAKAYA_CHARACTERS.map(char => (
            <Link
              key={char.id}
              href={`/english/toeic/characters#char-${char.id}`}
        ...
        <div style={{ textAlign: 'center', marginTop: 14 }}>
          <Link href="/english/toeic/characters" style={{
        ...
        {selectedDay && (
          <div style={{
            ...
            <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
              <Link
                href={`/english/toeic/episodes/${selectedDay.episodeId}`}
                style={{
      ...
      <div style={{ maxWidth: 640, margin: '0 auto', padding: '0 16px 32px' }}>
        <Link href="/english/izakaya-toeic/kaiwa" style={{
          ...
          <div style={{ fontSize: 13, color: T.textSub, lineHeight: 1.6, marginBottom: 12 }}>
            ...
            <br />
            日本語から4段階の英語で覚える。1年で完全マスター。
          </div>
          <div style={{
            display: 'inline-flex', alignItems: 'center', gap: 6,
            padding: '8px 16px', background: 'rgba(212,175,55,0.12)',
            borderRadius: 8, fontSize: 12, fontWeight: 700, color: T.gold,
          }}>
            カレンダーを開く
        ...
        <div style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 6 }}>
            {[
              ...
              { href: '/english/toeic/tonight', icon: '1', iconColor: T.gold, title: '今夜の1杯', sub: '毎日1問、5秒で解ける' },
              { href: '/english/training', icon: 'V', iconColor: T.green, title: 'Daily Training', sub: '毎日20語ずつトレーニング' },
              { href: '/english/toeic/guide', icon: 'G', iconColor: T.blue, title: 'マスターの攻略メモ', sub: 'Part別の裏技' },
              { href: '/english/toeic/paraphrase', icon: 'P', iconColor: T.gold, title: '言い換えお品書き', sub: '167パターン' },
              { href: '/english/toeic/traps', icon: 'X', iconColor: T.red, title: '引っかけ毒見帳', sub: '17種の罠を見破る' },
              { href: '/english/toeic/sounds', icon: 'W', iconColor: '#3B82F6', title: '聞き酒ノート', sub: '90の音変化パターン' },
              { href: '/english/toeic/score', icon: 'D', iconColor: T.purple, title: 'スコア通知表', sub: '弱点診断' },
              { href: '/english/toeic/mistakes', icon: 'M', iconColor: T.orange, title: '反省ノート', sub: 'ミスの傾向分析' },
              { href: '/english/toeic/achievements', icon: 'B', iconColor: T.gold, title: 'のれんの勲章', sub: '23個の実績バッジ' },
              { href: '/english/toeic/my-story', icon: 'S', iconColor: T.gold, title: '俺のストーリー', sub: '学習の軌跡を共有' },
            ].map(item => (
      ...
      <div style={{
        ...
        {!hasReadChars ? (
          ...
          <Link href={`/english/toeic/episodes/${nextEpisode.id}`} style={{
            display: 'inline-block', padding: '18px 52px',
            background: `linear-gradient(135deg, ${T.gold}, #B8960F)`,
            color: '#fff', borderRadius: 14, fontWeight: 900, fontSize: 20,
            textDecoration: 'none', boxShadow: `0 8px 32px ${T.gold}50`, letterSpacing: 1,
