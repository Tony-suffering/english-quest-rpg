    ...
    return (
      <div style={{ minHeight: '100vh', background: T.bg, color: T.text, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ textAlign: 'center' }}>
          ...
          <Link href="/english/toeic" style={{ color: T.gold, textDecoration: 'none' }}>back</Link>
        </div>
      </div>
    );
  }
      ...
      <div style={{ minHeight: '100vh', background: T.bg, color: T.text }}>
        ...
        <div style={{
          ...
          <div style={{ maxWidth: 640, margin: '0 auto' }}>
            <Link href="/english/toeic" style={{ fontSize: 11, color: T.textMuted, textDecoration: 'none' }}>
              {'<'} 居酒屋TOEIC
            </Link>
          </div>
        </div>
        ...
        <div style={{ maxWidth: 640, margin: '0 auto', padding: '80px 16px', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12, maxWidth: 320, margin: '0 auto' }}>
            {prevEpisodeId && (
              <Link href={`/english/toeic/episodes/${prevEpisodeId}`} style={{
            ...
            <Link href="/english/toeic/program" style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 14 }}>
              <div style={{ display: 'flex', gap: 8 }}>
                ...
                {nextDayPlan && nextDayEpisode && (
                  <Link href={`/english/toeic/episodes/${nextDayEpisode.id}`} style={{
