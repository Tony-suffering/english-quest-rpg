            ...
            >
                ...
                <div style={{
                    ...
                    {(() => {
                        ...
                        return (
                            <div style={{
                                marginTop: size === 'full' ? '12px' : '8px',
                                paddingTop: size === 'full' ? '10px' : '6px',
    ...
    return (
        <div style={{ marginBottom: '28px' }}>
            ...
            <div style={{
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', position: 'relative', zIndex: 1 }}>
                    <div>
                        ...
                        <div style={{ display: 'flex', alignItems: 'baseline', gap: '6px' }}>
                            <span style={{ fontSize: '52px', fontWeight: '900', color: '#FAFAF9', lineHeight: 1, letterSpacing: '-2px' }}>
                                {total}
                            </span>
                            <span style={{ fontSize: '16px', color: 'rgba(255,255,255,0.3)', fontWeight: '500' }}>枚</span>
                        </div>
                    </div>
                ...
                <div style={{
                    height: '1px',
                    background: 'linear-gradient(90deg, transparent 0%, rgba(212,175,55,0.2) 30%, rgba(168,85,247,0.2) 70%, transparent 100%)',
                    margin: '20px 0 18px',
                }} />
                            ...
                            return (
                                <div key={rank} style={{
                                    ...
                                    <div style={{
                                        fontSize: '22px',
                                        fontWeight: '900',
                                        color: hasCards ? cfg.borderColor : 'rgba(255,255,255,0.1)',
                                        lineHeight: 1,
                                        marginBottom: '4px',
                                    }}>
                                        {count}
                                    ...
                                    <div style={{
                                        fontSize: '9px',
                                        fontWeight: '700',
                                        color: hasCards ? 'rgba(255,255,255,0.5)' : 'rgba(255,255,255,0.15)',
                                        letterSpacing: '0.5px',
                                    }}>
                                        {RANK_JA[rank]}
                                    </div>
            ...
            {/* Bottom row: Rare count + Rarest card */}
            <div style={{ display: 'grid', gridTemplateColumns: rarestCard && rarestCard.points > 0 ? '1fr 2fr' : '1fr', gap: '12px' }}>
                ...
                <div style={{
                    ...
                    <div style={{ fontSize: '11px', fontWeight: '600', color: '#A855F7', opacity: 0.6, marginBottom: '8px', letterSpacing: '1px' }}>
                        レア以上
                    </div>
                    <div style={{ display: 'flex', alignItems: 'baseline', gap: '4px' }}>
                        <span style={{ fontSize: '40px', fontWeight: '900', color: '#7C3AED', lineHeight: 1, letterSpacing: '-1px' }}>
                            {rareCount}
                        </span>
                    ...
                    <div style={{
                        ...
                        <div style={{
                            height: '100%',
                            width: `${total > 0 ? (rareCount / total) * 100 : 0}%`,
                            borderRadius: '2px',
                ...
                {rarestCard && rarestCard.points > 0 && (
                    <div style={{
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                            <div style={{ fontSize: '11px', fontWeight: '600', color: '#B8941E', opacity: 0.7, marginBottom: '6px', letterSpacing: '1px' }}>
                                最高ランクのカード
                            </div>
                            <div style={{
                                fontSize: '15px',
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                {RANK_JA[rarestCard.rankConfig.rank]}
                            </div>
                            <div style={{
                                fontSize: '28px',
                                fontWeight: '900',
    ...
    return (
        ...
        >
            <div onClick={e => e.stopPropagation()} style={{
                ...
                {/* ── Header: Full English + Japanese text ── */}
                <div style={{
                    padding: '28px 24px 20px',
                    background: getCardWindowBg(card.rankConfig.rank),
                    borderRadius: '20px 20px 0 0',
                    borderBottom: `1px solid ${accent}30`,
                    position: 'relative', overflow: 'hidden',
                }}>
                    {/* Subtle rank glow in header */}
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '14px', position: 'relative' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                            ...
                            <span style={{
                                ...
                                {card.rankConfig.label}
                            </span>
                            {advEl && (
                                <span style={{
                                    fontSize: '9px', fontWeight: '600',
                                    color: isLeg ? 'rgba(255,255,255,0.4)' : '#A8A29E',
                                    marginLeft: '2px',
                                }}>
                                    {elLabel} &gt; {advLabel}
                                </span>
                        ...
                        <div style={{ display: 'flex', alignItems: 'baseline', gap: '4px' }}>
                            <span style={{
                                ...
                                color: card.rankConfig.rank !== 'NORMAL' ? accent : '#A8A29E',
                                fontFamily: 'monospace',
                            }}>
                                {card.points}
                            </span>
                        ...
                        {nickname ? (
                            <>
                                <span style={{
                                    ...
                                    color: isLeg ? 'rgba(255,255,255,0.35)' : '#A8A29E',
                ...
                <div style={{ padding: '16px 20px 12px', display: 'flex', flexDirection: 'column', gap: '10px' }}>
                    ...
                    <div style={{
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                                <span style={{
                                    fontSize: '11px', fontWeight: '800', color: ci.color,
                                }}>{ci.ja}</span>
                                <span style={{
                                    fontSize: '13px', fontWeight: '900', color: ci.color,
                                    fontFamily: 'monospace',
                                }}>Lv.{card.chakra}</span>
                            </div>
                        </div>
                    ...
                    <div style={{
                        ...
                        gap: '8px', minHeight: '36px', padding: '2px 0',
                    }}>
                        {editing ? (
                            <form onSubmit={(e) => {
                                e.preventDefault();
                                ...
                                {nickname && (
                                    <button type="button" onClick={() => { onNicknameChange(''); setDraft(''); setEditing(false); }} style={{
                                        ...
                                        cursor: 'pointer', backgroundColor: 'transparent', color: 'rgba(255,255,255,0.4)',
                                    }}>x</button>
                                )}
                            </form>
                        ) : (
...
export default function CardCollectionPage() {
    ...
    const filterOptions: { key: CardRank | 'ALL'; label: string; color: string; count: number }[] = [
        { key: 'ALL', label: 'すべて', color: '#78716C', count: rankCounts.ALL },
        { key: 'LEGENDARY', label: '伝説', color: '#D4AF37', count: rankCounts.LEGENDARY },
        { key: 'HOLOGRAPHIC', label: '虹色', color: '#A855F7', count: rankCounts.HOLOGRAPHIC },
        { key: 'GOLD', label: '金', color: '#F6C85F', count: rankCounts.GOLD },
        { key: 'SILVER', label: '銀', color: '#94A3B8', count: rankCounts.SILVER },
        { key: 'BRONZE', label: '銅', color: '#CD7F32', count: rankCounts.BRONZE },
        { key: 'NORMAL', label: '普通', color: '#D6D3D1', count: rankCounts.NORMAL },
    ];
        ...
        <div style={{
            ...
            <div style={{ maxWidth: '960px', margin: '0 auto 28px' }}>
                ...
                <h1 style={{
                    ...
                    letterSpacing: '-1px', marginBottom: '6px', lineHeight: 1.2,
                }}>
                    カードコレクション
                </h1>
                <p style={{ fontSize: '13px', color: '#78716C', lineHeight: 1.6 }}>
                    レビューでSPを貯めてカードのランクを上げよう
                </p>
            </div>
                    ...
                    {(activeFilter !== 'ALL' || bstFilter !== 'ALL') && (
                        <button
                            ...
                            style={{
                                ...
                                padding: '4px 8px', marginLeft: '4px',
                                opacity: 0.8,
                            }}
                        >
                            リセット
