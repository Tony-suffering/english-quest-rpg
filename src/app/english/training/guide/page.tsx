            ...
            <div style={{ maxWidth: 640, margin: '0 auto', padding: '32px 24px 80px' }}>
                    ...
                    <div style={cardStyle}>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                            {[
                                ...
                                {
                                    title: 'チャクラバー（カレンダー内）',
                                    desc: 'カレンダーの各日に表示される7本の色付きバー。下（赤）がSEED、上（紫）がSTART。バーが上に伸びるほど、その日のフレーズの習熟度が高いことを示します。',
                                    color: '#8B5CF6',
                                },
                                {
                                    title: 'マリオランナー',
                ...
                <div style={{ marginBottom: 40 }}>
                    ...
                    {[
                        ...
                        {
                            q: 'レベルを間違えて上げてしまった',
                            a: 'Lv.7（START）以外はいつでも戻せます。カードの詳細画面からレベルを変更できます。STARTだけはリセットするとLv.1に戻るので注意。',
                        },
                        {
                            q: 'スロットは何のためにあるの？',
