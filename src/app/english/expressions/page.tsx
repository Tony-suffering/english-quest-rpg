...
type SeriesKey = 'party' | 'monster' | 'mariners' | 'movie' | 'gamenight' | 'antiques';

type AnyExpression = PartyExpression | MonsterExpression | MarinersExpression | MovieExpression | GameNightExpression | AntiquesExpression;
