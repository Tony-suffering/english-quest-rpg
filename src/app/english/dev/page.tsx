    ...
    return (
        <div style={{ padding: '0 0 24px', maxWidth: '960px', margin: '0 auto', backgroundColor: '#F5F5F4', minHeight: '100vh' }}>
            ...
            <div style={{ marginBottom: '16px' }}>
                <MiniRunner todayXP={previewXP} goalXP={previewGoal} onGoalChange={setPreviewGoal} battleData={battleSyncData} onBattleStart={() => setMiniRunnerBattleActive(true)} onBattleEnd={() => setMiniRunnerBattleActive(false)} />
            ...
            <div style={{ margin: '0 0 16px', padding: '16px', background: '#fff', borderRadius: '12px', border: '1px solid #E7E5E4' }}>
                ...
                <PuzzleBoard
                    ...
                    onBattleSync={(data) => {
                        console.log('Battle sync:', data);
                        setBattleSyncData(data);
                    }}
