...
export async function createCraftsmanProfile(
  ...
  try {
    console.log('[createCraftsmanProfile] Starting create for user:', userId)
    console.log('[createCraftsmanProfile] Profile data:', profileData)
    ...
    if (error) {
      console.error('[createCraftsmanProfile] Error details:', {
        code: error.code,
    ...
    console.log('[createCraftsmanProfile] Create successful:', data?.id)
    return data
  } catch (error) {
    console.error('[createCraftsmanProfile] Catch block error:', error)
    throw error
  }
}
...
export async function updateCraftsmanProfile(
  ...
  try {
    console.log('[updateCraftsmanProfile] Starting update for user:', userId)
    console.log('[updateCraftsmanProfile] Updates:', updates)
    ...
    if (error) {
      console.error('[updateCraftsmanProfile] Error details:', {
        code: error.code,
        message: error.message,
        details: error.details,
        hint: error.hint
    ...
    console.log('[updateCraftsmanProfile] Update successful:', data?.id)
    return data
  } catch (error) {
    console.error('[updateCraftsmanProfile] Catch block error:', error)
    throw error
  }
}
