...
import { OrbitControls, Html, ContactShadows, Environment, Float, OrthographicCamera, PerspectiveCamera } from '@react-three/drei'
import { motion, AnimatePresence } from 'framer-motion'
import { Info, X, Layers, Ruler, MousePointer2, Scan, Terminal, Sparkles, Copy, Check, Eye, Grid, Box, Map } from 'lucide-react'
