...
export default function CraftsmanCalendar() {
  ...
  const fetchSchedules = async () => {
    ...
    try {
      ...
      if (relError1) console.error('関係取得エラー1:', relError1)
      ...
      if (relError2) console.error('関係取得エラー2:', relError2)
      ...
      console.log('仲間関係1:', relationships1)
      console.log('仲間関係2:', relationships2)
      console.log('仲間のID:', colleagueIds)
      ...
      if (colleagueIds.length > 0) {
        ...
        console.log('仲間のスケジュール:', colleagueData)
